import{r as w,b as g,j as h,F,e as x}from"./index-BjAk923F.js";import{s as R}from"./shaderMaterial-MzvEB3dU.js";const b=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
`,o=R({uTime:0,uSnowAmount:1,uSnowScale:140,uSnowSpeed:1,uSnowSize:240,uSnap:60,uBandStrength:.35,uBandSpeed:.6,uBandScale:8,uRFStrength:.25,uRFScale:22,uRFSpeed:.4,uCurvature:0,uVignette:1.1},b,B);x({CrtStaticMaterial:o});function M({snowAmount:t=1,snowScale:n=180,snowSpeed:u=1,snowSize:a=240,curvature:r=.12,vignette:i=.75,bandStrength:l=.35,bandSpeed:v=.6,bandScale:f=8,snap:c=24,rfStrength:s=.25,rfScale:S=22,rfSpeed:d=.4,side:p=F}){const e=w.useRef();return g((y,m)=>{e.current&&(e.current.uTime+=m)}),h.jsx("crtStaticMaterial",{ref:e,side:p,transparent:!1,depthWrite:!0,toneMapped:!1,uSnowAmount:t,uSnowScale:n,uSnowSpeed:u,uSnowSize:a,uSnap:c,uBandStrength:l,uBandSpeed:v,uBandScale:f,uRFStrength:s,uRFScale:S,uRFSpeed:d,uCurvature:r,uVignette:i},o.key)}export{M as C};
