import{V as S,v as q,B as L,aa as G,X as I,ad as V,r as m,_ as H,I as X,F as U,C as Z,b as k,j as o,h as Y,k as A,M as E,ay as Q,J as K,E as $,Q as J}from"./index-BjAk923F.js";import{P as ee,R as F}from"./react-three-rapier.esm-DpnDVjkv.js";import{P as te}from"./PerspectiveCamera-CJF5pD1Q.js";import{v as ae}from"./constants-CkMERDu8.js";import{u as oe}from"./Gltf-DuvxF6ry.js";import"./Fbo-2WB1Ko_c.js";var re=Object.defineProperty,se=(e,t,a)=>t in e?re(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a,N=(e,t,a)=>(se(e,typeof t!="symbol"?t+"":t,a),a);const ne=(()=>{const e={uniforms:{turbidity:{value:2},rayleigh:{value:1},mieCoefficient:{value:.005},mieDirectionalG:{value:.8},sunPosition:{value:new S},up:{value:new S(0,1,0)}},vertexShader:`
    ...
    `},t=new q({name:"SkyShader",fragmentShader:e.fragmentShader,vertexShader:e.vertexShader,uniforms:G.clone(e.uniforms),side:L,depthWrite:!1});class a extends I{constructor(){super(new V(1,1,1),t)}}return N(a,"SkyShader",e),N(a,"material",t),a})();function ie(e,t,a=new S){const r=Math.PI*(e-.5),s=2*Math.PI*(t-.5);return a.x=Math.cos(s),a.y=Math.sin(r),a.z=Math.sin(s),a}const le=m.forwardRef(({inclination:e=.6,azimuth:t=.1,distance:a=1e3,mieCoefficient:r=.005,mieDirectionalG:s=.8,rayleigh:u=.5,turbidity:n=10,sunPosition:i=ie(e,t),...l},h)=>{const c=m.useMemo(()=>new S().setScalar(a),[a]),[p]=m.useState(()=>new ne);return m.createElement("primitive",H({object:p,ref:h,"material-uniforms-mieCoefficient-value":r,"material-uniforms-mieDirectionalG-value":s,"material-uniforms-rayleigh-value":u,"material-uniforms-sunPosition-value":i,"material-uniforms-turbidity-value":n,scale:c},l))}),ce=`
  uniform float uTime;
