...
- [ ] Add some sensible presets. Need a fast moving fluid, need a flow viscous fluid, need a preset with debug always on, need to set up some preset with differnt color pallettes
- [ ] Add support and preset for black ink on white background.
