import{aA as C,j as s,r as m,aZ as B,aa as D,p as w,a1 as Z,E as X,K as r,aO as R,J as P}from"./index-Ccd5CS82.js";import{d as Y,w as I}from"./index-CTI2H2vB.js";import{F as O}from"./flyingHighFire-DA4ljKnB.js";import{u as A}from"./Gltf-DldV08wr.js";import{d as u,V as c,g as k}from"./VolumetricFire-Db_ZpgQT.js";import{S as x}from"./SmokeParticles-DH2Nt8PM.js";import{C as W,a as G}from"./Cloud-LqvaYEyu.js";import{P as H}from"./PerspectiveCamera-BV3kTPML.js";import{O as E}from"./OrbitControls-CyY_AXiD.js";import"./constants-Bcuur6om.js";import"./three.tsl-CWjF3kga.js";import"./extends-CF3RwP-h.js";import"./Texture-CfjLvc10.js";import"./deprecated-CtTvmxFP.js";import"./Fbo-BbUyr020.js";function T(t){const{nodes:e,materials:a}=A(C("/boeing_737-300.glb"));return s.jsxs("group",{...t,dispose:null,children:[s.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:e.Object_9.geometry,material:a.material00}),s.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:e.Object_12.geometry,material:a.material00}),s.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:e.Object_15.geometry,material:a.material02}),s.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:e.Object_18.geometry,material:a.material00})]})}A.preload(C("/boeing_737-300.glb"));function U({leftEngineMainFire:t,rightEngineMainFire:e,leftWingSecondaryFire:a,rightWingSecondaryFire:n,leftEngineSmokeTrail:p,rightEngineSmokeTrail:d,leftSmokePoints:h,rightSmokePoints:g}){return s.jsxs(s.Fragment,{children:[s.jsx("pointLight",{position:t?u(t).toArray():[-1.8,-.1,.4],color:"#ff6600",intensity:4,distance:8,decay:2}),s.jsx("pointLight",{position:e?u(e).toArray():[1.8,-.1,.4],color:"#ff6600",intensity:4,distance:8,decay:2}),s.jsx(c,{position:t?u(t).toArray():[-1.8,0,.3],width:t?.fireWidth??.5,height:t?.fireHeight??1.8,depth:t?.fireDepth??.5,sliceSpacing:t?.fireSliceSpacing??.08,magnitude:t?.fireMagnitude??1.6,brightness:t?.fireBrightness??2.2,saturation:t?.fireSaturation??.9,animated:t?.fireAnimated??!0,bendX:.4,bendZ:-1.2,animSpeed:t?.fireAnimSpeed??.85,tintColor:t?.fireTintColor??"#ffcc44"}),s.jsx(c,{position:e?u(e).toArray():[1.8,0,.3],width:e?.fireWidth??.5,height:e?.fireHeight??1.8,depth:e?.fireDepth??.5,sliceSpacing:e?.fireSliceSpacing??.08,magnitude:e?.fireMagnitude??1.6,brightness:e?.fireBrightness??2.2,saturation:e?.fireSaturation??.9,animated:e?.fireAnimated??!0,bendX:-.4,bendZ:-1.2,animSpeed:e?.fireAnimSpeed??.75,tintColor:e?.fireTintColor??"#ffcc44"}),s.jsx(c,{position:a?u(a).toArray():[-1.4,.3,-.2],width:a?.fireWidth??.35,height:a?.fireHeight??1.2,depth:a?.fireDepth??.35,sliceSpacing:a?.fireSliceSpacing??.1,segments:16,magnitude:a?.fireMagnitude??1.4,brightness:a?.fireBrightness??1.8,animated:a?.fireAnimated??!0,animSpeed:a?.fireAnimSpeed??1.1,bendX:.2,bendZ:-.9,tintColor:a?.fireTintColor??"#ff8833"}),s.jsx(c,{position:n?u(n).toArray():[1.4,.3,-.2],width:n?.fireWidth??.35,height:n?.fireHeight??1.2,depth:n?.fireDepth??.35,sliceSpacing:n?.fireSliceSpacing??.1,segments:16,magnitude:n?.fireMagnitude??1.4,brightness:n?.fireBrightness??1.8,animated:n?.fireAnimated??!0,animSpeed:n?.fireAnimSpeed??1,bendX:-.2,bendZ:-.9,tintColor:n?.fireTintColor??"#ff8833"}),s.jsx(x,{points:h,config:p}),s.jsx(x,{points:g,config:d})]})}const _=m.memo(U);function L({clouds:t}){return s.jsx(W,{material:B,children:t.map((e,a)=>s.jsx(G,{position:e.position,scale:e.scale,speed:e.speed,opacity:e.opacity,width:e.width,depth:e.depth,segments:e.segments,color:e.color},a))})}const N=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
