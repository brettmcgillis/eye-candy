...
`);class Gt{constructor(e){const a={time:o(0),cameraPosition:o(new u),minLodRadius:Mt,gridResolution:o(e.gridResolution??Ot),position:ie("position"),vindex:ie("vindex"),width:ie("width"),lod:ie("lod"),ifftResolution:o(e.ifftResolution),displacement0:k(e.cascades[0].displacement),displacement1:k(e.cascades[1].displacement),displacement2:k(e.cascades[2].displacement),derivatives0:k(e.cascades[0].derivative),derivatives1:k(e.cascades[1].derivative),derivatives2:k(e.cascades[2].derivative),jacobian0:k(e.cascades[0].jacobian),jacobian1:k(e.cascades[1].jacobian),jacobian2:k(e.cascades[2].jacobian),ifft_sampler0:k(e.cascades[0].derivative),ifft_sampler1:k(e.cascades[1].derivative),ifft_sampler2:k(e.cascades[2].derivative),foamStrength:e.foamStrength,foamThreshold:e.foamThreshold,lodScale:e.lodScale,morphBlend:o(e.morphBlend??1),waveLengths:gt(e.cascades[0].params.lengthScale,e.cascades[1].params.lengthScale,e.cascades[2].params.lengthScale),sunPosition:o(e.sunPosition),vMorphedPosition:at,vDisplacedPosition:Pe,vCascadeScales:rt},r=o(new Le),i=o(new re(0,0)),s=o(0),l=new Je;l.positionNode=Et(a),l.colorNode=Wt(a),l.opacityNode=yt(()=>{const n=r.mul(wt(Pe,1)).xyz,c=n.x.div(Oe(i.x,te(1e-4))),d=n.z.div(Oe(i.y,te(1e-4))),b=c.mul(c).add(d.mul(d)).lessThan(te(1)).and(s.greaterThan(te(.5)));return bt(b,te(0),te(1))})(),l.alphaTest=.5,l.side=ct,l.colorSpace=Qe,l.transparent=!1,this.material=l,this.parameters=a,this.hullMask={enabled:s,extents:i,inverse:r}}}const Nt=C(`
