import{aD as g,j as r,a1 as h,p as s,y as S,m as w,r as a,aP as F,o as b}from"./index-ByL4sTkr.js";import{s as U}from"./shaderMaterial-BPk7APAB.js";import{B as M}from"./Billboard-ryyJzmln.js";const l=`
...
`,_=U({uTime:0,uTimeFrequency:.45,uUvFrequency:new S(3,5),uColor:new s("#b8b8b8"),uOpacity:.6,uRiseSpeed:.35,uSpreadStrength:.18,uScrollDir:1},P,R);w({SmokeMaterialImpl:_});const q=g.forwardRef(function({side:o=h},i){return r.jsx("smokeMaterialImpl",{ref:i,transparent:!0,side:o,depthWrite:!1,toneMapped:!1})}),D={timeFrequency:.45,uvFrequencyX:1,uvFrequencyY:1.5,riseSpeed:.35,spreadStrength:.18,opacity:.6,color:"#b8b8b8",width:.25,height:3};function E({position:c=[0,0,0],inverted:o=!1,smoke:i,visible:v=!0}){const e={...D,...i},n=a.useRef(),f=a.useMemo(()=>new s(e.color),[e.color]),m=a.useMemo(()=>new F(e.width,e.height,2,32),[e.width,e.height]),d=1;if(b(({clock:x})=>{const t=n.current;t&&(t.uTime=x.getElapsedTime(),t.uTimeFrequency=e.timeFrequency,t.uUvFrequency.set(e.uvFrequencyX,e.uvFrequencyY),t.uColor.copy(f),t.uOpacity=e.opacity,t.uRiseSpeed=e.riseSpeed,t.uSpreadStrength=e.spreadStrength,t.uScrollDir=d)}),!v)return null;const p=o?-(e.height/2):e.height/2,y=o?[1,-1,1]:[1,1,1];return r.jsx(M,{position:c,follow:!0,lockX:!1,lockY:!1,lockZ:!1,children:r.jsx("mesh",{position:[0,p,0],scale:y,geometry:m,children:r.jsx(q,{ref:n})})})}export{E as S};
