import{r as l,K as k,j as a,cm as ge,cn as xe,y as be,Z as Se,aK as ye,a as Ce,b as Y,t as me,bg as Te,ad as we,W as ne,f as Re,aL as je,ax as ke,c as I,d as $,v as Ee,l as Me,n as p,av as Oe,m as ie}from"./index-CQMuuBZp.js";import{S as Pe}from"./stayingAfloatSplines-BCzNZRtB.js";import{u as E}from"./Gltf-LeYGagT5.js";import{u as he}from"./useAnimations-BkRogJhr.js";import{c as Be}from"./SkeletonUtils-BCVmgslc.js";import{s as _e,b as Le,a as Ie}from"./NurbsWaterColumn-JrRWaxOm.js";import{u as pe}from"./Texture-BiquuS8W.js";import{u as A}from"./Fbo-BywmgRQ1.js";import{S as Ae}from"./SplineLine-CJZZXoGn.js";import{P as Ve}from"./PerspectiveCamera-Dx4zV-Ab.js";import{O as De}from"./OrbitControls-qfNdrSGQ.js";import"./constants-qD98c99N.js";import"./Line2-CJhFf__y.js";function Ue(e){const n=l.useRef(),{nodes:i,materials:s,animations:o}=E(k("/hammerHead.glb")),{actions:u}=he(o,n);return l.useEffect(()=>(Object.values(u??{}).forEach(c=>{c.reset(),c.fadeIn(.35),c.play()}),()=>{Object.values(u??{}).forEach(c=>{c.fadeOut(.2),c.stop()})}),[u]),a.jsx("group",{ref:n,...e,dispose:null,children:a.jsx("group",{name:"Sketchfab_Scene",children:a.jsx("group",{name:"Sketchfab_model",rotation:[-Math.PI/2,0,0],children:a.jsx("group",{name:"bac65c2aa79a4a3a9500cef32dd8cf74fbx",rotation:[Math.PI/2,0,0],scale:.01,children:a.jsx("group",{name:"Object_2",children:a.jsxs("group",{name:"RootNode",children:[a.jsx("group",{name:"Cube",position:[0,.712,9.972],rotation:[-Math.PI/2,0,0],scale:24.02}),a.jsx("group",{name:"Armature",position:[-.434,1.731,100.544],rotation:[-Math.PI,0,0],scale:100,children:a.jsxs("group",{name:"Object_6",children:[a.jsx("primitive",{object:i._rootJoint}),a.jsx("skinnedMesh",{name:"Object_9",geometry:i.Object_9.geometry,material:s.Material,skeleton:i.Object_9.skeleton}),a.jsx("group",{name:"Object_8",position:[0,.712,9.972],rotation:[-Math.PI/2,0,0],scale:24.02})]})})]})})})})})})}E.preload(k("/hammerHead.glb"));function se({excludeAnimations:e=[],...n}){const i=l.useRef(),{scene:s,materials:o,animations:u}=E(k("/tigerShark.glb")),c=l.useMemo(()=>Be(s),[s]),{nodes:d}=ge(c),C=l.useMemo(()=>u.map(g=>g.clone()),[u]),{actions:v}=he(C,i);return l.useEffect(()=>{const g=e.map(f=>f.toLowerCase());return Object.entries(v??{}).forEach(([f,h])=>{g.some(y=>f.toLowerCase().includes(y))||(h.reset(),h.setLoop(xe,1/0),Object.assign(h,{clampWhenFinished:!1}),h.fadeIn(.35),h.play())}),()=>{Object.values(v??{}).forEach(f=>{f.fadeOut(.2),f.stop()})}},[v,e]),a.jsx("group",{ref:i,...n,dispose:null,children:a.jsx("group",{name:"Sketchfab_Scene",children:a.jsx("group",{name:"Sketchfab_model",rotation:[-Math.PI/2,0,0],children:a.jsx("group",{name:"Tiger_Shark_2fbx",rotation:[Math.PI/2,0,0],children:a.jsx("group",{name:"Object_2",children:a.jsxs("group",{name:"RootNode",children:[a.jsx("group",{name:"Hemi",position:[0,-124.661,0],rotation:[0,0,Math.PI],scale:100,children:a.jsx("group",{name:"Object_5",rotation:[Math.PI/2,0,0],children:a.jsx("group",{name:"Object_6"})})}),a.jsx("group",{name:"Sun",position:[209.518,114.514,0],rotation:[0,-.58,-.95],scale:100,children:a.jsx("group",{name:"Object_8",rotation:[Math.PI/2,0,0],children:a.jsx("group",{name:"Object_9"})})}),a.jsx("group",{name:"Armature",rotation:[-Math.PI/2,0,0],scale:100,children:a.jsxs("group",{name:"Object_11",children:[a.jsx("primitive",{object:d._rootJoint}),a.jsx("skinnedMesh",{name:"Object_83",geometry:d.Object_83.geometry,material:o.Tiger_shark,skeleton:d.Object_83.skeleton}),a.jsx("group",{name:"Object_82",rotation:[-Math.PI/2,0,0],scale:100})]})}),a.jsx("group",{name:"TIGER_SHARK_lowpoly",rotation:[-Math.PI/2,0,0],scale:100}),a.jsx("group",{name:"Cube",rotation:[-Math.PI/2,0,0],scale:100,children:a.jsx("mesh",{name:"Cube__0",castShadow:!0,receiveShadow:!0,geometry:d.Cube__0.geometry,material:o.Cube__0})}),a.jsx("group",{name:"Empty_SPHERE",rotation:[-Math.PI/2,0,0],scale:100})]})})})})})})}E.preload(k("/tigerShark.glb"));const ue=`
...
`;function j(e,n,i){const s=new be({uniforms:i,vertexShader:We,fragmentShader:n,depthTest:!1,depthWrite:!1}),o=new Se(e,s);o.frustumCulled=!1;const u=new ye;return u.add(o),{scene:u,material:s}}pe.preload(me("watercolor.png"));const Ne=1;function Je({radius:e=6,alpha:n=25,qualityScale:i=.5,quantizeLevels:s=16,saturation:o=1.5,paperStrength:u=1,bloomEnabled:c=!0,bloomIntensity:d=1.2,outlineEnabled:C=!0,outlineStrength:v=.75,outlineThreshold:g=.22,outlineSoftness:f=.14,hatchingEnabled:h=!0,hatchScale:y=6,hatchIntensity:M=.25,hatchThickness:V=.9,hatchRotation:b=.35}){const{size:O}=Ce(),D=l.useRef(new Y),U=l.useRef(new Y),T=pe(me("watercolor.png"));T.minFilter=Te,T.magFilter=we,T.generateMipmaps=!0;const N=A({depthBuffer:!0}),S=l.useMemo(()=>new ne(1,1,{depthBuffer:!1,type:Re}),[]),P=l.useMemo(()=>new ne(1,1,{depthBuffer:!1}),[]);l.useEffect(()=>()=>{S.dispose(),P.dispose()},[S,P]);const ee=A({depthBuffer:!0}),te=A({depthBuffer:!1}),ae=A({depthBuffer:!1}),re=A({depthBuffer:!1}),w=l.useMemo(()=>new je(-1,1,1,-1,0,1),[]),x=l.useMemo(()=>new ke(2,2),[]),J=l.useMemo(()=>j(x,Fe,{inputBuffer:{value:null},resolution:{value:new Y}}),[x]),R=l.useMemo(()=>j(x,He,{inputBuffer:{value:null},originalTexture:{value:null},sourceSize:{value:new I},radius:{value:e},alpha:{value:n}}),[x]),m=l.useMemo(()=>j(x,Ge,{inputBuffer:{value:null},watercolorTexture:{value:null},tensorTexture:{value:null},quantizeLevels:{value:s},saturation:{value:o},paperStrength:{value:u},outlineEnabled:{value:C},outlineStrength:{value:v},outlineThreshold:{value:g},outlineSoftness:{value:f},hatchingEnabled:{value:h},hatchScale:{value:y},hatchIntensity:{value:M},hatchThickness:{value:V},hatchRotation:{value:b}}),[x]),q=l.useMemo(()=>j(x,ue,{inputBuffer:{value:null},direction:{value:new I(1,0)},resolution:{value:new I}}),[x]),Q=l.useMemo(()=>j(x,ue,{inputBuffer:{value:null},direction:{value:new I(0,1)},resolution:{value:new I}}),[x]),z=l.useMemo(()=>j(x,ze,{inputBuffer:{value:null},bloomBuffer:{value:null},bloomIntensity:{value:d}}),[x]);return $(fe=>{const{gl:r,scene:B,camera:G}=fe,oe=r.getPixelRatio(),H=O.width*oe,F=O.height*oe;D.current.set(H,F,1/H,1/F);const _=Math.max(1,Math.round(H*i)),L=Math.max(1,Math.round(F*i));(S.width!==_||S.height!==L)&&(S.setSize(_,L),P.setSize(_,L)),U.current.set(_,L,1/_,1/L);const de=r.autoClear;r.autoClear=!1,r.setRenderTarget(N),r.clear(),r.render(B,G);const le=c?(()=>{const W=D.current,ve=B.background;return B.background=null,G.layers.set(Ne),r.setRenderTarget(ee),r.setClearColor(0,1),r.clear(),r.render(B,G),G.layers.set(0),B.background=ve,q.material.uniforms.inputBuffer.value=ee.texture,q.material.uniforms.resolution.value.set(W.x,W.y),r.setRenderTarget(te),r.clear(),r.render(q.scene,w),Q.material.uniforms.inputBuffer.value=te.texture,Q.material.uniforms.resolution.value.set(W.x,W.y),r.setRenderTarget(ae),r.clear(),r.render(Q.scene,w),z.material.uniforms.inputBuffer.value=N.texture,z.material.uniforms.bloomBuffer.value=ae.texture,z.material.uniforms.bloomIntensity.value=d,r.setRenderTarget(re),r.clear(),r.render(z.scene,w),re.texture})():N.texture;J.material.uniforms.inputBuffer.value=le,J.material.uniforms.resolution.value=U.current,r.setRenderTarget(S),r.clear(),r.render(J.scene,w),R.material.uniforms.inputBuffer.value=S.texture,R.material.uniforms.originalTexture.value=le,R.material.uniforms.sourceSize.value.set(H,F),R.material.uniforms.radius.value=e,R.material.uniforms.alpha.value=n,r.setRenderTarget(P),r.clear(),r.render(R.scene,w),m.material.uniforms.inputBuffer.value=P.texture,m.material.uniforms.watercolorTexture.value=T,m.material.uniforms.tensorTexture.value=S.texture,m.material.uniforms.quantizeLevels.value=s,m.material.uniforms.saturation.value=o,m.material.uniforms.paperStrength.value=u,m.material.uniforms.outlineEnabled.value=C,m.material.uniforms.outlineStrength.value=v,m.material.uniforms.outlineThreshold.value=g,m.material.uniforms.outlineSoftness.value=f,m.material.uniforms.hatchingEnabled.value=h,m.material.uniforms.hatchScale.value=y,m.material.uniforms.hatchIntensity.value=M,m.material.uniforms.hatchThickness.value=V,m.material.uniforms.hatchRotation.value=b,r.setRenderTarget(null),r.clear(),r.render(m.scene,w),r.autoClear=de},1),null}function qe(e){const{nodes:n,materials:i}=E(k("/lifePreserver.glb"));return a.jsx("group",{...e,dispose:null,children:a.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:n.Object_4.geometry,material:i["Material.001"],scale:[1,.698,1]})})}E.preload(k("/lifePreserver.glb"));const K=.1,X=.15,ce=3;function Qe({waveHeight:e,waveChoppiness:n,waveSpeed:i}){const s=l.useRef();return $(o=>{if(!s.current)return;const u=o.clock.elapsedTime,c=_e(K,X,e,n,i);s.current.position.y=ce+c;const d=Le(K,X,e,n,i);s.current.rotation.x=Math.asin(-d.z),s.current.rotation.z=Math.asin(d.x),s.current.rotation.y=u*.2}),a.jsx("group",{ref:s,position:[K,ce,X],scale:.22,children:a.jsx(qe,{})})}function Z({Shark:e,points:n,speed:i,scale:s,headingOffset:o=0,clockwise:u=!0,visible:c=!0,showSpline:d=!1,sharkProps:C={}}){const v=l.useRef(),g=l.useMemo(()=>n?.length?n.map(h=>h.clone().multiplyScalar(.01)):[],[n]),f=l.useMemo(()=>g.length?new Ee(g,!0,"centripetal",.5):null,[g]);return $(h=>{if(!v.current||!f)return;const y=h.clock.elapsedTime*i%1,M=u?(1-y+1)%1:y,V=(M+.01)%1,b=f.getPointAt(M),O=f.getPointAt(V),D=O.x-b.x,U=O.z-b.z,T=Math.atan2(D,U);v.current.position.set(b.x,b.y+Math.sin(h.clock.elapsedTime*1.7)*.05,b.z),v.current.rotation.y=T+o,v.current.rotation.z=Math.sin(h.clock.elapsedTime*2)*.08}),a.jsxs(a.Fragment,{children:[c&&a.jsx("group",{ref:v,scale:s,children:a.jsx(e,{...C})}),d&&g.length>=2&&a.jsx(Ae,{points:g,tension:.5,closed:!0,curveType:"catmullrom",color:"#ff6600",visible:!0,arcSegments:64})]})}const t={cameraMode:"Fixed",backgroundColor:"#ffffff",ambientIntensity:.85,ambientColor:"#f7fbff",mainLightIntensity:1.15,mainLightColor:"#fff8ea",fillLightIntensity:.35,fillLightColor:"#d9f2ff",columnWidth:3.6,columnDepth:3.6,columnHeight:6,segments:24,topColor:"#9edff0",bottomColor:"#246f98",opacity:1,transmission:.31,roughness:0,ior:2,thickness:.24,waveHeight:.15,waveChoppiness:.5,waveSpeed:.6,edgeColor:"#333333",edgeOpacity:1,edgeLineWidth:3.5,showEdges:!0,hammerheadVisible:!0,hammerheadScale:.38,hammerheadSpeed:.1,hammerheadSplineVisible:!1,tiger1Visible:!0,tiger1Scale:.003,tiger1Speed:.075,tiger1SplineVisible:!1,tiger2Visible:!0,tiger2Scale:.003,tiger2Speed:.06,tiger2SplineVisible:!1,painterlyEnabled:!0,painterlyRadius:2,painterlyAlpha:25,painterlyQuantize:16,painterlySaturation:1.5,painterlyPaper:1,outlineEnabled:!0,outlineStrength:.75,outlineThreshold:.22,outlineSoftness:.14,hatchingEnabled:!0,hatchScale:6,hatchIntensity:.25,hatchThickness:.9,hatchRotation:.35,bloomEnabled:!0,bloomIntensity:1.2};function Ye(){const e=l.useRef({...t}),[n,i]=Me("Staying Afloat",()=>({Presets:p({reset:ie(()=>i({...t})),...Oe()?{copy:ie(()=>{const o=JSON.stringify(e.current,null,2).replace(/"([A-Za-z_$][A-Za-z0-9_$]*)":/g,"$1:");navigator.clipboard.writeText(o)})}:{}},{collapsed:!0}),Scene:p({cameraMode:{label:"Camera",value:t.cameraMode,options:["Fixed","Orbit"]},backgroundColor:{label:"Background",value:t.backgroundColor},Lighting:p({ambientIntensity:{label:"Ambient",value:t.ambientIntensity,min:0,max:2,step:.05},ambientColor:{label:"Ambient Color",value:t.ambientColor},mainLightIntensity:{label:"Main Light",value:t.mainLightIntensity,min:0,max:3,step:.05},mainLightColor:{label:"Main Color",value:t.mainLightColor},fillLightIntensity:{label:"Fill Light",value:t.fillLightIntensity,min:0,max:2,step:.05},fillLightColor:{label:"Fill Color",value:t.fillLightColor}},{collapsed:!0})},{collapsed:!0}),Water:p({columnWidth:{label:"Width",value:t.columnWidth,min:.5,max:10,step:.1},columnDepth:{label:"Depth",value:t.columnDepth,min:.5,max:10,step:.1},columnHeight:{label:"Height",value:t.columnHeight,min:.5,max:12,step:.1},segments:{value:t.segments,min:4,max:64,step:1},topColor:{label:"Top Color",value:t.topColor},bottomColor:{label:"Bottom Color",value:t.bottomColor},opacity:{value:t.opacity,min:0,max:1,step:.01},transmission:{value:t.transmission,min:0,max:1,step:.01},roughness:{value:t.roughness,min:0,max:1,step:.01},ior:{label:"IOR",value:t.ior,min:1,max:2.5,step:.01},thickness:{value:t.thickness,min:0,max:2,step:.01},waveHeight:{label:"Wave Height",value:t.waveHeight,min:0,max:1,step:.01},waveChoppiness:{label:"Choppiness",value:t.waveChoppiness,min:0,max:2,step:.01},waveSpeed:{label:"Wave Speed",value:t.waveSpeed,min:0,max:2,step:.01},Edges:p({showEdges:{label:"Show Edges",value:t.showEdges},edgeColor:{label:"Edge Color",value:t.edgeColor},edgeOpacity:{label:"Edge Opacity",value:t.edgeOpacity,min:0,max:1,step:.01},edgeLineWidth:{label:"Line Width",value:t.edgeLineWidth,min:.1,max:5,step:.1}},{collapsed:!0})},{collapsed:!0}),Sharks:p({HammerHead:p({hammerheadVisible:{label:"Visible",value:t.hammerheadVisible},hammerheadScale:{label:"Scale",value:t.hammerheadScale,min:.01,max:2,step:.01},hammerheadSpeed:{label:"Speed",value:t.hammerheadSpeed,min:0,max:.5,step:.005},"HammerHead Path":p({hammerheadSplineVisible:{label:"Show Spline",value:t.hammerheadSplineVisible}},{collapsed:!0})},{collapsed:!0}),"Tiger Shark 1":p({tiger1Visible:{label:"Visible",value:t.tiger1Visible},tiger1Scale:{label:"Scale",value:t.tiger1Scale,min:.001,max:.01,step:5e-4},tiger1Speed:{label:"Speed",value:t.tiger1Speed,min:0,max:.5,step:.005},"Tiger 1 Path":p({tiger1SplineVisible:{label:"Show Spline",value:t.tiger1SplineVisible}},{collapsed:!0})},{collapsed:!0}),"Tiger Shark 2":p({tiger2Visible:{label:"Visible",value:t.tiger2Visible},tiger2Scale:{label:"Scale",value:t.tiger2Scale,min:.001,max:.01,step:5e-4},tiger2Speed:{label:"Speed",value:t.tiger2Speed,min:0,max:.5,step:.005},"Tiger 2 Path":p({tiger2SplineVisible:{label:"Show Spline",value:t.tiger2SplineVisible}},{collapsed:!0})},{collapsed:!0})},{collapsed:!0}),"Post Processing":p({painterlyEnabled:{label:"Painterly",value:t.painterlyEnabled},painterlyRadius:{label:"Painterly Radius",value:t.painterlyRadius,min:1,max:10,step:1},painterlyAlpha:{label:"Stroke Direction",value:t.painterlyAlpha,min:1,max:100,step:1},painterlyQuantize:{label:"Quantize Levels",value:t.painterlyQuantize,min:2,max:32,step:1},painterlySaturation:{label:"Saturation",value:t.painterlySaturation,min:0,max:3,step:.05},painterlyPaper:{label:"Paper Strength",value:t.painterlyPaper,min:0,max:1,step:.05},"Ink + Hatch":p({outlineEnabled:{label:"Outline",value:t.outlineEnabled},outlineStrength:{label:"Outline Strength",value:t.outlineStrength,min:0,max:2,step:.01},outlineThreshold:{label:"Outline Threshold",value:t.outlineThreshold,min:0,max:1,step:.01},outlineSoftness:{label:"Outline Softness",value:t.outlineSoftness,min:.001,max:1,step:.005},hatchingEnabled:{label:"Hatching",value:t.hatchingEnabled},hatchScale:{label:"Hatch Scale",value:t.hatchScale,min:1,max:24,step:.1},hatchIntensity:{label:"Hatch Intensity",value:t.hatchIntensity,min:0,max:1,step:.01},hatchThickness:{label:"Hatch Thickness",value:t.hatchThickness,min:.1,max:2,step:.01},hatchRotation:{label:"Hatch Rotation",value:t.hatchRotation,min:-3.14159,max:3.14159,step:.01}},{collapsed:!0}),bloomEnabled:{label:"Bloom",value:t.bloomEnabled},bloomIntensity:{label:"Bloom Intensity",value:t.bloomIntensity,min:0,max:6,step:.01}},{collapsed:!0})}),{collapsed:!0});return e.current={...n},n}function ut(){const e=Ye(),{hammerheadPath:n,tigerSharkPath:i,tigerSharkPath2:s}=l.useMemo(()=>{const u=Pe["Staying Afloat"]?.splines??[];return{hammerheadPath:u.find(c=>c.name==="Hammerhead Path"),tigerSharkPath:u.find(c=>c.name==="Tiger Shark Path"),tigerSharkPath2:u.find(c=>c.name==="Tiger Shark Path 2")}},[]);return a.jsxs(a.Fragment,{children:[a.jsx("color",{attach:"background",args:[e.backgroundColor]}),a.jsx(Ve,{makeDefault:!0,position:[8.4,7.4,8.2],fov:30,near:.1,far:100,onUpdate:o=>o.lookAt(0,.4,0)}),e.cameraMode==="Orbit"&&a.jsx(De,{target:[0,.4,0]}),a.jsx("ambientLight",{intensity:e.ambientIntensity,color:e.ambientColor}),a.jsx("directionalLight",{position:[4,10,5],intensity:e.mainLightIntensity,color:e.mainLightColor,castShadow:!0,"shadow-bias":-5e-4,"shadow-normalBias":.04}),a.jsx("directionalLight",{position:[-5,2,-6],intensity:e.fillLightIntensity,color:e.fillLightColor}),a.jsx(Ie,{width:e.columnWidth,depth:e.columnDepth,height:e.columnHeight,segments:e.segments,topColor:e.topColor,bottomColor:e.bottomColor,opacity:e.opacity,transmission:e.transmission,roughness:e.roughness,ior:e.ior,thickness:e.thickness,waveHeight:e.waveHeight,waveChoppiness:e.waveChoppiness,waveSpeed:e.waveSpeed,edgeColor:e.edgeColor,edgeOpacity:e.edgeOpacity,edgeLineWidth:e.edgeLineWidth,showEdges:e.showEdges}),a.jsx(Qe,{waveHeight:e.waveHeight,waveChoppiness:e.waveChoppiness,waveSpeed:e.waveSpeed}),a.jsx(Z,{Shark:Ue,points:n?.points?.map(o=>o.position)??[],speed:e.hammerheadSpeed,scale:e.hammerheadScale,headingOffset:Math.PI,visible:e.hammerheadVisible,showSpline:e.hammerheadSplineVisible}),a.jsx(Z,{Shark:se,points:i?.points?.map(o=>o.position)??[],speed:e.tiger1Speed,scale:e.tiger1Scale,headingOffset:Math.PI,visible:e.tiger1Visible,showSpline:e.tiger1SplineVisible,sharkProps:{excludeAnimations:["attack"]}}),a.jsx(Z,{Shark:se,points:s?.points?.map(o=>o.position)??[],speed:e.tiger2Speed,scale:e.tiger2Scale,headingOffset:0,clockwise:!1,visible:e.tiger2Visible,showSpline:e.tiger2SplineVisible,sharkProps:{excludeAnimations:["attack"]}}),e.painterlyEnabled&&a.jsx(Je,{radius:e.painterlyRadius,alpha:e.painterlyAlpha,quantizeLevels:e.painterlyQuantize,saturation:e.painterlySaturation,paperStrength:e.painterlyPaper,outlineEnabled:e.outlineEnabled,outlineStrength:e.outlineStrength,outlineThreshold:e.outlineThreshold,outlineSoftness:e.outlineSoftness,hatchingEnabled:e.hatchingEnabled,hatchScale:e.hatchScale,hatchIntensity:e.hatchIntensity,hatchThickness:e.hatchThickness,hatchRotation:e.hatchRotation,bloomEnabled:e.bloomEnabled,bloomIntensity:e.bloomIntensity})]})}export{ut as default};
