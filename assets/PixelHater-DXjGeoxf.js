import{r as n,n as Z,W as F,y as U,p as _,V as C,z as me,am as B,a5 as ne,a8 as xe,aN as he,o as ae,j as e,v as se,aG as le,R as ye,aY as ve,b9 as Me,Q as Ce,a1 as be,aH as we,aZ as Pe,aa as O,c8 as Se,aU as Te,m as ke,E as je,K as re}from"./index-ByL4sTkr.js";import{E as ze,I as De,d as We,V as Be}from"./index-BfXUKtk6.js";import{C as Re,R as Ve}from"./Record-wfWujJJX.js";import{M as Ie}from"./MeshBVH-BCI2e9b-.js";import{O as Ee}from"./OrbitControls-DVYdpzny.js";import{E as Ue}from"./Environment-t39LS5Py.js";import{P as Ge}from"./shapes-DxJNcxME.js";import"./Gltf-CvGAguF_.js";import"./constants-D2UNjNOk.js";import"./extends-CF3RwP-h.js";const Ne=`
...
`;function Qe({voxelSize:a=.25,maxInstances:t=4096,clipOffset:c=0,children:f,...h}){const s=n.useRef(),g=n.useRef(),M=n.useRef(),{gl:o,scene:r,camera:m}=Z(),l=n.useMemo(()=>new F(1,1),[]),v=n.useMemo(()=>new F(1,1),[]),i=n.useMemo(()=>new le(1,1,1),[]),y=n.useMemo(()=>new U,[]),p=n.useMemo(()=>new _,[]),w=n.useMemo(()=>new C,[]),d=n.useMemo(()=>new C,[]),x=n.useMemo(()=>new C,[]),b=n.useMemo(()=>new me,[]),R=n.useMemo(()=>new B,[]),u=n.useMemo(()=>new ye,[]),z=n.useMemo(()=>new C,[]),k=n.useMemo(()=>new ne({vertexShader:Fe,fragmentShader:_e,uniforms:{clippedSceneTexture:{value:null},fullSceneTexture:{value:null},resolution:{value:new U},fallbackColor:{value:new _(1,1,1)},viewProjectionMatrix:{value:new B},cameraWorldPos:{value:new C}},transparent:!1,depthWrite:!0}),[]);return n.useEffect(()=>()=>{l.dispose(),v.dispose(),i.dispose(),k.dispose()},[l,v,i,k]),n.useLayoutEffect(()=>{const P=g.current,D=M.current;if(!P||!D||!P.geometry)return;P.geometry.computeBoundingBox();const S=P.geometry.boundingBox;if(!S)return;S.getSize(z);const V=Math.max(a,.02),I=Math.ceil(z.x/V)*Math.ceil(z.y/V)*Math.ceil(z.z/V),q=I>t?Math.ceil(Math.cbrt(I/t)):1,j=V*q,G=j*.9;let E=0;for(let N=S.min.x+j*.5;N<=S.max.x;N+=j)for(let L=S.min.y+j*.5;L<=S.max.y;L+=j)for(let A=S.min.z+j*.5;A<=S.max.z&&!(E>=t);A+=j)u.position.set(N,L,A),u.scale.set(G,G,G),u.rotation.set(0,0,0),u.updateMatrix(),D.setMatrixAt(E,u.matrix),E+=1;D.count=E,D.instanceMatrix.needsUpdate=!0},[a,t,u,z]),ae(()=>{const P=s.current;if(!P)return;o.getDrawingBufferSize(y),(l.width!==y.x||l.height!==y.y)&&(l.setSize(y.x,y.y),v.setSize(y.x,y.y)),k.uniforms.resolution.value.copy(y),R.multiplyMatrices(m.projectionMatrix,m.matrixWorldInverse),k.uniforms.viewProjectionMatrix.value.copy(R),m.getWorldPosition(x),k.uniforms.cameraWorldPos.value.copy(x),P.getWorldPosition(w),m.getWorldDirection(d),b.setFromNormalAndCoplanarPoint(d,w),b.constant+=c;const D=o.getRenderTarget(),S=o.clippingPlanes,V=o.toneMapping,I=o.getClearAlpha();o.getClearColor(p),o.toneMapping=se,r.background&&r.background.isColor?k.uniforms.fallbackColor.value.copy(r.background):k.uniforms.fallbackColor.value.setRGB(1,1,1),P.visible=!1,o.setClearColor(p,I),o.clippingPlanes=[],o.setRenderTarget(v),o.clear(),o.render(r,m),o.setClearColor(0,0),o.clippingPlanes=[b],o.setRenderTarget(l),o.clear(),o.render(r,m),o.setRenderTarget(D),o.clippingPlanes=S,o.toneMapping=V,o.setClearColor(p,I),P.visible=!0,k.uniforms.clippedSceneTexture.value=l.texture,k.uniforms.fullSceneTexture.value=v.texture}),e.jsxs("group",{ref:s,...h,children:[e.jsx("mesh",{ref:g,visible:!1,children:f}),e.jsx("instancedMesh",{ref:M,args:[i,k,t],frustumCulled:!1})]})}const H=new C;function W(a,t,c,f,h,s){const g=2*Math.PI*h/4,M=Math.max(s-2*h,0),o=Math.PI/4;H.copy(t),H[f]=0,H.normalize();const r=.5*g/(g+M),m=1-H.angleTo(a)/o;return Math.sign(H[c])===1?m*r:M/(g+M)+r+r*(1-m)}class ie extends le{constructor(t=1,c=1,f=1,h=2,s=.1){const g=h*2+1;if(s=Math.min(t/2,c/2,f/2,s),super(1,1,1,g,g,g),this.type="RoundedBoxGeometry",this.parameters={width:t,height:c,depth:f,segments:h,radius:s},g===1)return;const M=this.toNonIndexed();this.index=null,this.attributes.position=M.attributes.position,this.attributes.normal=M.attributes.normal,this.attributes.uv=M.attributes.uv;const o=new C,r=new C,m=new C(t,c,f).divideScalar(2).subScalar(s),l=this.attributes.position.array,v=this.attributes.normal.array,i=this.attributes.uv.array,y=l.length/6,p=new C,w=.5/g;for(let d=0,x=0;d<l.length;d+=3,x+=2)switch(o.fromArray(l,d),r.copy(o),r.x-=Math.sign(r.x)*w,r.y-=Math.sign(r.y)*w,r.z-=Math.sign(r.z)*w,r.normalize(),l[d+0]=m.x*Math.sign(o.x)+r.x*s,l[d+1]=m.y*Math.sign(o.y)+r.y*s,l[d+2]=m.z*Math.sign(o.z)+r.z*s,v[d+0]=r.x,v[d+1]=r.y,v[d+2]=r.z,Math.floor(d/y)){case 0:p.set(1,0,0),i[x+0]=W(p,r,"z","y",s,f),i[x+1]=1-W(p,r,"y","z",s,c);break;case 1:p.set(-1,0,0),i[x+0]=1-W(p,r,"z","y",s,f),i[x+1]=1-W(p,r,"y","z",s,c);break;case 2:p.set(0,1,0),i[x+0]=1-W(p,r,"x","z",s,t),i[x+1]=W(p,r,"z","x",s,f);break;case 3:p.set(0,-1,0),i[x+0]=1-W(p,r,"x","z",s,t),i[x+1]=1-W(p,r,"z","x",s,f);break;case 4:p.set(0,0,1),i[x+0]=1-W(p,r,"x","y",s,t),i[x+1]=1-W(p,r,"y","x",s,c);break;case 5:p.set(0,0,-1),i[x+0]=W(p,r,"x","y",s,t),i[x+1]=1-W(p,r,"y","x",s,c);break}}static fromJSON(t){return new ie(t.width,t.height,t.depth,t.segments,t.radius)}}const Oe=`
  varying vec3 vCenterWorld;
...
`,Ke=new ve(new C(-.5,-.5,-.5),new C(.5,.5,.5)),ue=new WeakMap;function Ye(a){let t=ue.get(a);return t||(t=new Ie(a),ue.set(a,t)),t}function $e(a,t){let c=t;for(;c;){if(c===a)return!0;c=c.parent}return!1}function Xe({voxelSize:a=.25,cornerRadius:t=0,insideOnly:c=!1,maxInstances:f=8192,children:h,...s}){const g=n.useRef(),M=n.useRef(),o=n.useRef(),{gl:r,scene:m,camera:l}=Z(),v=n.useMemo(()=>new F(1,1),[]),i=n.useMemo(()=>new U,[]),y=n.useMemo(()=>new _,[]),p=n.useMemo(()=>new B,[]),w=n.useMemo(()=>t>0?new ie(1,1,1,4,Math.min(t,.49)):new le(1,1,1),[t]),d=n.useMemo(()=>new ne({vertexShader:Oe,fragmentShader:He,uniforms:{fullSceneTexture:{value:null},resolution:{value:new U},fallbackColor:{value:new _(1,1,1)},viewProjectionMatrix:{value:new B}},transparent:!1,depthWrite:!0}),[]);return n.useEffect(()=>{o.current&&(o.current.geometry=w)},[w]),n.useEffect(()=>()=>{v.dispose(),w.dispose(),d.dispose()},[v,w,d]),n.useLayoutEffect(()=>{const x=M.current,b=o.current,R=g.current;if(!x||!b||!R||!x.geometry)return;x.updateWorldMatrix(!0,!1),x.geometry.computeBoundingBox();const u=x.geometry.boundingBox;if(!u)return;const z=u.clone().applyMatrix4(x.matrixWorld),k=new ve,P=[];if(m.traverse(T=>{if(!T.isMesh||!T.visible||!T.geometry||!T.geometry.attributes?.position||$e(R,T)||(T.geometry.boundingBox||T.geometry.computeBoundingBox(),!T.geometry.boundingBox)||(k.copy(T.geometry.boundingBox).applyMatrix4(T.matrixWorld),!k.intersectsBox(z)))return;const Q=Ye(T.geometry);P.push({bvh:Q,worldToLocal:new B().copy(T.matrixWorld).invert()})}),P.length===0){b.count=0,b.instanceMatrix.needsUpdate=!0;return}const D=Math.max(a,.01),S=u.getSize(new C),V=Math.ceil(S.x/D)*Math.ceil(S.y/D)*Math.ceil(S.z/D),I=Math.max(f*4,2e4),q=V>I?Math.ceil(Math.cbrt(V/I)):1,j=D*q,G=new C,E=new C,N=new B,L=new B,A=new B,de=new Ce,ge=new C().setScalar(j),K=new Me;K.direction.set(0,0,1);let Y=0,J=!1;for(let T=u.min.x+j*.5;T<=u.max.x;T+=j){for(let Q=u.min.y+j*.5;Q<=u.max.y;Q+=j){for(let ee=u.min.z+j*.5;ee<=u.max.z;ee+=j){if(Y>=f){J=!0;break}G.set(T,Q,ee),N.compose(G,de,ge),L.multiplyMatrices(x.matrixWorld,N),E.copy(G),x.localToWorld(E);let $=!1,oe=!1;for(let te=0;te<P.length;te+=1){const X=P[te];if(A.multiplyMatrices(X.worldToLocal,L),X.bvh.intersectsBox(Ke,A)&&($=!0),!$||c){K.origin.copy(E).applyMatrix4(X.worldToLocal);const ce=X.bvh.raycastFirst(K,be);ce&&ce.face.normal.dot(K.direction)>0&&(oe=!0)}if($&&oe)break}($&&!c||oe)&&(b.setMatrixAt(Y,N),Y+=1)}if(J)break}if(J)break}b.count=Y,b.instanceMatrix.needsUpdate=!0},[a,c,f,m]),ae(()=>{const x=g.current;if(!x)return;r.getDrawingBufferSize(i),(v.width!==i.x||v.height!==i.y)&&v.setSize(i.x,i.y),d.uniforms.resolution.value.copy(i),p.multiplyMatrices(l.projectionMatrix,l.matrixWorldInverse),d.uniforms.viewProjectionMatrix.value.copy(p);const b=r.getRenderTarget(),R=r.toneMapping,u=r.getClearAlpha();r.getClearColor(y),r.toneMapping=se,m.background&&m.background.isColor?d.uniforms.fallbackColor.value.copy(m.background):d.uniforms.fallbackColor.value.setRGB(1,1,1),x.visible=!1,r.setClearColor(y,u),r.setRenderTarget(v),r.clear(),r.render(m,l),r.setRenderTarget(b),r.toneMapping=R,r.setClearColor(y,u),x.visible=!0,d.uniforms.fullSceneTexture.value=v.texture}),e.jsxs("group",{ref:g,...s,children:[e.jsx("mesh",{ref:M,visible:!1,children:h}),e.jsx("instancedMesh",{ref:o,args:[w,d,f],frustumCulled:!1})]})}function Ze({effectShape:a,pixelSize:t,refraction:c,planeWidth:f,planeHeight:h,voxelMode:s,voxelSize:g,voxelSteps:M,cornerRadius:o,insideOnly:r}){const m=s!=="pixel";let l=Re;m&&(s==="voxelInstanced"?l=Qe:s==="voxelInterior"?l=Xe:l=Ae);let v={};m&&(s==="voxelInstanced"?v={voxelSize:g}:s==="voxelInterior"?v={voxelSize:g,cornerRadius:o,insideOnly:r}:v={mode:s,voxelSize:g,voxelSteps:M});const i=m?{pixelSize:t,...v}:{pixelSize:t,refraction:c};return e.jsxs(e.Fragment,{children:[a==="Plane"&&e.jsx(l,{...i,children:e.jsx("planeGeometry",{args:[f,h]})}),a==="TwoPanes"&&e.jsxs(e.Fragment,{children:[e.jsx(l,{...i,position:[.5,.5,0],children:e.jsx("planeGeometry",{args:[1,1]})}),e.jsx(l,{...i,position:[-.5,-.5,0],children:e.jsx("planeGeometry",{args:[1,1]})})]}),a==="Cube"&&e.jsx(l,{...i,children:e.jsx("boxGeometry",{args:[1,1,1]})}),a==="Cubes"&&e.jsx(l,{...i,clipOffset:.5,position:[0,0,1],children:e.jsx("boxGeometry",{args:[1,1,1]})}),a==="Torus"&&e.jsx(l,{...i,children:e.jsx("torusGeometry",{args:[.5,.15,16,100]})}),a==="Sphere"&&e.jsx(l,{...i,children:e.jsx("sphereGeometry",{args:[.4,32,32]})}),a==="Knot"&&e.jsx(l,{...i,children:e.jsx("torusKnotGeometry",{args:[.5,.1,100,16]})})]})}const pe=n.createContext(null);function qe({children:a}){const t=n.useContext(pe);return t?we(e.jsx("group",{children:n.Children.map(a,c=>n.isValidElement(c)?n.cloneElement(c,{material:new Pe({color:"white"})}):null)}),t):null}class fe extends ze{constructor(t,c,{pixelSize:f=8,maskScene:h}){super("PixelMaskEffect",`
