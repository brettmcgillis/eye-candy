              ...
              Projector: folder(
                {
                  ...
                  projectorTintColor: {
                    label: 'Tint',
                    value: preset.projectorTintColor,
                  },
                  projectorTintStrength: {
                    label: 'Tint Strength',
                    value: preset.projectorTintStrength,
                    min: 0,
                    max: 1,
                    step: 0.01,
                  },
                  projectorBlur: {
                    label: 'Blur',
                    value: preset.projectorBlur,
                    min: 0,
                    max: 4,
                    step: 0.05,
                  },
                  projectorCausticAmount: {
                    label: 'Caustics',
                    value: preset.projectorCausticAmount,
                    min: 0,
                    max: 1,
                    step: 0.01,
                  },
                  projectorCausticScale: {
                    label: 'Caustic Scale',
                    value: preset.projectorCausticScale,
                    min: 1,
                    max: 16,
                    step: 0.1,
                  },
                  projectorCausticContrast: {
                    label: 'Caustic Contrast',
                    value: preset.projectorCausticContrast,
                    min: 0,
                    max: 0.8,
                    step: 0.01,
                  },
                  projectorCausticSpeed: {
                    label: 'Caustic Speed',
                    value: preset.projectorCausticSpeed,
                    min: 0,
                    max: 2,
                    step: 0.01,
                  },
