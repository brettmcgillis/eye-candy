...
- `src/components/scenes/WebGPU/CrossTalk/components/FluidSimView.jsx`

- [ ] remove crossbars from cells
- [ ] incorporate the oct tree style cells from PourOneOut
- [ ] build out a game of life mode where fireflies multiply, hunters feed & multiply
