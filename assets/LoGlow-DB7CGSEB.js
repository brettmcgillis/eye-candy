import{ai as je,b6 as ke,aj as Le,ab as B,ad as X,q as O,ag as P,W as k,H,V as A,a0 as Ve,b0 as Qe,bb as ae,al as re,ch as $e,cJ as He,r as l,o as te,m as W,c9 as Ne,n as L,p as Ge,ak as We,aR as N,af as G,aT as oe,j as u,aO as le,aS as Ke,J as Ye,U as b}from"./index-Cz5-dIPW.js";import{r as F,s as Q}from"./math-C0Z1meOP.js";import{a as ne}from"./react-spring_three.modern-BjAZLomp.js";import{u as ue}from"./Gltf-Dom-iEU4.js";import{P as Je}from"./PerspectiveCamera-CAAs_6HK.js";import{_ as he}from"./extends-CF3RwP-h.js";import{v as qe}from"./constants-Cxunp0s0.js";import"./constants-CMKWQZ-t.js";import"./Fbo-BGqhwdi6.js";var Xe=Object.defineProperty,Ze=(r,e,t)=>e in r?Xe(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,D=(r,e,t)=>(Ze(r,typeof e!="symbol"?e+"":e,t),t);class V{constructor(){D(this,"enabled",!0),D(this,"needsSwap",!0),D(this,"clear",!1),D(this,"renderToScreen",!1)}setSize(e,t){}render(e,t,o,a,s){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}class ce{constructor(e){D(this,"camera",new je(-1,1,1,-1,0,1)),D(this,"geometry",new ke(2,2)),D(this,"mesh"),this.mesh=new Le(this.geometry,e)}get material(){return this.mesh.material}set material(e){this.mesh.material=e}dispose(){this.mesh.geometry.dispose()}render(e){e.render(this.mesh,this.camera)}}var et=Object.defineProperty,tt=(r,e,t)=>e in r?et(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t,$=(r,e,t)=>(tt(r,typeof e!="symbol"?e+"":e,t),t);class Z extends V{constructor(e,t="tDiffuse"){super(),$(this,"textureID"),$(this,"uniforms"),$(this,"material"),$(this,"fsQuad"),this.textureID=t,e instanceof B?(this.uniforms=e.uniforms,this.material=e):(this.uniforms=X.clone(e.uniforms),this.material=new B({defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new ce(this.material)}render(e,t,o){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=o.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.fsQuad.dispose(),this.material.dispose()}}const ee={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
    varying vec2 vUv;
  ...
  `},vt=l.forwardRef(({children:r,multisamping:e=8,renderIndex:t=1,disableRender:o,disableGamma:a,disableRenderPass:s,depthBuffer:i=!0,stencilBuffer:n=!1,anisotropy:d=1,colorSpace:h,type:v,...g},c)=>{l.useMemo(()=>te({EffectComposer:ct,RenderPass:dt,ShaderPass:Z}),[]);const m=l.useRef(null);l.useImperativeHandle(c,()=>m.current,[]);const{scene:y,camera:M,gl:C,size:f,viewport:p}=W(),[_]=l.useState(()=>{const x=new k(f.width,f.height,{type:v||H,format:ae,depthBuffer:i,stencilBuffer:n,anisotropy:d});return v===Ne&&h!=null&&(x.texture.colorSpace=h),x.samples=e,x});l.useEffect(()=>{var x,I;(x=m.current)==null||x.setSize(f.width,f.height),(I=m.current)==null||I.setPixelRatio(p.dpr)},[C,f,p.dpr]),L(()=>{var x;o||(x=m.current)==null||x.render()},t);const T=[];return s||T.push(l.createElement("renderPass",{key:"renderpass",attach:`passes-${T.length}`,args:[y,M]})),a||T.push(l.createElement("shaderPass",{attach:`passes-${T.length}`,key:"gammapass",args:[pt]})),l.Children.forEach(r,x=>{x&&T.push(l.cloneElement(x,{key:T.length,attach:`passes-${T.length}`}))}),l.createElement("effectComposer",he({ref:m,args:[C,_]},g),T)});class gt extends B{constructor(){super({uniforms:{time:{value:0},pixelRatio:{value:1}},vertexShader:`
      ...
      `,fragmentShader:`
        ...
        void main() {
          ...
          #include <${qe>=154?"colorspace_fragment":"encodings_fragment"}>
        }
      `})}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}get pixelRatio(){return this.uniforms.pixelRatio.value}set pixelRatio(e){this.uniforms.pixelRatio.value=e}}const fe=r=>r&&r.constructor===Float32Array,bt=r=>[r.r,r.g,r.b],me=r=>r instanceof P||r instanceof A||r instanceof We,de=r=>Array.isArray(r)?r:me(r)?r.toArray():[r,r,r];function j(r,e,t){return l.useMemo(()=>{if(e!==void 0){if(fe(e))return e;if(e instanceof O){const o=Array.from({length:r*3},()=>bt(e)).flat();return Float32Array.from(o)}else if(me(e)||Array.isArray(e)){const o=Array.from({length:r*3},()=>de(e)).flat();return Float32Array.from(o)}return Float32Array.from({length:r},()=>e)}return Float32Array.from({length:r},t)},[e])}const xt=l.forwardRef(({noise:r=1,count:e=100,speed:t=1,opacity:o=1,scale:a=1,size:s,color:i,children:n,...d},h)=>{l.useMemo(()=>te({SparklesImplMaterial:gt}),[]);const v=l.useRef(null),g=W(_=>_.viewport.dpr),c=de(a),m=l.useMemo(()=>Float32Array.from(Array.from({length:e},()=>c.map(Ge.randFloatSpread)).flat()),[e,...c]),y=j(e,s,Math.random),M=j(e,o),C=j(e,t),f=j(e*3,r),p=j(i===void 0?e*3:e,fe(i)?i:new O(i),()=>1);return L(_=>{v.current&&v.current.material&&(v.current.material.time=_.clock.elapsedTime)}),l.useImperativeHandle(h,()=>v.current,[]),l.createElement("points",he({key:`particle-${e}-${JSON.stringify(a)}`},d,{ref:v}),l.createElement("bufferGeometry",null,l.createElement("bufferAttribute",{attach:"attributes-position",args:[m,3]}),l.createElement("bufferAttribute",{attach:"attributes-size",args:[y,1]}),l.createElement("bufferAttribute",{attach:"attributes-opacity",args:[M,1]}),l.createElement("bufferAttribute",{attach:"attributes-speed",args:[C,1]}),l.createElement("bufferAttribute",{attach:"attributes-color",args:[p,3]}),l.createElement("bufferAttribute",{attach:"attributes-noise",args:[f,3]})),n||l.createElement("sparklesImplMaterial",{transparent:!0,pixelRatio:g,depthWrite:!1}))});function yt(){const r=W(e=>e.gl);return l.useEffect(()=>(r.shadowMap.autoUpdate=!1,r.shadowMap.needsUpdate=!0,()=>{r.shadowMap.autoUpdate=r.shadowMap.needsUpdate=!0}),[r.shadowMap]),null}function pe(r,e=8,t=2,o=10){const a=r/1e3,s=Math.random()*t,i=Math.sin(a*2*Math.PI*o),n=e+t*i+s;return Math.max(1,Math.min(10,n))}function Ct({innerMaterial:r,outerMaterial:e,innerProps:t,outerProps:o,...a}){const{nodes:s}=ue(le("Bret.glb"));return u.jsx("group",{...a,dispose:null,children:u.jsxs("group",{rotation:[Math.PI/2,0,0],children:[u.jsx(ne.mesh,{castShadow:!0,receiveShadow:!0,geometry:s["bret-in"].geometry,material:r,scale:[10,.524,10],...t}),u.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:s["bret-out"].geometry,material:e,scale:[10,.524,10],...o})]})})}function St({pressDepth:r=.012,emissiveIntensity:e=2.5,enableNeonFlicker:t=!0,neonFlickerIntensity:o=2,neonFlickerFrequency:a=10,innerColor:s="#ff0000",outerColor:i="#000000",onClick:n,...d}){const[h,v]=l.useState(!0),[g,c]=l.useState(!1),m=l.useMemo(()=>new N({color:s,emissive:s,emissiveIntensity:0,side:G}),[s]),y=l.useMemo(()=>new N({color:i,side:G}),[i]),{pressY:M}=oe({pressY:g?-r:0,config:{mass:.6,tension:320,friction:16}});L(({clock:f})=>{if(!m)return;let p=0;h&&t?p=pe(f.getElapsedTime(),e,o,a):h&&(p=e),m.emissiveIntensity=p});const C={onPointerDown:f=>{f.stopPropagation(),c(!0)},onPointerUp:f=>{f.stopPropagation(),c(!1),v(p=>!p),n?.()},onPointerLeave:()=>c(!1)};return u.jsx(Ct,{...d,innerMaterial:m,outerMaterial:y,innerProps:{"position-y":M,...C},outerProps:C})}function Tt({innerMaterial:r,outerMaterial:e,innerProps:t={},outerProps:o={},...a}){const{nodes:s}=ue(le("Reversal.glb")),i=n=>Ke.isValidElement(n);return u.jsx("group",{...a,dispose:null,children:u.jsxs("group",{rotation:[Math.PI/2,0,0],children:[r&&u.jsx(ne.mesh,{castShadow:!0,receiveShadow:!0,geometry:s["reversal-in"].geometry,scale:[10,1.018,10],...t,children:i(r)?r:u.jsx("primitive",{attach:"material",object:r})}),e&&u.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:s["reversal-out"].geometry,scale:[10,1.018,10],...o,children:i(e)?e:u.jsx("primitive",{attach:"material",object:e})})]})})}function wt({pressDepth:r=.015,emissiveIntensity:e=2.5,enableNeonFlicker:t=!0,neonFlickerIntensity:o=2,neonFlickerFrequency:a=10,innerColor:s="#ff0000",outerColor:i="#000000",onClick:n,...d}){const[h,v]=l.useState(!0),[g,c]=l.useState(!1),m=l.useMemo(()=>new N({color:s,emissive:s,emissiveIntensity:0,side:G}),[s]),y=l.useMemo(()=>new N({color:i,side:G}),[i]),{pressY:M}=oe({pressY:g?-r:0,config:{mass:.6,tension:300,friction:14}});L(({clock:f})=>{if(!m)return;let p=0;h&&t?p=pe(f.getElapsedTime(),e,o,a):h&&(p=e),m.emissiveIntensity=p});const C={onPointerDown:f=>{f.stopPropagation(),n?.(),c(!0)},onPointerUp:f=>{f.stopPropagation(),c(!1),v(p=>!p)},onPointerLeave:()=>c(!1)};return u.jsx(Tt,{...d,innerMaterial:m,outerMaterial:y,outerProps:C,innerProps:{"position-y":M,...C}})}function Mt(r,e,t){const o=r%(e+t);return o<e?0:(o-e)/t*2*Math.PI}function Pt({bretPosition:r={x:0,y:0,z:0},bretRotation:e={x:0,y:0,z:0},bretInnerColor:t="#FF0000",bretInnerColorEmissiveIntensity:o=0,bretOuterColor:a="#000000",reversalPosition:s={x:.9,y:-.4,z:0},reversalRotation:i={x:0,y:0,z:0},reversalInnerColor:n="#FF0000",reversalInnerColorEmissiveIntensity:d=0,reversalOuterColor:h="#000000",float:v=!0,floatSpeed:g=1,floatIntensity:c=.05,flip:m=!0,flipDelay:y=4,flipDuration:M=2,spin:C=!0,spinRotation:f=33,spinSpeed:p=.4,enableNeonFlicker:_=!0,neonFlickerIntensity:T=2,neonFlickerFrequency:x=10,bretPressDepth:I=.012,reversalPressDepth:K=.015,...Y}){const S=l.useRef(),U=l.useRef(),R=l.useMemo(()=>({x:(r.x+s.x)/2,y:(r.y+s.y)/2,z:(r.z+s.z)/2}),[r.x,r.y,r.z,s.x,s.y,s.z]);return L(({clock:J})=>{const E=J.getElapsedTime();!S.current||!U.current||(v?S.current.position.y=Q(E,g,c):S.current.position.y!==0&&(S.current.position.y=Q(E,g*2,c),Math.abs(S.current.position.y)<.01&&(S.current.position.y=0)),C?S.current.rotation.y=F(Q(E,p,f)):S.current.rotation.y!==0&&(S.current.rotation.y=F(Q(E,p*2,f)),Math.abs(S.current.rotation.y)<.1&&(S.current.rotation.y=0)),(m||U.current.rotation.x!==0)&&(U.current.rotation.x=Mt(E,y,M)))}),u.jsx("group",{...Y,dispose:null,children:u.jsxs("group",{ref:S,children:[u.jsx("group",{position:[r.x-R.x,r.y-R.y,r.z-R.z],rotation:[F(e.x),F(e.y),F(e.z)],children:u.jsx(St,{pressDepth:I,emissiveIntensity:o,enableNeonFlicker:_,neonFlickerIntensity:T,neonFlickerFrequency:x,innerColor:t,outerColor:a})}),u.jsx("group",{position:[s.x-R.x,s.y-R.y,s.z-R.z],rotation:[F(i.x),F(i.y),F(i.z)],children:u.jsx("group",{ref:U,children:u.jsx(wt,{pressDepth:K,emissiveIntensity:d,enableNeonFlicker:_,neonFlickerIntensity:T,neonFlickerFrequency:x,innerColor:n,outerColor:h})})})]})})}function _t(){return Ye("LoGlow",{Background:b({backgroundColor:{label:"Color",value:"#202030"},Fog:b({fogColor:{label:"Color",value:"#202030"},fogNear:{label:"Near",value:10},fogFar:{label:"Far",value:25}},{collapsed:!0})},{collapsed:!0}),Lighting:b({Ambient:b({ambientColor:{label:"Color",value:"#ffffff"},ambientIntensity:{label:"Intensity",value:.35,min:0,max:3}},{collapsed:!0}),Key:b({keyColor:{label:"Key Color",value:"#ffffff"},keyIntensity:{label:"Key Intensity",value:1.1,min:0,max:5},keyPosition:{label:"Position",value:{x:2.5,y:2,z:4}}},{collapsed:!0})},{collapsed:!0}),Bloom:b({bloomThreshold:{label:"Threshold",value:.1,min:0,max:10},bloomStrength:{label:"Strength",value:.2,min:0,max:10},bloomRadius:{label:"Radius",value:.2,min:0,max:10}},{collapsed:!0}),Sparkles:b({sparkleCount:{label:"Count",value:100,min:10,max:500},sparkleSpeed:{label:"Speed",value:.71,min:0,max:10},sparkleOpactity:{label:"Opacity",value:.7,min:0,max:1},sparkleColor:{label:"Color",value:"#FFFFFF"},sparkleSize:{label:"Size",value:.7,min:.1,max:10},sparkleScale:{label:"Scale",value:3.6,min:0,max:10},sparkleNoise:{label:"Noise",value:1,min:0,max:10}},{collapsed:!0}),Logo:b({Bret:b({bretPosition:{label:"Position",value:{x:0,y:0,z:0}},bretRotation:{label:"Rotation",value:{x:0,y:0,z:0}},bretPressDepth:{label:"Depth",value:.012,min:0,max:.1,step:.001},"Inner Color":b({bretInnerColor:{label:"Color",value:"#FF0000"},bretInnerColorEmissive:{label:"Emissive",value:!0},bretInnerColorEmissiveIntensity:{label:"Intensity",value:5,min:0,max:10,step:.1}},{collapsed:!0}),"Outer Color":b({bretOuterColor:{label:"Color",value:"#000000"},bretOuterColorEmissive:{label:"Emissive",value:!1},bretOuterColorEmissiveIntensity:{label:"Intensity",value:0,min:0,max:10,step:.1}},{collapsed:!0})},{collapsed:!0}),Reversal:b({reversalPosition:{label:"Position",value:{x:.9,y:-.4,z:0}},reversalRotation:{label:"Rotation",value:{x:0,y:0,z:0}},reversalPressDepth:{label:"Depth",value:.015,min:0,max:.1,step:.001},"Inner Color":b({reversalInnerColor:{label:"Color",value:"#FF0000"},reversalInnerColorEmissive:{label:"Emissive",value:!0},reversalInnerColorEmissiveIntensity:{label:"Intensity",value:5,min:0,max:10,step:.1}},{collapsed:!0}),"Outer Color":b({reversalOuterColor:{label:"Color",value:"#000000"},reversalOuterColorEmissive:{label:"Emissive",value:!1},reversalOuterColorEmissiveIntensity:{label:"Intensity",value:0,min:0,max:10,step:.1}},{collapsed:!0})},{collapsed:!0}),Neon:b({enableNeonFlicker:{label:"Flicker",value:!0},neonFlickerIntensity:{label:"Intensity",value:2,min:.1,max:10},neonFlickerFrequency:{label:"Frequency",value:10,min:.1,max:10}},{collapsed:!0}),Flip:b({flip:{label:"Enabled",value:!0},flipDuration:{label:"Duration",value:2,min:1,max:2,step:.01},flipDelay:{label:"Delay",value:4,min:0,max:10,step:.01}},{collapsed:!0}),Float:b({float:{label:"Enabled",value:!0},floatSpeed:{label:"Speed",value:1,min:0,max:10,step:.01},floatIntensity:{label:"Intensity",value:.05,min:0,max:1,step:.01}},{collapsed:!0}),Spin:b({spin:{label:"Enabled",value:!0},spinRotation:{label:"Rotation",value:33,min:0,max:360,step:1},spinSpeed:{label:"Speed",value:.4,min:0,max:1,step:.01}},{collapsed:!0})},{collapsed:!0})},{collapsed:!0})}te({UnrealBloomPass:at});function Ot(){const{size:r}=W(),e=r.width<=768?6.5:5,t=r.width<=768?0:-.2,{backgroundColor:o,fogColor:a,fogNear:s,fogFar:i,ambientColor:n,ambientIntensity:d,keyColor:h,keyIntensity:v,keyPosition:g,bloomThreshold:c,bloomStrength:m,bloomRadius:y,bretPosition:M,bretRotation:C,bretInnerColor:f,bretInnerColorEmissive:p,bretInnerColorEmissiveIntensity:_,bretOuterColor:T,bretOuterColorEmissive:x,bretOuterColorEmissiveIntensity:I,reversalPosition:K,reversalRotation:Y,reversalInnerColor:S,reversalInnerColorEmissive:U,reversalInnerColorEmissiveIntensity:R,reversalOuterColor:J,reversalOuterColorEmissive:E,reversalOuterColorEmissiveIntensity:ve,bretPressDepth:ge,reversalPressDepth:be,flip:xe,flipDelay:ye,flipDuration:Ce,float:Se,floatSpeed:Te,floatIntensity:we,spin:Me,spinRotation:Pe,spinSpeed:_e,sparkleColor:Re,sparkleCount:Fe,sparkleNoise:Ee,sparkleOpactity:ze,sparkleScale:Be,sparkleSize:De,sparkleSpeed:Ie,enableNeonFlicker:Ue,neonFlickerIntensity:Ae,neonFlickerFrequency:Oe}=_t();return u.jsxs(u.Fragment,{children:[u.jsx("ambientLight",{color:n,intensity:d}),u.jsx("directionalLight",{color:h,intensity:v,position:[g.x,g.y,g.z]}),u.jsx(Je,{makeDefault:!0,position:[0,0,e]}),u.jsx(yt,{}),u.jsx("color",{attach:"background",args:[o]}),u.jsx("fog",{attach:"fog",args:[a,s,i]}),u.jsx(Pt,{scale:2,position:[0,t,0],bretPosition:M,bretRotation:C,bretInnerColor:f,bretInnerColorEmissive:p,bretInnerColorEmissiveIntensity:_,bretOuterColor:T,bretOuterColorEmissive:x,bretOuterColorEmissiveIntensity:I,reversalPosition:K,reversalRotation:Y,reversalInnerColor:S,reversalInnerColorEmissive:U,reversalInnerColorEmissiveIntensity:R,reversalOuterColor:J,reversalOuterColorEmissive:E,reversalOuterColorEmissiveIntensity:ve,enableNeonFlicker:Ue,neonFlickerIntensity:Ae,neonFlickerFrequency:Oe,bretPressDepth:ge,reversalPressDepth:be,flip:xe,flipDelay:ye,flipDuration:Ce,float:Se,floatSpeed:Te,floatIntensity:we,spin:Me,spinRotation:Pe,spinSpeed:_e}),u.jsx(xt,{count:Fe,speed:Ie,opacity:ze,color:Re,size:De,scale:Be,noise:Ee}),u.jsx(vt,{disableGamma:!0,children:u.jsx("unrealBloomPass",{threshold:c,strength:m,radius:y})})]})}export{Ot as default};
