      ...
      Datamosh: folder(
        {
          ...
          postDatamoshResidual: {
            label: 'Residual',
            min: 0,
            max: 3,
            step: 0.01,
            value: preset.postDatamoshResidual,
          },
          postDatamoshResidualSteps: {
            label: 'Residual Steps',
            min: 0,
            max: 64,
            step: 1,
            value: preset.postDatamoshResidualSteps,
          },
          postDatamoshVectorSnap: {
            label: 'Vector Snap (per px)',
            min: 0,
            max: 8,
            step: 1,
            value: preset.postDatamoshVectorSnap,
          },
          postDatamoshSkipThreshold: {
            label: 'Skip Threshold (px)',
            min: 0,
            max: 8,
            step: 0.05,
            value: preset.postDatamoshSkipThreshold,
          },
          postDatamoshWrongVectors: {
            label: 'Wrong Vectors',
            min: 0,
            max: 1,
            step: 0.01,
            value: preset.postDatamoshWrongVectors,
          },
          postDatamoshLossLayers: {
            label: 'Loss Layers',
            min: 0,
            max: 3,
            step: 1,
            value: preset.postDatamoshLossLayers,
          },
          postDatamoshLossCell: {
            label: 'Loss Cell (px)',
            min: 4,
            max: 256,
            step: 1,
            value: preset.postDatamoshLossCell,
          },
          postDatamoshLossLife: {
            label: 'Loss Life (s)',
            min: 0.05,
            max: 3,
            step: 0.01,
            value: preset.postDatamoshLossLife,
          },
          postDatamoshLossChance: {
            label: 'Loss Chance',
            min: 0,
            max: 1,
            step: 0.01,
            value: preset.postDatamoshLossChance,
          },
        },
        { collapsed: true }
      ),
