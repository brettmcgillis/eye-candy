import{r as c,d as g,j as o,F as C,B as S,C as x,e as j,k as M,m as h,aN as k,s as P}from"./index-D4JliqBF.js";import{u as U,S as b}from"./tracks-B2oj_ps8.js";import{s as y}from"./shaderMaterial-BD4yfprO.js";import{O as z}from"./OrbitControls-Cv98jc_6.js";import{H as E}from"./Html-Fa9DbbTu.js";import{G as F}from"./Grid-BhQ9Je29.js";import"./extends-CF3RwP-h.js";import"./constants-CdyDop-_.js";const R=y({uTime:0,uColorTop:new x("#ff9bf5"),uColorBottom:new x("#ff2fa4"),uBands:12,uIntensity:2.2},`
    varying vec2 vUv;
  ...
  `);j({SunMaterial:R});function m({colorTop:e="#ff9bf5",colorBottom:t="#ff2fa4",bands:l=12,intensity:r=2.2,...i}){const n=c.useRef();return g((d,u)=>{n.current&&(n.current.uTime+=u)}),o.jsxs("mesh",{...i,children:[o.jsx("sphereGeometry",{args:[1.5,64,64]}),o.jsx("sunMaterial",{ref:n,side:C,depthWrite:!0,depthTest:!0,uColorTop:e,uColorBottom:t,uBands:l,uIntensity:r})]})}function T({colorTop:e="#ff9bf5",colorBottom:t="#ff2fa4",innerColorTop:l="#6b2cff",innerColorBottom:r="#14002b",bands:i=12,intensity:n=2.2,radius:d=1.5,...u}){const s=c.useRef(),p=c.useRef();return g((v,a)=>{s.current&&(s.current.uTime+=a),p.current&&(p.current.uTime+=a*.6)}),o.jsxs("group",{...u,children:[o.jsxs("mesh",{children:[o.jsx("sphereGeometry",{args:[d,64,64]}),o.jsx("sunMaterial",{ref:s,side:C,depthWrite:!0,depthTest:!0,uColorTop:e,uColorBottom:t,uBands:i,uIntensity:n})]}),o.jsxs("mesh",{scale:.992,children:[o.jsx("sphereGeometry",{args:[d,64,64]}),o.jsx("sunMaterial",{ref:p,side:S,depthWrite:!0,depthTest:!0,uColorTop:l,uColorBottom:r,uBands:i,uIntensity:n*.75})]})]})}const B={Miami:{bg:"#07000f",grid:"#ff4fd8",wire:"#00f6ff",accent:"#ffe66d",fog:"#2b0051",skyTop:"#ff4fd8",skyBottom:"#00f6ff"},CyberSunset:{bg:"#02010a",grid:"#ff8c42",wire:"#b967ff",accent:"#2de2e6",fog:"#220039",skyTop:"#ff8c42",skyBottom:"#b967ff"},MonoNeon:{bg:"#000000",grid:"#00ff9c",wire:"#00ff9c",accent:"#ffffff",fog:"#00422e",skyTop:"#008b56",skyBottom:"#000000"}};function f({children:e,speed:t=.25,amp:l=.6}){const r=c.useRef();return g(i=>{const n=i.clock.elapsedTime*t;r.current&&(r.current.position.y=Math.sin(n)*l,r.current.rotation.y+=.002,r.current.rotation.x=Math.sin(n*.6)*.04)}),o.jsx("group",{ref:r,children:e})}const D=y({uTop:new x("#2b0f3f"),uBottom:new x("#060010")},`
    varying vec3 vPos;
    void main() {
      vPos = position;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0);
