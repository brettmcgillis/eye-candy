...
export const DEFAULT_AISLE_LABEL = 'AISLE 9';
...
export function resolveSurveillanceFrameBounds(size) {
...
export function createSecurityCamTimestampTexture() {
...
export function drawSecurityCamTimestamp(
  textureState,
