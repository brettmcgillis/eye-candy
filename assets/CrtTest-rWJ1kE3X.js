import{r as t,n as de,aU as Ee,R as Ie,aH as _e,o as H,j as e,t as J,aM as Ge,a5 as oe,av as me,p as Ne,m as ee,W as ue,cU as Oe,cV as Le,ax as We,cW as Ke,b_ as $,cX as He,cY as Ye,aA as pe,az as X,aB as z,E as K,K as F,cZ as ze}from"./index-DBD_Xnl5.js";import{S as ve,u as $e}from"./tracks-CI69qH4A.js";import{s as te}from"./shaderMaterial-ByNLeYVs.js";import{_ as Xe}from"./extends-CF3RwP-h.js";import{u as Ze}from"./Fbo-BDjscY95.js";import{C as he}from"./crtStaticMaterial-BcpF4zui.js";import{B as qe}from"./Bret-Co5k9XzY.js";import{I as xe,R as fe}from"./Reversal-BTvQ7bTV.js";import{P as ge}from"./PerspectiveCamera-DpuSrB_N.js";import{a as Se}from"./react-spring_three.modern-DqiMaJxn.js";import{u as be}from"./Gltf-B5MMxcwU.js";import{M as Qe}from"./Instances-Ca7j-qYC.js";import{O as Je}from"./OrbitControls-tYOv5LEv.js";import{E as et}from"./Environment-DUYC-JuS.js";import{M as tt}from"./MeshReflectorMaterial-C3UxaO1Q.js";import"./constants-ueQBMVxJ.js";import"./deprecated-CtTvmxFP.js";import"./constants-M1-70t4d.js";const at=t.forwardRef(({children:r,compute:u,width:p,height:c,samples:s=8,renderPriority:v=0,eventPriority:l=0,frames:i=1/0,stencilBuffer:f=!1,depthBuffer:a=!0,generateMipmaps:m=!1,...b},w)=>{const{size:x,viewport:T}=de(),S=Ze((p||x.width)*T.dpr,(c||x.height)*T.dpr,{samples:s,stencilBuffer:f,depthBuffer:a,generateMipmaps:m}),[d]=t.useState(()=>new Ee),k=t.useCallback((M,y,R)=>{var g,n;let C=(g=S.texture)==null||(g=g.__r3f.parent)==null?void 0:g.object;for(;C&&!(C instanceof Ie);){var h;C=(h=C.__r3f.parent)==null?void 0:h.object}if(!C)return!1;R.raycaster.camera||R.events.compute(M,R,(n=R.previousRoot)==null?void 0:n.getState());const[A]=R.raycaster.intersectObject(C);if(!A)return!1;const V=A.uv;if(!V)return!1;y.raycaster.setFromCamera(y.pointer.set(V.x*2-1,V.y*2-1),y.camera)},[]);return t.useImperativeHandle(w,()=>S.texture,[S]),t.createElement(t.Fragment,null,_e(t.createElement(rt,{renderPriority:v,frames:i,fbo:S},r,t.createElement("group",{onPointerOver:()=>null})),d,{events:{compute:u||k,priority:l}}),t.createElement("primitive",Xe({object:S.texture},b)))});function rt({frames:r,renderPriority:u,children:p,fbo:c}){let s=0,v,l,i,f;return H(a=>{(r===1/0||s<r)&&(v=a.gl.autoClear,l=a.gl.xr.enabled,i=a.gl.getRenderTarget(),f=a.gl.xr.isPresenting,a.gl.autoClear=!0,a.gl.xr.enabled=!1,a.gl.xr.isPresenting=!1,a.gl.setRenderTarget(c),a.gl.render(a.scene,a.camera),a.gl.setRenderTarget(i),a.gl.autoClear=v,a.gl.xr.enabled=l,a.gl.xr.isPresenting=f,s++)},u),t.createElement(t.Fragment,null,p)}const nt=`
...
`,Ce=te({uTime:0,uTextTexture:null,uScreenColor:new Ne(.05,.18,.85),uNoiseStrength:.08,uGlowStrength:.35,uCurvature:.06,uVignette:.85,uScanlineStrength:.08,uScanlineDensity:900,uRollSpeed:.4,uRollStrength:.4,uChromaOffset:.0025},ot,it);ee({CrtBlueScreenMaterial:Ce});function ut(r,u,p,c,s,v){const l=u.split("");let i="";const f=[];return l.forEach(a=>{if(a===`
...
`,ke=te({uTime:0,uTexture:null,uStaticAmount:0,uStaticScale:0,uStaticSpeed:0,uSnap:0,uGlitchRate:0,uScanlineStrength:0,uColorBleed:0,uCurvature:0,uVignette:0,uMaskStrength:0,uFlyback:0,uConverge:0,uBloom:0,uBreath:0,uRetrace:0,uBeamWidth:0,uChromaDrift:0,uHum:0,uThermalDrift:0,uSpotNoise:0,uMaskMode:0,uBarrelConverge:0,uPadX:0,uPadY:0},gt,St);ee({CrtShowMaterial:ke});function ie({src:r=Oe("ren_and_stimpy.mp4"),useWebcam:u=!1,padX:p=.06,padY:c=.08,staticAmount:s=.35,staticScale:v=700,staticSpeed:l=9,snap:i=24,glitchRate:f=.18,scanlineStrength:a=.55,colorBleed:m=.14,curvature:b=.12,vignette:w=.75,maskStrength:x=.35,flybackStrength:T=.35,convergenceDrift:S=.4,bloomStrength:d=.25,breathStrength:k=.35,retraceStrength:M=.35,beamWidth:y=.5,chromaDrift:R=.3,humStrength:g=.25,barrelConvergence:n=.6,spotNoise:C=.35,thermalDrift:h=.15,maskMode:A=0,side:V=J}){const U=t.useRef();return t.useEffect(()=>{if(!U.current)return;let E=null,_=!1;const B=document.createElement("video");B.crossOrigin="anonymous",B.loop=!0,B.muted=!0,B.playsInline=!0,B.autoplay=!0;const D=()=>{if(_)return;const P=new Le(B);P.colorSpace=We,P.minFilter=oe,P.magFilter=oe,P.generateMipmaps=!1,U.current.uTexture=P},G=async()=>{try{B.src=r,await B.play(),D()}catch(P){console.error("[CRTShowMaterial] Video failed to play:",P)}};return u?(async()=>{try{const P=navigator,ae=P.mediaDevices?.getUserMedia||P.getUserMedia||P.webkitGetUserMedia||P.mozGetUserMedia;if(!ae)throw new Error("getUserMedia not supported on this device");P.mediaDevices?.getUserMedia?E=await P.mediaDevices.getUserMedia({video:{facingMode:"user"},audio:!1}):E=await new Promise((Z,re)=>{ae.call(P,{video:!0,audio:!1},Z,re)}),B.srcObject=E,await B.play(),D()}catch(P){console.warn("[CRTShowMaterial] Webcam failed, falling back to video:",P),G()}})():G(),()=>{_=!0,E&&E.getTracks().forEach(P=>P.stop()),U.current?.uTexture&&U.current.uTexture.dispose(),B.pause(),B.remove()}},[r,u]),H((E,_)=>{U.current&&(U.current.uTime+=_)}),e.jsx("crtShowMaterial",{ref:U,side:V,toneMapped:!1,uPadX:p,uPadY:c,uStaticAmount:s,uStaticScale:v,uStaticSpeed:l,uSnap:i,uGlitchRate:f,uScanlineStrength:a,uColorBleed:m,uCurvature:b,uVignette:w,uMaskStrength:x,uFlyback:T,uConverge:S,uBloom:d,uBreath:k,uRetrace:M,uBeamWidth:y,uChromaDrift:R,uHum:g,uThermalDrift:h,uSpotNoise:C,uMaskMode:A,uBarrelConverge:n},ke.key)}const bt=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
