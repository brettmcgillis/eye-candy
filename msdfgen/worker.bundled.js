...
var createMSDFGenModule = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    r.startsWith('blob:')
      ? (r = '')
      : (r = r.substr(0, r.replace(/[?#].*/, '').lastIndexOf('/') + 1));
    da = async (a) => {
      a = await fetch(a, { credentials: 'same-origin' });
      if (a.ok) return a.arrayBuffer();
      throw Error(a.status + ' : ' + a.url);
    };
    var ea = m.print || console.log.bind(console),
      w = m.printErr || console.error.bind(console);
    Object.assign(m, ca);
    ca = null;
    var x = m.wasmBinary,
      A,
      ...
      P = (a, b, c) => {
        function d(g) {
          ...
          if (g.length !== a.length)
            throw new N('Mismatched type converter count');
    ...
    var Ia = (a) => {
      ...
      Pa = (a, b) => {
        if (!b.L || !b.K)
          throw new N('makeClassHandle requires ptr and ptrType');
        if (!!b.O !== !!b.M)
          throw new N('Both smartPtrType and smartPtr must be specified');
        b.count = { value: 1 };
        return S(Object.create(a, { I: { value: b, writable: true } }));
      },
      S = (a) => {
      ...
      Qa = [];
    function Ra() {}
    var Sa = (a, b) => Object.defineProperty(b, 'name', { value: a }),
      Ta = (a, b, c) => {
        if (void 0 === a[b].T) {
          var d = a[b];
          a[b] = function (...e) {
            if (!a[b].T.hasOwnProperty(e.length))
              throw new R(
                `Function '${c}' called with an invalid number of arguments (${e.length}) - expects one of (${a[b].T})!`
              );
    ...
    function $a(a, b) {
      ...
      if (!this.$ && b.I.L.$)
        throw new R(
          `Cannot convert argument of type ${b.I.O ? b.I.O.name : b.I.L.name} to parameter type ${this.name}`
        );
    ...
    function bb(a, b) {
      ...
      if (b.I.L.$)
        throw new R(
          `Cannot convert argument of type ${b.I.L.name} to parameter type ${this.name}`
        );
      return Xa(b.I.K, b.I.L.J, this.J);
    }
    function cb(a, b, c, d, e, f, h, g, l, k, n) {
      ...
      e || void 0 !== b.N
        ? (this.toWireType = $a)
        : ((this.toWireType = d ? Ya : bb), (this.P = null));
    }
    var eb = (a, b) => {
        if (!m.hasOwnProperty(a))
          throw new N('Replacing nonexistent public symbol');
        m[a] = b;
        m[a].W = void 0;
      },
      fb,
      gb = (a, b, c = []) => {
        a.includes('j')
          ? ((a = a.replace(/p/g, 'i')), (b = (0, m['dynCall_' + a])(b, ...c)))
          : (b = fb.get(b)(...c));
        return b;
      },
      hb =
      ...
      lb = (a, b) => {
        function c(f) {
          e[f] ||
            M[f] ||
            (Ea[f] ? Ea[f].forEach(c) : (d.push(f), (e[f] = true)));
        }
        var d = [],
          e = {};
        b.forEach(c);
    ...
    function nb(a) {
      for (var b = 1; b < a.length; ++b)
        if (null !== a[b] && void 0 === a[b].P) return true;
      return false;
    }
    function ob(a) {
      var b = Function;
    ...
    function pb(a, b, c, d, e, f) {
      ...
      if (!l)
        for (e = g ? 1 : 2; e < b.length; ++e)
          null !== b[e].P && d.push(b[e].P);
      l = nb(b);
      e = b.length - 2;
      var k = [],
        n = ['fn'];
...
`;
      l && (k += 'var destructors = [];\n');
      var q = l ? 'destructors' : 'null',
        t =
          'humanName throwBindingError invoker fn runDestructors retType classParam'.split(
            ' '
          );
      g &&
        (k += `var thisWired = classParam['toWireType'](${q}, this);
`);
      for (h = 0; h < e; ++h)
        ((k += `var arg${h}Wired = argType${h}['toWireType'](${q}, arg${h});
`),
          t.push(`argType${h}`));
      k +=
        (c || f ? 'var rv = ' : '') +
...
`),
    ...
    var qb = (a) => {
      ...
      vb = Object.assign({ optional: true }, sb),
      wb = 'undefined' != typeof TextDecoder ? new TextDecoder() : void 0,
      xb = (a, b = 0, c = NaN) => {
        var d = b + c;
        for (c = b; a[c] && !(c >= d); ) ++c;
    ...
    Object.assign(cb.prototype, {
      ...
      fromWireType: function (a) {
        function b() {
          return this.aa
            ? Pa(this.J.V, { L: this.qa, K: c, O: this, M: a })
            : Pa(this.J.V, { L: this, K: a });
        }
        var c = this.la(a);
        if (!c) return (this.ea(a), null);
        var d = Oa(this.J, c);
        if (void 0 !== d) {
          if (0 === d.I.count.value)
            return ((d.I.K = c), (d.I.M = a), d.clone());
          d = d.clone();
          this.ea(a);
          return d;
        }
    ...
    var Ob = {
        ...
        e: (a) => {
          ...
          var c = b.ca,
            d = b.R,
            e = b.fa,
            f = e.map((h) => h.oa).concat(e.map((h) => h.ua));
          P([a], f, (h) => {
            var g = {};
            e.forEach((l, k) => {
              var n = h[k],
            ...
            return [
              {
                ...
                toWireType: (l, k) => {
                  for (var n in g)
                    if (!(n in k)) throw new TypeError(`Missing field: "${n}"`);
                  var q = c();
        ...
        j: (a, b, c, d, e, f, h, g, l, k, n, q, t) => {
          ...
          P([a, b, c], d ? [d] : [], (u) => {
            ...
            u = Sa(n, function (...xa) {
              ...
              if (void 0 === y.U)
                throw new R(n + ' has no accessible constructor');
              var db = y.U[xa.length];
              if (void 0 === db)
                throw new R(
                  `Tried to invoke ctor of ${n} with invalid number of parameters (${xa.length}) - expected (${Object.keys(y.U).toString()}) parameters instead!`
                );
        ...
        c: (a, b, c, d, e, f, h, g, l) => {
          ...
          P([], [a], (n) => {
            ...
            var v = n.J.V,
              u = v[b];
            void 0 === u ||
            (void 0 === u.T && u.className !== n.name && u.W === c - 2)
              ? ((q.W = c - 2), (q.className = n.name), (v[b] = q))
              : (Ta(v, b, t), (v[b].T[c - 2] = q));
            P([], k, (z) => {
              z = pb(t, z, n, f, h, l);
              void 0 === v[b].T
                ? ((z.W = c - 2), (v[b] = z))
        ...
        a: (a, b, c) => {
          ...
          O(
            a,
            { name: c, fromWireType: d, S: 8, readValueFromPointer: d },
            { pa: true }
          );
        },
        n: (a) => {
        ...
        m: (a, b) => {
          ...
          if (void 0 === c)
            throw (
              (a = `${'_emval_take_value'} has unknown type ${kb(a)}`),
              new R(a)
            );
          a = c;
    ...
    (async function () {
      ...
      ra ??= m.locateFile
        ? qa('msdfgen.wasm')
          ? 'msdfgen.wasm'
          : m.locateFile
            ? m.locateFile('msdfgen.wasm', r)
            : r + 'msdfgen.wasm'
        : new URL('msdfgen.wasm', import.meta.url).href;
      try {
        var c = await ua(b);
        a(c.instance);
        return c;
    ...
    function Rb() {
      function a() {
        if (!Pb && ((Pb = true), (m.calledRun = true), !B)) {
          ...
          if (m.postRun)
            for (
              'function' == typeof m.postRun && (m.postRun = [m.postRun]);
              m.postRun.length;
            ) {
      ...
      if (!(0 < I)) {
        if (m.preRun)
          for (
            'function' == typeof m.preRun && (m.preRun = [m.preRun]);
            m.preRun.length;
          )
            oa();
        wa(la);
...
var MSDFGenerator = class {
  ...
  generateAtlas(options) {
    ...
    for (let i = 0; i < chars.length; i++) {
      ...
      const translateX =
        0.5 * (glyphWidth / msdfScale - shapeWidth) - shape.left;
      const rawTranslateY =
        0.5 * (glyphHeight / msdfScale - shapeHeight) - shape.bottom;
