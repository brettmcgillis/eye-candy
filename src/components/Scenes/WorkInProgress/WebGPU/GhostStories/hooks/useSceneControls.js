    ...
    World: folder(
      {
        ...
        waterLevel: { value: -1.4, min: -6, max: 2, step: 0.1 },
    ...
    Grass: folder(
      {
        ...
        windScale: { value: 0.12, min: 0.01, max: 0.5, step: 0.005 },
        windSpeed: { value: 0.9, min: 0, max: 4, step: 0.05 },
        windStrength: { value: 0.5, min: 0, max: 2, step: 0.02 },
    ...
    Fog: folder(
      {
        fogEnabled: true,
        fogColor: '#1a2438',
        fogTop: { value: 0.8, min: -4, max: 6, step: 0.1 },
        fogBottom: { value: -1.8, min: -8, max: 2, step: 0.1 },
        fogPoolDensity: { value: 0.55, min: 0, max: 1, step: 0.02 },
        fogNoiseScale: { value: 0.045, min: 0.005, max: 0.3, step: 0.005 },
    ...
    Water: folder(
      {
        ...
        waterDisturbSize: { value: 0.9, min: 0.2, max: 4, step: 0.05 },
        waterDisturbDepth: { value: 0.22, min: 0, max: 1, step: 0.02 },
