...
export class VolumetricFireMesh extends THREE.Mesh {
  constructor({
    width = 1.0,
    height = 2.0,
    depth = 1.0,
    ...
    super(geometry, resolvedMaterial);
...
export function getFireProfileTexture() {
...
export const CP_COUNT = 5;
export const GUIDE_POINTS = 41;

export function makeControlPointPool(count) {
...
export function fillControlPoints(pool, height, width, depth, bendX, bendZ) {
  const halfH = height / 2;
