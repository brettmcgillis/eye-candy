...
export const SCENE_PRESETS = {
  ...
  Matrix: {
    ...
    cutoutRimWidth: 0,
    cutoutRimOffset: 0,
    // Cloth emissive — strong so the lines glow in low light;
    // saturated cyan-green also reads against bright/light backgrounds.
    outerEmissiveColor: '#00ffaa',
    outerEmissiveIntensity: 2.0,
    innerEmissiveColor: '#00ffaa',
    innerEmissiveIntensity: 2.0,
    emissiveFalloff: 0,
    emissiveCenterU: 0.5,
    emissiveCenterV: 0.4,
    // Ground light
    groundLightColor: '#00ffaa',
    groundLightIntensity: 1.0,
    groundLightAngle: 0.4,
    groundLightDistance: 3,
    // Animation
