import{h as me,l as ce,j as e,r as a,a as q,W as F,I as U,C as _,V as M,P as xe,U as B,w as re,a8 as ve,ao as ye,b as ne,f as ae,ae as se,O as Me,av as pe,aR as be,Q as we,y as Ce,cj as Pe,aw as Se,ab as Q,bB as Te,aK as ke,e as je}from"./index-B1EnSV03.js";import{E as ze,I as De,d as We,V as Be}from"./index-BhZTUQQG.js";import{C as Re,R as Ve}from"./Record-grIFfy4g.js";import{M as Ie}from"./MeshBVH-Dae8iBjf.js";import{O as Ee}from"./OrbitControls-D2MiKZfo.js";import{E as Ue}from"./Environment-BRIofBfb.js";import{P as Ge}from"./shapes-CV633sRz.js";import"./Gltf-C-zt2nP4.js";import"./constants-CdxV3xEo.js";function Ne(){const{plPosition:n,plDecay:o,plDistance:i,plIntensity:p,plCastShadow:d,ambientLightIntensity:s}=me("Lighting Rig",{"Point Light":ce({plPosition:{label:"Position",value:{x:3,y:3,z:5}},plDecay:{label:"Decay",value:0,min:-10,max:10,step:.1},plDistance:{label:"Distance",value:-1,min:-10,max:10,step:.1},plIntensity:{label:"Intensity",value:.8,min:0,max:10,step:.1},plCastShadow:{label:"Cast Shadow",value:!0}},{collapsed:!0}),"Ambient Light":ce({ambientLightIntensity:{label:"Intensity",value:0,min:0,max:1,step:.1}},{collapsed:!0})},{collapsed:!0});return e.jsxs("group",{children:[e.jsx("ambientLight",{intensity:s}),e.jsx("pointLight",{position:[n.x,n.y,n.z],decay:o,distance:i,intensity:p,castShadow:d})]})}const Le=`
...
`;function Fe({mode:n="voxelScreen",pixelSize:o=8,voxelSize:i=.25,voxelSteps:p=24,clipOffset:d=0,children:s,...g}){const y=a.useRef(),{gl:t,scene:r,camera:m}=q(),l=a.useMemo(()=>new F(1,1),[]),f=a.useMemo(()=>new F(1,1),[]),c=a.useMemo(()=>new U,[]),b=a.useMemo(()=>new _,[]),v=a.useMemo(()=>new M,[]),w=a.useMemo(()=>new M,[]),h=a.useMemo(()=>new M,[]),x=a.useMemo(()=>new xe,[]),C=a.useMemo(()=>new B,[]),R={voxelScreen:1,voxelRaymarch:2,voxelInstanced:3},u=a.useMemo(()=>new re({vertexShader:Le,fragmentShader:Ae,uniforms:{sceneTexture:{value:null},sceneDepthTexture:{value:null},fullSceneTexture:{value:null},fallbackColor:{value:new _(1,1,1)},resolution:{value:new U},pixelSize:{value:o},effectMode:{value:1},voxelWorldSize:{value:i},voxelSteps:{value:p},projectionMatrixInverse:{value:new B},viewMatrixInverse:{value:new B},viewProjectionMatrix:{value:new B},cameraWorldPos:{value:new M}},transparent:!1,depthWrite:!0}),[]);return a.useEffect(()=>{l.depthTexture=new ve(1,1),l.depthTexture.type=ye},[l]),a.useEffect(()=>()=>{l.dispose(),f.dispose(),u.dispose()},[l,f,u]),ne(()=>{const D=y.current;if(!D)return;t.getDrawingBufferSize(c),(l.width!==c.x||l.height!==c.y)&&(l.setSize(c.x,c.y),f.setSize(c.x,c.y)),u.uniforms.pixelSize.value=o,u.uniforms.effectMode.value=R[n]??1,u.uniforms.voxelWorldSize.value=i,u.uniforms.voxelSteps.value=p,u.uniforms.resolution.value.copy(c),u.uniforms.projectionMatrixInverse.value.copy(m.projectionMatrixInverse),u.uniforms.viewMatrixInverse.value.copy(m.matrixWorld),C.multiplyMatrices(m.projectionMatrix,m.matrixWorldInverse),u.uniforms.viewProjectionMatrix.value.copy(C),m.getWorldPosition(h),u.uniforms.cameraWorldPos.value.copy(h),D.getWorldPosition(v),m.getWorldDirection(w),x.setFromNormalAndCoplanarPoint(w,v),x.constant+=d,D.visible=!1;const k=t.clippingPlanes,P=t.toneMapping;t.toneMapping=ae;const z=t.getClearAlpha();t.getClearColor(b),r.background&&r.background.isColor?u.uniforms.fallbackColor.value.copy(r.background):u.uniforms.fallbackColor.value.setRGB(1,1,1);const S=t.getRenderTarget();t.setClearColor(b,z),t.clippingPlanes=[],t.setRenderTarget(f),t.clear(),t.render(r,m),t.setClearColor(0,0),t.clippingPlanes=[x],t.setRenderTarget(l),t.clear(),t.render(r,m),t.setRenderTarget(S),t.toneMapping=P,t.setClearColor(b,z),t.clippingPlanes=k,D.visible=!0,u.uniforms.sceneTexture.value=l.texture,u.uniforms.sceneDepthTexture.value=l.depthTexture,u.uniforms.fullSceneTexture.value=f.texture}),e.jsx("mesh",{ref:y,material:u,...g,children:s})}const _e=`
...
`;function Qe({voxelSize:n=.25,maxInstances:o=4096,clipOffset:i=0,children:p,...d}){const s=a.useRef(),g=a.useRef(),y=a.useRef(),{gl:t,scene:r,camera:m}=q(),l=a.useMemo(()=>new F(1,1),[]),f=a.useMemo(()=>new F(1,1),[]),c=a.useMemo(()=>new se(1,1,1),[]),b=a.useMemo(()=>new U,[]),v=a.useMemo(()=>new _,[]),w=a.useMemo(()=>new M,[]),h=a.useMemo(()=>new M,[]),x=a.useMemo(()=>new M,[]),C=a.useMemo(()=>new xe,[]),R=a.useMemo(()=>new B,[]),u=a.useMemo(()=>new Me,[]),D=a.useMemo(()=>new M,[]),k=a.useMemo(()=>new re({vertexShader:_e,fragmentShader:Oe,uniforms:{clippedSceneTexture:{value:null},fullSceneTexture:{value:null},resolution:{value:new U},fallbackColor:{value:new _(1,1,1)},viewProjectionMatrix:{value:new B},cameraWorldPos:{value:new M}},transparent:!1,depthWrite:!0}),[]);return a.useEffect(()=>()=>{l.dispose(),f.dispose(),c.dispose(),k.dispose()},[l,f,c,k]),a.useLayoutEffect(()=>{const P=g.current,z=y.current;if(!P||!z||!P.geometry)return;P.geometry.computeBoundingBox();const S=P.geometry.boundingBox;if(!S)return;S.getSize(D);const V=Math.max(n,.02),I=Math.ceil(D.x/V)*Math.ceil(D.y/V)*Math.ceil(D.z/V),J=I>o?Math.ceil(Math.cbrt(I/o)):1,j=V*J,G=j*.9;let E=0;for(let N=S.min.x+j*.5;N<=S.max.x;N+=j)for(let L=S.min.y+j*.5;L<=S.max.y;L+=j)for(let A=S.min.z+j*.5;A<=S.max.z&&!(E>=o);A+=j)u.position.set(N,L,A),u.scale.set(G,G,G),u.rotation.set(0,0,0),u.updateMatrix(),z.setMatrixAt(E,u.matrix),E+=1;z.count=E,z.instanceMatrix.needsUpdate=!0},[n,o,u,D]),ne(()=>{const P=s.current;if(!P)return;t.getDrawingBufferSize(b),(l.width!==b.x||l.height!==b.y)&&(l.setSize(b.x,b.y),f.setSize(b.x,b.y)),k.uniforms.resolution.value.copy(b),R.multiplyMatrices(m.projectionMatrix,m.matrixWorldInverse),k.uniforms.viewProjectionMatrix.value.copy(R),m.getWorldPosition(x),k.uniforms.cameraWorldPos.value.copy(x),P.getWorldPosition(w),m.getWorldDirection(h),C.setFromNormalAndCoplanarPoint(h,w),C.constant+=i;const z=t.getRenderTarget(),S=t.clippingPlanes,V=t.toneMapping,I=t.getClearAlpha();t.getClearColor(v),t.toneMapping=ae,r.background&&r.background.isColor?k.uniforms.fallbackColor.value.copy(r.background):k.uniforms.fallbackColor.value.setRGB(1,1,1),P.visible=!1,t.setClearColor(v,I),t.clippingPlanes=[],t.setRenderTarget(f),t.clear(),t.render(r,m),t.setClearColor(0,0),t.clippingPlanes=[C],t.setRenderTarget(l),t.clear(),t.render(r,m),t.setRenderTarget(z),t.clippingPlanes=S,t.toneMapping=V,t.setClearColor(v,I),P.visible=!0,k.uniforms.clippedSceneTexture.value=l.texture,k.uniforms.fullSceneTexture.value=f.texture}),e.jsxs("group",{ref:s,...d,children:[e.jsx("mesh",{ref:g,visible:!1,children:p}),e.jsx("instancedMesh",{ref:y,args:[c,k,o],frustumCulled:!1})]})}const H=new M;function W(n,o,i,p,d,s){const g=2*Math.PI*d/4,y=Math.max(s-2*d,0),t=Math.PI/4;H.copy(o),H[p]=0,H.normalize();const r=.5*g/(g+y),m=1-H.angleTo(n)/t;return Math.sign(H[i])===1?m*r:y/(g+y)+r+r*(1-m)}class le extends se{constructor(o=1,i=1,p=1,d=2,s=.1){const g=d*2+1;if(s=Math.min(o/2,i/2,p/2,s),super(1,1,1,g,g,g),this.type="RoundedBoxGeometry",this.parameters={width:o,height:i,depth:p,segments:d,radius:s},g===1)return;const y=this.toNonIndexed();this.index=null,this.attributes.position=y.attributes.position,this.attributes.normal=y.attributes.normal,this.attributes.uv=y.attributes.uv;const t=new M,r=new M,m=new M(o,i,p).divideScalar(2).subScalar(s),l=this.attributes.position.array,f=this.attributes.normal.array,c=this.attributes.uv.array,b=l.length/6,v=new M,w=.5/g;for(let h=0,x=0;h<l.length;h+=3,x+=2)switch(t.fromArray(l,h),r.copy(t),r.x-=Math.sign(r.x)*w,r.y-=Math.sign(r.y)*w,r.z-=Math.sign(r.z)*w,r.normalize(),l[h+0]=m.x*Math.sign(t.x)+r.x*s,l[h+1]=m.y*Math.sign(t.y)+r.y*s,l[h+2]=m.z*Math.sign(t.z)+r.z*s,f[h+0]=r.x,f[h+1]=r.y,f[h+2]=r.z,Math.floor(h/b)){case 0:v.set(1,0,0),c[x+0]=W(v,r,"z","y",s,p),c[x+1]=1-W(v,r,"y","z",s,i);break;case 1:v.set(-1,0,0),c[x+0]=1-W(v,r,"z","y",s,p),c[x+1]=1-W(v,r,"y","z",s,i);break;case 2:v.set(0,1,0),c[x+0]=1-W(v,r,"x","z",s,o),c[x+1]=W(v,r,"z","x",s,p);break;case 3:v.set(0,-1,0),c[x+0]=1-W(v,r,"x","z",s,o),c[x+1]=1-W(v,r,"z","x",s,p);break;case 4:v.set(0,0,1),c[x+0]=1-W(v,r,"x","y",s,o),c[x+1]=1-W(v,r,"y","x",s,i);break;case 5:v.set(0,0,-1),c[x+0]=W(v,r,"x","y",s,o),c[x+1]=1-W(v,r,"y","x",s,i);break}}static fromJSON(o){return new le(o.width,o.height,o.depth,o.segments,o.radius)}}const He=`
  varying vec3 vCenterWorld;
...
`,$e=new pe(new M(-.5,-.5,-.5),new M(.5,.5,.5)),ue=new WeakMap;function Ye(n){let o=ue.get(n);return o||(o=new Ie(n),ue.set(n,o)),o}function Xe(n,o){let i=o;for(;i;){if(i===n)return!0;i=i.parent}return!1}function qe({voxelSize:n=.25,cornerRadius:o=0,insideOnly:i=!1,maxInstances:p=8192,children:d,...s}){const g=a.useRef(),y=a.useRef(),t=a.useRef(),{gl:r,scene:m,camera:l}=q(),f=a.useMemo(()=>new F(1,1),[]),c=a.useMemo(()=>new U,[]),b=a.useMemo(()=>new _,[]),v=a.useMemo(()=>new B,[]),w=a.useMemo(()=>o>0?new le(1,1,1,4,Math.min(o,.49)):new se(1,1,1),[o]),h=a.useMemo(()=>new re({vertexShader:He,fragmentShader:Ke,uniforms:{fullSceneTexture:{value:null},resolution:{value:new U},fallbackColor:{value:new _(1,1,1)},viewProjectionMatrix:{value:new B}},transparent:!1,depthWrite:!0}),[]);return a.useEffect(()=>{t.current&&(t.current.geometry=w)},[w]),a.useEffect(()=>()=>{f.dispose(),w.dispose(),h.dispose()},[f,w,h]),a.useLayoutEffect(()=>{const x=y.current,C=t.current,R=g.current;if(!x||!C||!R||!x.geometry)return;x.updateWorldMatrix(!0,!1),x.geometry.computeBoundingBox();const u=x.geometry.boundingBox;if(!u)return;const D=u.clone().applyMatrix4(x.matrixWorld),k=new pe,P=[];if(m.traverse(T=>{if(!T.isMesh||!T.visible||!T.geometry||!T.geometry.attributes?.position||Xe(R,T)||(T.geometry.boundingBox||T.geometry.computeBoundingBox(),!T.geometry.boundingBox)||(k.copy(T.geometry.boundingBox).applyMatrix4(T.matrixWorld),!k.intersectsBox(D)))return;const O=Ye(T.geometry);P.push({bvh:O,worldToLocal:new B().copy(T.matrixWorld).invert()})}),P.length===0){C.count=0,C.instanceMatrix.needsUpdate=!0;return}const z=Math.max(n,.01),S=u.getSize(new M),V=Math.ceil(S.x/z)*Math.ceil(S.y/z)*Math.ceil(S.z/z),I=Math.max(p*4,2e4),J=V>I?Math.ceil(Math.cbrt(V/I)):1,j=z*J,G=new M,E=new M,N=new B,L=new B,A=new B,ge=new we,he=new M().setScalar(j),K=new be;K.direction.set(0,0,1);let $=0,Z=!1;for(let T=u.min.x+j*.5;T<=u.max.x;T+=j){for(let O=u.min.y+j*.5;O<=u.max.y;O+=j){for(let ee=u.min.z+j*.5;ee<=u.max.z;ee+=j){if($>=p){Z=!0;break}G.set(T,O,ee),N.compose(G,ge,he),L.multiplyMatrices(x.matrixWorld,N),E.copy(G),x.localToWorld(E);let Y=!1,oe=!1;for(let te=0;te<P.length;te+=1){const X=P[te];if(A.multiplyMatrices(X.worldToLocal,L),X.bvh.intersectsBox($e,A)&&(Y=!0),!Y||i){K.origin.copy(E).applyMatrix4(X.worldToLocal);const ie=X.bvh.raycastFirst(K,Ce);ie&&ie.face.normal.dot(K.direction)>0&&(oe=!0)}if(Y&&oe)break}(Y&&!i||oe)&&(C.setMatrixAt($,N),$+=1)}if(Z)break}if(Z)break}C.count=$,C.instanceMatrix.needsUpdate=!0},[n,i,p,m]),ne(()=>{const x=g.current;if(!x)return;r.getDrawingBufferSize(c),(f.width!==c.x||f.height!==c.y)&&f.setSize(c.x,c.y),h.uniforms.resolution.value.copy(c),v.multiplyMatrices(l.projectionMatrix,l.matrixWorldInverse),h.uniforms.viewProjectionMatrix.value.copy(v);const C=r.getRenderTarget(),R=r.toneMapping,u=r.getClearAlpha();r.getClearColor(b),r.toneMapping=ae,m.background&&m.background.isColor?h.uniforms.fallbackColor.value.copy(m.background):h.uniforms.fallbackColor.value.setRGB(1,1,1),x.visible=!1,r.setClearColor(b,u),r.setRenderTarget(f),r.clear(),r.render(m,l),r.setRenderTarget(C),r.toneMapping=R,r.setClearColor(b,u),x.visible=!0,h.uniforms.fullSceneTexture.value=f.texture}),e.jsxs("group",{ref:g,...s,children:[e.jsx("mesh",{ref:y,visible:!1,children:d}),e.jsx("instancedMesh",{ref:t,args:[w,h,p],frustumCulled:!1})]})}function Je({effectShape:n,pixelSize:o,refraction:i,planeWidth:p,planeHeight:d,voxelMode:s,voxelSize:g,voxelSteps:y,cornerRadius:t,insideOnly:r}){const m=s!=="pixel";let l=Re;m&&(s==="voxelInstanced"?l=Qe:s==="voxelInterior"?l=qe:l=Fe);let f={};m&&(s==="voxelInstanced"?f={voxelSize:g}:s==="voxelInterior"?f={voxelSize:g,cornerRadius:t,insideOnly:r}:f={mode:s,voxelSize:g,voxelSteps:y});const c=m?{pixelSize:o,...f}:{pixelSize:o,refraction:i};return e.jsxs(e.Fragment,{children:[n==="Plane"&&e.jsx(l,{...c,children:e.jsx("planeGeometry",{args:[p,d]})}),n==="TwoPanes"&&e.jsxs(e.Fragment,{children:[e.jsx(l,{...c,position:[.5,.5,0],children:e.jsx("planeGeometry",{args:[1,1]})}),e.jsx(l,{...c,position:[-.5,-.5,0],children:e.jsx("planeGeometry",{args:[1,1]})})]}),n==="Cube"&&e.jsx(l,{...c,children:e.jsx("boxGeometry",{args:[1,1,1]})}),n==="Cubes"&&e.jsx(l,{...c,clipOffset:.5,position:[0,0,1],children:e.jsx("boxGeometry",{args:[1,1,1]})}),n==="Torus"&&e.jsx(l,{...c,children:e.jsx("torusGeometry",{args:[.5,.15,16,100]})}),n==="Sphere"&&e.jsx(l,{...c,children:e.jsx("sphereGeometry",{args:[.4,32,32]})}),n==="Knot"&&e.jsx(l,{...c,children:e.jsx("torusKnotGeometry",{args:[.5,.1,100,16]})})]})}const fe=a.createContext(null);function Ze({children:n}){const o=a.useContext(fe);return o?Pe(e.jsx("group",{children:a.Children.map(n,i=>a.isValidElement(i)?a.cloneElement(i,{material:new Se({color:"white"})}):null)}),o):null}class de extends ze{constructor(o,i,{pixelSize:p=8,maskScene:d}){super("PixelMaskEffect",`
