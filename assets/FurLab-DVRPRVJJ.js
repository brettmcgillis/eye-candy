...
`;function Nt(e,a){const s=Array.isArray(e)?e:a;return{alpha:s[3]??a[3],color:new te(s[0],s[1],s[2])}}function Za({alphaMap:e,alphaEnd:a,alphaStart:s,baseColor:c,colorEnd:t,colorStart:n,fallbackTexture:l,layerIndex:x,layerThickness:R,layersCount:k,source:T,interactionRadius:C,interactionStrength:u,stiffness:A,waveScale:v}){const m=new aa({depthWrite:!1,fragmentShader:Xa,side:ke,transparent:!0,uniforms:{uAlphaEnd:{value:a},uAlphaMap:{value:e||l},uAlphaStart:{value:s},uBaseColor:{value:c.clone()},uColorEnd:{value:t.clone()},uColorStart:{value:n.clone()},uInteractorEnabled:{value:0},uInteractorDir:{value:new I(1,0,0)},uInteractorNormal:{value:new I(0,1,0)},uInteractorPos:{value:new I(1e3,1e3,1e3)},uInteractorRadius:{value:C},uInteractorStrength:{value:u},uLayerIndex:{value:x},uLayerThickness:{value:R},uLayersCount:{value:k},uSourceMap:{value:T.map||l},uStiffness:{value:A},uTime:{value:0},uUseSourceMap:{value:T.map?1:0},uWaveScale:{value:v}},vertexShader:qa});return m.skinning=T.isSkinnedMesh,m}function $a({source:e,layers:a=null,shellCount:s=20,thickness:c=null,shellSpacing:t=null,waveScale:n=.06,stiffness:l=2.75,startColor:x=Dt,endColor:R=Wt,alphaTexturePath:k=Ga,rootColor:T=null,interactive:C=!1,interactionRadius:u=.18,interactionStrength:A=1.2,showInteractionSurface:v=!1,...m}){const w=o.useRef(),D=o.useRef(new I),Y=o.useRef(new I(0,1,0)),W=o.useRef(new I),j=o.useRef(new I(1,0,0)),M=o.useRef(),U=o.useMemo(()=>Fe(),[]),P=Ie(k),H=C||v,F=o.useMemo(()=>ca(a??s),[a,s]),f=o.useMemo(()=>{const d=e.baseColor.clone();return T&&d.set(T),d},[T,e.baseColor]),E=o.useMemo(()=>Nt(x,Dt),[x]),S=o.useMemo(()=>Nt(R,Wt),[R]),O=c??t??.018,B=u*(e.radius||1),y=n,N=B,r=o.useMemo(()=>Array.from({length:F},(d,h)=>Za({alphaMap:P,alphaEnd:S.alpha,alphaStart:E.alpha,baseColor:f,colorEnd:S.color,colorStart:E.color,fallbackTexture:U,interactionRadius:B,interactionStrength:A,layerIndex:h,layerThickness:O,layersCount:F,source:e,stiffness:l,waveScale:y})),[P,U,f,S.alpha,S.color,B,A,F,O,E.alpha,E.color,y,e,l]);o.useEffect(()=>{P&&(P.colorSpace=ta,P.wrapS=rt,P.wrapT=rt,P.needsUpdate=!0)},[P]),o.useEffect(()=>()=>{U.dispose()},[U]),o.useEffect(()=>()=>{r.forEach(d=>d.dispose())},[r]),o.useEffect(()=>{r.forEach((d,h)=>{const{uniforms:i}=d;i.uAlphaEnd.value=S.alpha,i.uAlphaMap.value=P||U,i.uAlphaStart.value=E.alpha,i.uBaseColor.value.copy(f),i.uColorEnd.value.copy(S.color),i.uColorStart.value.copy(E.color),i.uInteractorRadius.value=B,i.uInteractorStrength.value=A,i.uLayerIndex.value=h,i.uLayerThickness.value=O,i.uLayersCount.value=F,i.uSourceMap.value=e.map||U,i.uStiffness.value=l,i.uUseSourceMap.value=e.map?1:0,i.uWaveScale.value=y})},[P,U,r,f,S.alpha,S.color,B,A,F,O,E.alpha,E.color,y,e.map,l]);const g=o.useCallback(()=>{!M.current||!v||(M.current.visible=!0,M.current.position.copy(D.current))},[v]),G=o.useCallback(d=>{if(!C||!w.current)return;d.stopPropagation(),D.current.copy(d.point),w.current.worldToLocal(D.current),d.face?.normal&&Y.current.copy(d.face.normal).normalize();const h=new I().subVectors(D.current,W.current);h.lengthSq()>1e-8&&j.current.copy(h.normalize()),W.current.copy(D.current),r.forEach(i=>{const V=i.uniforms;V.uInteractorEnabled.value=1,V.uInteractorDir.value.copy(j.current),V.uInteractorNormal.value.copy(Y.current),V.uInteractorPos.value.copy(D.current)}),g()},[C,r,g]),z=o.useCallback(()=>{r.forEach(d=>{const h=d.uniforms;h.uInteractorEnabled.value=0,h.uInteractorDir.value.set(1,0,0),h.uInteractorNormal.value.set(0,1,0)}),M.current&&(M.current.visible=!1)},[r]);return o.useEffect(()=>{M.current&&(M.current.visible=!1)},[v]),Te((d,h)=>{r.forEach(i=>{const V=i.uniforms;V.uTime.value+=h})}),p.jsxs(_e,{ref:w,source:e,...m,children:[r.map((d,h)=>e.isSkinnedMesh&&e.mesh?p.jsx(ct,{frustumCulled:!1,material:d,raycast:Et,renderOrder:20+h,sourceMesh:e.mesh},d.uuid):p.jsx("mesh",{frustumCulled:!1,geometry:e.geometry,material:d,raycast:Et,renderOrder:20+h},d.uuid)),H?p.jsx(ze,{onPointerDown:C?G:void 0,onPointerLeave:C?z:void 0,onPointerMove:C?G:void 0,showInteractionSurface:v,source:e}):null,v?p.jsxs("mesh",{ref:M,renderOrder:200,children:[p.jsx("sphereGeometry",{args:[N,20,20]}),p.jsx("meshBasicMaterial",{color:"#00ff88",depthTest:!1,depthWrite:!1,opacity:.95,transparent:!0,wireframe:!0})]}):null]})}const Qa="/textures/fur/uneven-alpha.png",Ka=`
#include <common>
#include <skinning_pars_vertex>
...
`;function er({source:e,geometry:a,bladeHeight:s=.045,alphaTexturePath:c=Qa,rootColor:t=null,tipColor:n=null,tipMix:l=.18,curvature:x=.05,windStrength:R=.18,noiseFrequency:k=.4,noiseAmplitude:T=.02,waveAmplitude:C=.025,waveLength:u=.7,waveSpeed:A=1.2,waveDirection:v=[1,0],interactive:m=!0,interactionRadius:w=.18,interactionStrength:D=1.2,showInteractionSurface:Y=!1,...W}){const j=o.useRef(),M=o.useRef(new I),U=n!=null,P=e.radius||1,H=s*P,F=w*P,f=T*P,E=C*P,S=o.useMemo(()=>Fe(),[]),O=Ie(c),B=o.useMemo(()=>{const z=e.baseColor.clone();return t&&z.set(t),z},[t,e.baseColor]),y=o.useMemo(()=>n?new te(n):e.baseColor.clone(),[e.baseColor,n]),N=o.useMemo(()=>ut(v),[v]),r=o.useMemo(()=>{const z=new aa({fragmentShader:Ja,side:ke,uniforms:{uAlphaMap:{value:O||S},uBaseColor:{value:B.clone()},uBladeHeight:{value:H},uCurvature:{value:x},uInteractorEnabled:{value:0},uInteractorPos:{value:new I(1e3,1e3,1e3)},uInteractorRadius:{value:F},uInteractorStrength:{value:D},uNoiseAmplitude:{value:f},uNoiseFrequency:{value:k},uSourceMap:{value:e.map||S},uTime:{value:0},uTipColor:{value:y.clone()},uTipMix:{value:l},uUseExplicitTipColor:{value:U?1:0},uUseSourceMap:{value:e.map?1:0},uWaveAmplitude:{value:E},uWaveDirection:{value:N.clone()},uWaveLength:{value:u},uWaveSpeed:{value:A},uWindStrength:{value:R}},vertexShader:Ka});return z.skinning=!0,z},[]);o.useEffect(()=>()=>{S.dispose(),r.dispose()},[S,r]),o.useEffect(()=>{r.uniforms.uAlphaMap.value=O||S,r.uniforms.uBaseColor.value.copy(B),r.uniforms.uBladeHeight.value=H,r.uniforms.uCurvature.value=x,r.uniforms.uInteractorRadius.value=F,r.uniforms.uInteractorStrength.value=D,r.uniforms.uNoiseAmplitude.value=f,r.uniforms.uNoiseFrequency.value=k,r.uniforms.uSourceMap.value=e.map||S,r.uniforms.uTipColor.value.copy(y),r.uniforms.uTipMix.value=l,r.uniforms.uUseExplicitTipColor.value=U?1:0,r.uniforms.uUseSourceMap.value=e.map?1:0,r.uniforms.uWaveAmplitude.value=E,r.uniforms.uWaveDirection.value.copy(N),r.uniforms.uWaveLength.value=u,r.uniforms.uWaveSpeed.value=A,r.uniforms.uWindStrength.value=R},[O,x,S,D,r,k,B,H,F,f,y,E,N,e.map,l,U,u,A,R]);const g=o.useCallback(z=>{!m||!j.current||(z.stopPropagation(),M.current.copy(z.point),j.current.worldToLocal(M.current),r.uniforms.uInteractorEnabled.value=1,r.uniforms.uInteractorPos.value.copy(M.current))},[m,r]),G=o.useCallback(()=>{r.uniforms.uInteractorEnabled.value=0},[r]);return Te((z,d)=>{r.uniforms.uTime.value+=d}),!a||!e.mesh?null:p.jsxs(_e,{ref:j,source:e,...W,children:[p.jsx(ct,{frustumCulled:!1,geometry:a,material:r,sourceMesh:e.mesh}),p.jsx(ze,{onPointerDown:m?g:void 0,onPointerLeave:m?G:void 0,onPointerMove:m?g:void 0,showInteractionSurface:Y,source:e})]})}const dt=new I,mt=new I,Lt=new I,Bt=new Pa,He=new bt,Ge=new I,qe=new I,Ut=new I,Ft=new pe,zt=new pe,_t=new pe,Ot=new pe,Xe=new pe,jt=new pe,Vt=new pe,Yt=new pe,Ht=new pe,fe=new I,Ze=new I,Ne=new I,$e=new I,Qe=new I,ve=new I,ft=3,tr=.65,ar=1.5,rr=.82,nr=1.12;function or(e,a,s=Math.random,c={normals:new Float32Array(a*3),positions:new Float32Array(a*3),uvs:new Float32Array(a*2)}){const t=c;let n=e;n.index||(n=n.toNonIndexed());const l=n.getAttribute("position");if(!l)throw new Error("Strand fur source geometry is missing a position attribute.");n.getAttribute("normal")||n.computeVertexNormals();const x=n.getAttribute("normal"),R=n.getAttribute("skinIndex"),k=n.getAttribute("skinWeight"),T=n.getAttribute("uv"),C=!!(R&&k),u=n.index?.array,A=u?u.length/3:l.count/3,v=new Float32Array(A),m=new I,w=new I,D=new I,Y=new I,W=new I,j=new I,M=new I,U=new I,P=new I,H=new Map,F=new Ke,f=new Ke,E=new Ke,S=new Ke;C&&(t.skinIndices||=new Float32Array(a*4),t.skinWeights||=new Float32Array(a*4));let O=0;for(let y=0;y<A;y+=1){const N=u?u[y*3]:y*3,r=u?u[y*3+1]:y*3+1,g=u?u[y*3+2]:y*3+2;m.fromBufferAttribute(l,N),w.fromBufferAttribute(l,r),D.fromBufferAttribute(l,g),O+=Y.copy(w).sub(m).cross(W.copy(D).sub(m)).length()*.5,v[y]=O}const B=y=>{let N=0,r=A-1;for(;N<r;){const g=Math.floor((N+r)/2);y<=v[g]?r=g:N=g+1}return N};for(let y=0;y<a;y+=1){const N=B(s()*O),r=u?u[N*3]:N*3,g=u?u[N*3+1]:N*3+1,G=u?u[N*3+2]:N*3+2;let z=s(),d=s();z+d>1&&(z=1-z,d=1-d);const h=1-z-d;if(m.fromBufferAttribute(l,r),w.fromBufferAttribute(l,g),D.fromBufferAttribute(l,G),t.positions[y*3]=m.x*h+w.x*z+D.x*d,t.positions[y*3+1]=m.y*h+w.y*z+D.y*d,t.positions[y*3+2]=m.z*h+w.z*z+D.z*d,M.fromBufferAttribute(x,r),U.fromBufferAttribute(x,g),P.fromBufferAttribute(x,G),j.copy(M).multiplyScalar(h).addScaledVector(U,z).addScaledVector(P,d).normalize(),t.normals[y*3]=j.x,t.normals[y*3+1]=j.y,t.normals[y*3+2]=j.z,C){H.clear(),Ft.fromBufferAttribute(R,r),zt.fromBufferAttribute(R,g),_t.fromBufferAttribute(R,G),Vt.fromBufferAttribute(k,r),Yt.fromBufferAttribute(k,g),Ht.fromBufferAttribute(k,G),[[Ft,Vt,h],[zt,Yt,z],[_t,Ht,d]].forEach(([X,L,Z])=>{for(let Q=0;Q<4;Q+=1){const se=X.getComponent(Q),ce=L.getComponent(Q)*Z;Number.isFinite(se)&&ce>1e-5&&H.set(se,(H.get(se)||0)+ce)}});const i=Array.from(H.entries()).sort((X,L)=>L[1]-X[1]).slice(0,4),V=i.reduce((X,[,L])=>X+L,0);for(let X=0;X<4;X+=1){const L=y*4+X,Z=i[X];t.skinIndices[L]=Z?.[0]??0,t.skinWeights[L]=Z?Z[1]/Math.max(V,1e-6):0}}T?(F.fromBufferAttribute(T,r),f.fromBufferAttribute(T,g),E.fromBufferAttribute(T,G),S.copy(F).multiplyScalar(h).addScaledVector(f,z).addScaledVector(E,d),t.uvs[y*2]=S.x,t.uvs[y*2+1]=S.y):(t.uvs[y*2]=0,t.uvs[y*2+1]=0)}return t}function gt(e,a=new bt){const s=new I(0,1,0);if(s.dot(e)<-.9995){const c=new I(1,0,0).cross(s);return c.lengthSq()<1e-6&&c.set(0,0,1),c.normalize(),a.setFromAxisAngle(c,Math.PI),a}return a.setFromUnitVectors(s,e.clone().normalize()),a}function ma({bladeWidth:e=.008,isSkinnedMesh:a=!1,seed:s=1,sourceGeometry:c,strandCount:t=4e3}){if(!c)return null;const n=Math.max(5e-4,Math.min(.5,e*.5)),l=ft*3,x=new Float32Array(l*3),R=new Float32Array(l*2),k=new Float32Array(l*3),T=new Uint16Array(l),C=new Pt;for(let f=0;f<ft;f+=1){const E=Math.PI/ft*f,S=Math.cos(E),O=Math.sin(E),B=f*3,y=f*6;fe.set(-n,0,0),Ze.set(fe.x*S-fe.z*O,fe.y,fe.x*O+fe.z*S),Ne.copy(Ze),fe.set(n,0,0),Ze.set(fe.x*S-fe.z*O,fe.y,fe.x*O+fe.z*S),$e.copy(Ze),Qe.set(0,1,0),ve.copy($e).sub(Ne).cross(Ze.copy(Qe).sub(Ne)).normalize(),x.set([Ne.x,Ne.y,Ne.z,$e.x,$e.y,$e.z,Qe.x,Qe.y,Qe.z],B*3),R.set([0,0,1,0,.5,1],y),k.set([ve.x,ve.y,ve.z,ve.x,ve.y,ve.z,ve.x,ve.y,ve.z],B*3),T.set([B,B+1,B+2],B)}C.setAttribute("position",new ge(x,3)),C.setAttribute("uv",new ge(R,2)),C.setAttribute("normal",new ge(k,3)),C.setIndex(new ge(T,1));const u=or(c,t,wt(s)),A=wt(s*17+5),v=new I,m=new bt,w=a?rr:tr,Y=(a?nr:ar)-w;if(a&&u.skinIndices&&u.skinWeights){const f=C.getAttribute("position").count,E=C.index.count,S=f*t,O=E*t,B=C.getAttribute("position").array,y=C.getAttribute("uv").array,N=C.getAttribute("normal").array,r=C.index.array,g=new Pt,G=new Float32Array(S*3),z=new Float32Array(S*2),d=new Float32Array(S*3),h=8,i=6,V=new Float32Array(S*h),X=new Float32Array(S*i),L=new Uint16Array(S*4),Z=new Float32Array(S*4),Q=S>65535?new Uint32Array(O):new Uint16Array(O),se=new kt(V,h),ce=new kt(X,i);for(let q=0;q<t;q+=1){const Me=w+A()*Y,Re=A()*Math.PI*2,J=q*f;v.set(u.normals[q*3],u.normals[q*3+1],u.normals[q*3+2]).normalize(),gt(v,m);for(let $=0;$<f;$+=1){const ie=J+$,le=ie*3,we=ie*2,re=ie*4,de=ie*h,ee=ie*i,K=$*3,me=$*2;G[le]=B[K],G[le+1]=B[K+1],G[le+2]=B[K+2],d[le]=N[K],d[le+1]=N[K+1],d[le+2]=N[K+2],z[we]=y[me],z[we+1]=y[me+1],V[de]=u.positions[q*3],V[de+1]=u.positions[q*3+1],V[de+2]=u.positions[q*3+2],V[de+3]=u.normals[q*3],V[de+4]=u.normals[q*3+1],V[de+5]=u.normals[q*3+2],V[de+6]=u.uvs[q*2],V[de+7]=u.uvs[q*2+1],X[ee]=Me,X[ee+1]=Re,X[ee+2]=m.x,X[ee+3]=m.y,X[ee+4]=m.z,X[ee+5]=m.w,L[re]=u.skinIndices[q*4],L[re+1]=u.skinIndices[q*4+1],L[re+2]=u.skinIndices[q*4+2],L[re+3]=u.skinIndices[q*4+3],Z[re]=u.skinWeights[q*4],Z[re+1]=u.skinWeights[q*4+1],Z[re+2]=u.skinWeights[q*4+2],Z[re+3]=u.skinWeights[q*4+3]}for(let $=0;$<E;$+=1)Q[q*E+$]=r[$]+J}return g.setAttribute("position",new ge(G,3)),g.setAttribute("uv",new ge(z,2)),g.setAttribute("normal",new ge(d,3)),g.setAttribute("aRootPosition",new Ee(se,3,0)),g.setAttribute("aRootNormal",new Ee(se,3,3)),g.setAttribute("aScale",new Ee(ce,1,0)),g.setAttribute("aPhase",new Ee(ce,1,1)),g.setAttribute("aQuat",new Ee(ce,4,2)),g.setAttribute("aRootUv",new Ee(se,2,6)),g.setAttribute("skinIndex",new Ca(L,4)),g.setAttribute("skinWeight",new Ma(Z,4)),g.setIndex(new ge(Q,1)),g.userData.furSkinning=null,g.userData.strandGeometryType="skinned",g}const W=new Aa;W.index=C.index,W.attributes.position=C.attributes.position,W.attributes.uv=C.attributes.uv,W.attributes.normal=C.attributes.normal;const j=new Float32Array(t*3),M=new Float32Array(t*3),U=new Float32Array(t),P=new Float32Array(t),H=new Float32Array(t*4),F=new Float32Array(t*2);for(let f=0;f<t;f+=1)j[f*3]=u.positions[f*3],j[f*3+1]=u.positions[f*3+1],j[f*3+2]=u.positions[f*3+2],M[f*3]=u.normals[f*3],M[f*3+1]=u.normals[f*3+1],M[f*3+2]=u.normals[f*3+2],v.set(u.normals[f*3],u.normals[f*3+1],u.normals[f*3+2]).normalize(),gt(v,m),H[f*4]=m.x,H[f*4+1]=m.y,H[f*4+2]=m.z,H[f*4+3]=m.w,F[f*2]=u.uvs[f*2],F[f*2+1]=u.uvs[f*2+1],U[f]=w+A()*Y,P[f]=A()*Math.PI*2;return W.setAttribute("aOffset",new Ae(j,3)),W.setAttribute("aRootPosition",new Ae(j,3)),W.setAttribute("aRootNormal",new Ae(M,3)),W.setAttribute("aScale",new Ae(U,1)),W.setAttribute("aPhase",new Ae(P,1)),W.setAttribute("aQuat",new Ae(H,4)),W.setAttribute("aRootUv",new Ae(F,2)),u.skinIndices&&u.skinWeights?(W.userData.furSkinning={bindNormals:u.normals,bindPositions:u.positions,skinIndices:u.skinIndices,skinWeights:u.skinWeights},W.getAttribute("aOffset").setUsage(Tt),W.getAttribute("aQuat").setUsage(Tt)):W.userData.furSkinning=null,W.instanceCount=t,W.userData.strandGeometryType="instanced",W}function Gt(e,a,s,c,t){Ot.set(a.x,a.y,a.z,1).applyMatrix4(e.bindMatrix),Xe.set(0,0,0,0);for(let n=0;n<4;n+=1){const l=c[n];l>1e-5&&(Bt.fromArray(e.skeleton.boneMatrices,s[n]*16),jt.copy(Ot).applyMatrix4(Bt),Xe.addScaledVector(jt,l))}return t.set(Xe.x,Xe.y,Xe.z),t.applyMatrix4(e.bindMatrixInverse),t}function fa(e,a){const s=e?.userData?.furSkinning;if(!s||!a?.isSkinnedMesh||!a.skeleton)return!1;const c=e.getAttribute("aOffset"),t=e.getAttribute("aQuat");if(!c||!t)return!1;a.skeleton.update();for(let n=0;n<c.count;n+=1)dt.fromArray(s.bindPositions,n*3),mt.fromArray(s.bindNormals,n*3).normalize(),Lt.copy(dt).addScaledVector(mt,.025),Gt(a,dt,s.skinIndices.subarray(n*4,n*4+4),s.skinWeights.subarray(n*4,n*4+4),qe),Gt(a,Lt,s.skinIndices.subarray(n*4,n*4+4),s.skinWeights.subarray(n*4,n*4+4),Ut),Ge.copy(Ut).sub(qe),Ge.lengthSq()<=1e-6?Ge.copy(mt):Ge.normalize(),gt(Ge,He),c.setXYZ(n,qe.x,qe.y,qe.z),t.setXYZW(n,He.x,He.y,He.z,He.w);return c.needsUpdate=!0,t.needsUpdate=!0,!0}const sr="/textures/fur/uneven-alpha.png",ir=`
precision highp float;
...
`;function ur({source:e,count:a=5e3,bladeHeight:s=.045,bladeWidth:c=.008,alphaTexturePath:t=sr,rootColor:n=null,tipColor:l=null,tipMix:x=.18,curvature:R=.05,windStrength:k=.18,noiseFrequency:T=.4,noiseAmplitude:C=.02,waveAmplitude:u=.025,waveLength:A=.7,waveSpeed:v=1.2,waveDirection:m=[1,0],interactive:w=!0,interactionRadius:D=.18,interactionStrength:Y=1.2,seed:W=1,showInteractionSurface:j=!1,...M}){const U=o.useRef(),P=o.useRef(new I),H=l!=null,F=e.radius||1,f=s*F,E=c*F,S=D*F,O=C*F,B=u*F,y=o.useMemo(()=>da(a,e.isSkinnedMesh),[a,e.isSkinnedMesh]),N=o.useMemo(()=>Fe(),[]),r=Ie(t),g=o.useMemo(()=>ma({bladeWidth:E,isSkinnedMesh:e.isSkinnedMesh,seed:W,sourceGeometry:e.geometry,strandCount:y}),[E,y,W,e.geometry,e.isSkinnedMesh]),G=g?.userData?.strandGeometryType==="skinned",z=o.useMemo(()=>{const L=e.baseColor.clone();return n&&L.set(n),L},[n,e.baseColor]),d=o.useMemo(()=>l?new te(l):e.baseColor.clone(),[e.baseColor,l]),h=o.useMemo(()=>ut(m),[m]),i=o.useRef({uAlphaMap:{value:r||N},uBaseColor:{value:z.clone()},uBladeHeight:{value:f},uCurvature:{value:R},uInteractorEnabled:{value:0},uInteractorPos:{value:new I(1e3,1e3,1e3)},uInteractorRadius:{value:S},uInteractorStrength:{value:Y},uNoiseAmplitude:{value:O},uNoiseFrequency:{value:T},uSourceMap:{value:e.map||N},uTime:{value:0},uTipColor:{value:d.clone()},uTipMix:{value:x},uUseExplicitTipColor:{value:H?1:0},uUseSourceMap:{value:e.map?1:0},uWaveAmplitude:{value:B},uWaveDirection:{value:h.clone()},uWaveLength:{value:A},uWaveSpeed:{value:v},uWindStrength:{value:k}});o.useEffect(()=>()=>N.dispose(),[N]),o.useEffect(()=>{const L=i.current;L.uAlphaMap.value=r||N,L.uBaseColor.value.copy(z),L.uTipColor.value.copy(d),L.uBladeHeight.value=f,L.uCurvature.value=R,L.uInteractorRadius.value=S,L.uInteractorStrength.value=Y,L.uNoiseAmplitude.value=O,L.uNoiseFrequency.value=T,L.uSourceMap.value=e.map||N,L.uTipMix.value=x,L.uUseExplicitTipColor.value=H?1:0,L.uUseSourceMap.value=e.map?1:0,L.uWaveAmplitude.value=B,L.uWaveDirection.value.copy(h),L.uWaveLength.value=A,L.uWaveSpeed.value=v,L.uWindStrength.value=k},[r,f,R,N,S,Y,O,T,z,d,h,B,e.map,x,H,A,v,k]);const V=o.useCallback(L=>{!w||!U.current||(L.stopPropagation(),P.current.copy(L.point),U.current.worldToLocal(P.current),i.current.uInteractorEnabled.value=1,i.current.uInteractorPos.value.copy(P.current))},[w]),X=o.useCallback(()=>{i.current.uInteractorEnabled.value=0},[]);return Te((L,Z)=>{i.current.uTime.value+=Z,!G&&e.isSkinnedMesh&&e.mesh&&fa(g,e.mesh)}),g?G&&e.mesh?p.jsx(er,{alphaTexturePath:t,bladeHeight:s,curvature:R,geometry:g,interactionRadius:D,interactionStrength:Y,interactive:w,noiseAmplitude:C,noiseFrequency:T,rootColor:n,showInteractionSurface:j,source:e,tipColor:l,tipMix:x,waveAmplitude:u,waveDirection:m,waveLength:A,waveSpeed:v,windStrength:k,...M}):p.jsxs(_e,{ref:U,source:e,...M,children:[p.jsx("mesh",{frustumCulled:!1,geometry:g,children:p.jsx("rawShaderMaterial",{fragmentShader:lr,side:ke,uniforms:i.current,vertexShader:ir})}),p.jsx(ze,{onPointerDown:w?V:void 0,onPointerLeave:w?X:void 0,onPointerMove:w?V:void 0,showInteractionSurface:j,source:e})]}):null}function va({sourceGeometry:e=null,sourceMaterial:a=null,sourceMesh:s=null}){const[c,t]=o.useState(()=>Rt(s));return o.useLayoutEffect(()=>{const n=Rt(s);n!==c&&t(n)},[c,s]),o.useMemo(()=>{const n=pt(a)||pt(c?.material);return{baseColor:ja(n),geometry:e||c?.geometry||null,isSkinnedMesh:c?.isSkinnedMesh===!0,map:Va(n),material:n,mesh:c,radius:Ya(e||c?.geometry)}},[c,e,a])}function cr({technique:e=he.strand,sourceGeometry:a=null,sourceMaterial:s=null,sourceMesh:c=null,...t}){const n=va({sourceGeometry:a,sourceMaterial:s,sourceMesh:c});return n.geometry?e===he.shell?p.jsx($a,{...t,source:n}):e===he.strand?p.jsx(ur,{...t,source:n}):null:null}const qt=[.6,.6,.6,1],Xt=[1,1,1,0],dr="/textures/fur/uneven-alpha.png",mr=6.2831852,fr=.1376,vr=.3726,hr=.2546;function Zt(){return null}function $t(e,a){const s=Array.isArray(e)?e:a;return{alpha:s[3]??a[3],color:new te(s[0],s[1],s[2])}}function pr({alphaEnd:e,alphaMap:a,alphaStart:s,baseColor:c,colorEnd:t,colorStart:n,layerIndex:l,layerThickness:x,layersCount:R,sourceMap:k,interactionRadius:T,interactionStrength:C,stiffness:u,useSourceMap:A,waveScale:v}){const m={alphaEnd:b(e),alphaStart:b(s),baseColor:b(c.clone()),colorEnd:b(t.clone()),colorStart:b(n.clone()),interactorEnabled:b(0),interactorDir:b(new I(1,0,0)),interactorNormal:b(new I(0,1,0)),interactorPos:b(new I(1e3,1e3,1e3)),interactorRadius:b(T),interactorStrength:b(C),layerIndex:b(l),layerThickness:b(x),layersCount:b(R),stiffness:b(u),time:b(0),useSourceMap:b(A?1:0),waveScale:b(v)},w=new St({alphaTest:.001,depthWrite:!1,side:ke,transparent:!0}),D=m.layerIndex.div(m.layersCount.max(_(1))),Y=m.layerIndex.add(1).mul(m.layerThickness),W=m.waveScale.mul(xt(D.max(_(1e-4)),m.stiffness)),j=m.time.mul(mr),M=oe.toVar(),U=Da.normalize().toVar(),P=m.interactorNormal.normalize(),H=ne(M.x.add(U.x.mul(Y)).add(xe(j.add(M.x.add(M.y).add(M.z).mul(fr))).mul(W)),M.y.add(U.y.mul(Y)).add(yt(j.add(M.x.sub(M.y).add(M.z).mul(vr))).mul(W)),M.z.add(U.z.mul(Y)).add(xe(j.add(M.x.add(M.y).sub(M.z).mul(hr))).mul(W))),F=H.sub(m.interactorPos).toVar(),f=Be(F,P).toVar(),E=F.sub(P.mul(f)).toVar(),S=Pe(E),O=E.div(S.max(_(1e-5))),B=m.interactorDir.sub(P.mul(Be(m.interactorDir,P))).toVar(),y=Pe(B),N=ae(O,B.div(y.max(_(1e-5))),Wa(_(1e-4),y)),r=m.layerThickness.mul(2).max(m.interactorRadius.mul(.08)),g=_(1).sub(ye(r,r.mul(2.5),Ea(f.sub(Y)))),G=ae(_(1),_(.45),D),z=ae(_(.35),_(1),D),d=_(1).sub(ye(0,m.interactorRadius,S)).mul(g).mul(m.interactorStrength).mul(m.interactorEnabled),h=Ce(d.mul(G).mul(.32),0,.6),i=ae(H.add(N.mul(d).mul(z).mul(.85)),M,h).sub(U.mul(d).mul(G).mul(.08));let V=m.baseColor;k&&(V=ae(m.baseColor,m.baseColor.mul(Ue(new Le(k),nt()).rgb),m.useSourceMap)),w.vertexNode=na.mul(oa).mul(sa(i,1));const X=V.mul(ae(m.colorStart,m.colorEnd,D));return w.colorNode=X,w.opacityNode=Ue(new Le(a),nt()).r.mul(ae(m.alphaStart,m.alphaEnd,D)),{material:w,uniforms:m}}function gr({source:e,layers:a=null,shellCount:s=20,thickness:c=null,shellSpacing:t=null,waveScale:n=.06,stiffness:l=2.75,startColor:x=qt,endColor:R=Xt,alphaTexturePath:k=dr,rootColor:T=null,interactive:C=!1,interactionRadius:u=.18,interactionStrength:A=1.2,showInteractionSurface:v=!1,...m}){const w=o.useRef(),D=o.useRef(new I),Y=o.useRef(new I(0,1,0)),W=o.useRef(new I),j=o.useRef(new I(1,0,0)),M=o.useRef(),U=o.useMemo(()=>Fe(),[]),P=Ie(k),H=C||v,F=o.useMemo(()=>ca(a??s),[a,s]),f=o.useMemo(()=>{const d=e.baseColor.clone();return T&&d.set(T),d},[T,e.baseColor]),E=o.useMemo(()=>$t(x,qt),[x]),S=o.useMemo(()=>$t(R,Xt),[R]),O=c??t??.018,B=u*(e.radius||1),y=n,N=B,r=o.useMemo(()=>Array.from({length:F},(d,h)=>pr({alphaEnd:S.alpha,alphaMap:P||U,alphaStart:E.alpha,baseColor:f,colorEnd:S.color,colorStart:E.color,interactionRadius:B,interactionStrength:A,layerIndex:h,layerThickness:O,layersCount:F,sourceMap:e.map||U,stiffness:l,useSourceMap:!!e.map,waveScale:y})),[P,U,f,S.alpha,S.color,B,A,F,O,E.alpha,E.color,y,e.map,l]);o.useEffect(()=>{P&&(P.colorSpace=ta,P.wrapS=rt,P.wrapT=rt,P.needsUpdate=!0)},[P]),o.useEffect(()=>()=>{U.dispose()},[U]),o.useEffect(()=>()=>{r.forEach(({material:d})=>d.dispose())},[r]),o.useEffect(()=>{r.forEach((d,h)=>{const{uniforms:i}=d;i.alphaEnd.value=S.alpha,i.alphaStart.value=E.alpha,i.baseColor.value.copy(f),i.colorEnd.value.copy(S.color),i.colorStart.value.copy(E.color),i.interactorRadius.value=B,i.interactorStrength.value=A,i.layerIndex.value=h,i.layerThickness.value=O,i.layersCount.value=F,i.stiffness.value=l,i.useSourceMap.value=e.map?1:0,i.waveScale.value=y})},[r,f,S.alpha,S.color,B,A,F,O,E.alpha,E.color,y,e.map,l]);const g=o.useCallback(()=>{!M.current||!v||(M.current.visible=!0,M.current.position.copy(D.current))},[v]),G=o.useCallback(d=>{if(!C||!w.current)return;d.stopPropagation(),D.current.copy(d.point),w.current.worldToLocal(D.current),d.face?.normal&&Y.current.copy(d.face.normal).normalize();const h=new I().subVectors(D.current,W.current);h.lengthSq()>1e-8&&j.current.copy(h.normalize()),W.current.copy(D.current),r.forEach(({uniforms:i})=>{const V=i;V.interactorEnabled.value=1,V.interactorDir.value.copy(j.current),V.interactorNormal.value.copy(Y.current),V.interactorPos.value.copy(D.current)}),g()},[C,r,g]),z=o.useCallback(()=>{r.forEach(({uniforms:d})=>{const h=d;h.interactorEnabled.value=0,h.interactorDir.value.set(1,0,0),h.interactorNormal.value.set(0,1,0)}),M.current&&(M.current.visible=!1)},[r]);return o.useEffect(()=>{M.current&&(M.current.visible=!1)},[v]),Te((d,h)=>{r.forEach(i=>{const V=i.uniforms;V.time.value+=h})}),p.jsxs(_e,{ref:w,source:e,...m,children:[r.map(({material:d},h)=>e.isSkinnedMesh&&e.mesh?p.jsx(ct,{frustumCulled:!1,material:d,raycast:Zt,renderOrder:20+h,sourceMesh:e.mesh},d.uuid):p.jsx("mesh",{frustumCulled:!1,geometry:e.geometry,material:d,raycast:Zt,renderOrder:20+h},d.uuid)),H?p.jsx(ze,{onPointerDown:C?G:void 0,onPointerLeave:C?z:void 0,onPointerMove:C?G:void 0,showInteractionSurface:v,source:e}):null,v?p.jsxs("mesh",{ref:M,renderOrder:200,children:[p.jsx("sphereGeometry",{args:[N,20,20]}),p.jsx("meshBasicMaterial",{color:"#00ff88",depthTest:!1,depthWrite:!1,opacity:.95,transparent:!0,wireframe:!0})]}):null]})}function Qt(e,a,s,c,t,n){const l=s.mul(a),x=ia(e.element(t.x).mul(n.x).mul(l),e.element(t.y).mul(n.y).mul(l),e.element(t.z).mul(n.z).mul(l),e.element(t.w).mul(n.w).mul(l));return c.mul(x).xyz}function br(e,a,s,c,t,n){const l=ia(n.x.mul(e.element(t.x)),n.y.mul(e.element(t.y)),n.z.mul(e.element(t.z)),n.w.mul(e.element(t.w)));return c.mul(l).mul(s).transformDirection(a).xyz}const Sr="/textures/fur/uneven-alpha.png";function xr({source:e,geometry:a,bladeHeight:s=.045,alphaTexturePath:c=Sr,rootColor:t=null,tipColor:n=null,tipMix:l=.18,curvature:x=.05,windStrength:R=.18,noiseFrequency:k=.4,noiseAmplitude:T=.02,waveAmplitude:C=.025,waveLength:u=.7,waveSpeed:A=1.2,waveDirection:v=[1,0],interactive:m=!0,interactionRadius:w=.18,interactionStrength:D=1.2,showInteractionSurface:Y=!1,...W}){const j=o.useRef(),M=o.useRef(new I),U=n!=null,P=e.radius||1,H=s*P,F=w*P,f=T*P,E=C*P,S=o.useMemo(()=>Fe(),[]),O=Ie(c),B=o.useMemo(()=>{const d=e.baseColor.clone();return t&&d.set(t),d},[t,e.baseColor]),y=o.useMemo(()=>n?new te(n):e.baseColor.clone(),[e.baseColor,n]),N=o.useMemo(()=>ut(v),[v]),r=o.useMemo(()=>({baseColor:b(B.clone()),bladeHeight:b(H),curvature:b(x),interactorEnabled:b(0),interactorPos:b(new I(1e3,1e3,1e3)),interactorRadius:b(F),interactorStrength:b(D),noiseAmplitude:b(f),noiseFrequency:b(k),time:b(0),tipColor:b(y.clone()),tipMix:b(l),useExplicitTipColor:b(U?1:0),waveAmplitude:b(E),waveDirection:b(N.clone()),waveLength:b(u),waveSpeed:b(A),windStrength:b(R)}),[]),g=o.useMemo(()=>{const d=new St({alphaTest:.01,side:ke}),h=Se("aRootPosition","vec3"),i=Se("aRootNormal","vec3").normalize(),V=Se("aScale","float"),X=Se("aPhase","float"),L=Se("aQuat","vec4"),Z=Se("aRootUv","vec2"),Q=Se("skinIndex","uvec4"),se=Se("skinWeight","vec4"),ce=b(e.mesh.bindMatrix,"mat4"),q=b(e.mesh.bindMatrixInverse,"mat4"),Me=Na(e.mesh.skeleton.boneMatrices,"mat4",e.mesh.skeleton.bones.length),Re=ot(([ee,K])=>{const me=st(ee.xyz,K);return K.add(st(ee.xyz,me.add(K.mul(ee.w))).mul(2))}),J=Ce(oe.y,0,1),$=r.waveDirection.div(Pe(r.waveDirection).max(_(1e-4))),ie=xe(h.x.mul(r.noiseFrequency.max(_(1e-4))).add(h.z.mul(r.noiseFrequency.max(_(1e-4)))).add(J.mul(4)).add(r.time.mul(.1))).mul(.5).add(.5),le=ye(_(.08),_(.65),Ue(new Le(O||S),nt()).r),we=ot(()=>{const ee=ne(oe.x,oe.y.mul(r.bladeHeight).mul(V),oe.z).toVar(),K=r.time.add(X),me=xe(K.mul(1.3).add(h.x.mul(.2))).add(yt(K.mul(.7).add(h.z.mul(.15)))).mul(r.windStrength).mul(J.mul(J)),Oe=xe(Be(h.xz,$).div(r.waveLength.max(_(1e-4))).mul(6.2831852).sub(r.time.mul(r.waveSpeed))).mul(r.waveAmplitude).mul(J),De=h.add(Re(L,ee.add(ne(r.curvature.mul(J).mul(J),0,0)).add(ne(me.mul(.4),0,me.mul(.15))).add(ne($.x.mul(Oe),0,$.y.mul(Oe))).add(ne(ie.sub(.5).mul(r.noiseAmplitude).mul(J),0,ie.sub(.5).mul(r.noiseAmplitude).mul(J).mul(.6))))).toVar(),We=Qt(Me,h,ce,q,Q,se).toVar(),je=br(Me,i,ce,q,Q,se).normalize().toVar(),Je=Qt(Me,De,ce,q,Q,se).toVar(),Ve=We.sub(r.interactorPos).sub(je.mul(Be(We.sub(r.interactorPos),je))).toVar(),et=Pe(Ve),Mt=Ce(_(1).sub(ye(0,r.interactorRadius,et)).mul(r.interactorStrength).mul(r.interactorEnabled),0,1),ga=Ve.div(et.max(_(1e-5)));return ae(Je.add(ga.mul(Mt).mul(r.bladeHeight).mul(.9).mul(J)),We,Mt.mul(.25).mul(J))})();let re=r.baseColor;e.map&&(re=r.baseColor.mul(Ue(new Le(e.map),Z).rgb));const de=ae(re,r.tipColor,r.tipMix.mul(r.useExplicitTipColor));return d.vertexNode=na.mul(oa).mul(sa(we,1)),d.colorNode=ae(re,de,xt(J,1.2)).mul(ae(_(.75),_(1.25),ie)).mul(ae(_(.82),_(1),le)).add(ye(.7,1,J).mul(.12)),d.opacityNode=le,d},[O,S,e.map,e.mesh,r]);o.useEffect(()=>()=>{S.dispose(),g.dispose()},[S,g]),o.useEffect(()=>{r.baseColor.value.copy(B),r.bladeHeight.value=H,r.curvature.value=x,r.interactorRadius.value=F,r.interactorStrength.value=D,r.noiseAmplitude.value=f,r.noiseFrequency.value=k,r.tipColor.value.copy(y),r.tipMix.value=l,r.useExplicitTipColor.value=U?1:0,r.waveAmplitude.value=E,r.waveDirection.value.copy(N),r.waveLength.value=u,r.waveSpeed.value=A,r.windStrength.value=R},[x,D,k,B,H,F,f,y,E,N,l,r,U,u,A,R]);const G=o.useCallback(d=>{!m||!j.current||(d.stopPropagation(),M.current.copy(d.point),j.current.worldToLocal(M.current),r.interactorEnabled.value=1,r.interactorPos.value.copy(M.current))},[m,r]),z=o.useCallback(()=>{r.interactorEnabled.value=0},[r]);return Te((d,h)=>{r.time.value+=h,e.mesh?.skeleton?.update()}),!a||!e.mesh?null:p.jsxs(_e,{ref:j,source:e,...W,children:[p.jsx("mesh",{frustumCulled:!1,geometry:a,material:g}),p.jsx(ze,{onPointerDown:m?G:void 0,onPointerLeave:m?z:void 0,onPointerMove:m?G:void 0,showInteractionSurface:Y,source:e})]})}const yr="/textures/fur/uneven-alpha.png";function Cr({source:e,count:a=5e3,bladeHeight:s=.045,bladeWidth:c=.008,alphaTexturePath:t=yr,rootColor:n=null,tipColor:l=null,tipMix:x=.18,curvature:R=.05,windStrength:k=.18,noiseFrequency:T=.4,noiseAmplitude:C=.02,waveAmplitude:u=.025,waveLength:A=.7,waveSpeed:v=1.2,waveDirection:m=[1,0],interactive:w=!0,interactionRadius:D=.18,interactionStrength:Y=1.2,seed:W=1,showInteractionSurface:j=!1,...M}){const U=o.useRef(),P=o.useRef(new I),H=l!=null,F=e.radius||1,f=s*F,E=c*F,S=D*F,O=C*F,B=u*F,y=o.useMemo(()=>da(a,e.isSkinnedMesh),[a,e.isSkinnedMesh]),N=o.useMemo(()=>Fe(),[]),r=Ie(t),g=o.useMemo(()=>ma({bladeWidth:E,isSkinnedMesh:e.isSkinnedMesh,seed:W,sourceGeometry:e.geometry,strandCount:y}),[E,y,W,e.geometry,e.isSkinnedMesh]),G=g?.userData?.strandGeometryType==="skinned",z=o.useMemo(()=>{const Z=e.baseColor.clone();return n&&Z.set(n),Z},[n,e.baseColor]),d=o.useMemo(()=>l?new te(l):e.baseColor.clone(),[e.baseColor,l]),h=o.useMemo(()=>ut(m),[m]),i=o.useMemo(()=>({baseColor:b(z.clone()),bladeHeight:b(f),curvature:b(R),interactorEnabled:b(0),interactorPos:b(new I(1e3,1e3,1e3)),interactorRadius:b(S),interactorStrength:b(Y),noiseAmplitude:b(O),noiseFrequency:b(T),time:b(0),tipColor:b(d.clone()),tipMix:b(x),useExplicitTipColor:b(H?1:0),waveAmplitude:b(B),waveDirection:b(h.clone()),waveLength:b(A),waveSpeed:b(v),windStrength:b(k)}),[]),V=o.useMemo(()=>{if(!g||G)return null;const Z=new St({alphaTest:.01,side:ke}),Q=Ye(g.getAttribute("aOffset")),se=Ye(g.getAttribute("aScale")),ce=Ye(g.getAttribute("aPhase")),q=Ye(g.getAttribute("aQuat")),Me=Ye(g.getAttribute("aRootUv")),Re=ye(_(.08),_(.65),Ue(new Le(r||N),nt()).r),J=ot(([ee,K])=>{const me=st(ee.xyz,K);return K.add(st(ee.xyz,me.add(K.mul(ee.w))).mul(2))}),$=Ce(oe.y,0,1),ie=i.waveDirection.div(Pe(i.waveDirection).max(_(1e-4))),le=xe(Q.x.mul(i.noiseFrequency.max(_(1e-4))).add(Q.z.mul(i.noiseFrequency.max(_(1e-4)))).add($.mul(4)).add(i.time.mul(.1))).mul(.5).add(.5),we=ot(()=>{const ee=ne(oe.x,oe.y.mul(i.bladeHeight).mul(se),oe.z).toVar(),K=i.time.add(ce),me=xe(K.mul(1.3).add(Q.x.mul(.2))).add(yt(K.mul(.7).add(Q.z.mul(.15)))).mul(i.windStrength).mul($.mul($)),Oe=xe(Be(Q.xz,ie).div(i.waveLength.max(_(1e-4))).mul(6.2831852).sub(i.time.mul(i.waveSpeed))).mul(i.waveAmplitude).mul($),De=J(q,ee.add(ne(i.curvature.mul($).mul($),0,0)).add(ne(me.mul(.4),0,me.mul(.15))).add(ne(ie.x.mul(Oe),0,ie.y.mul(Oe))).add(ne(le.sub(.5).mul(i.noiseAmplitude).mul($),0,le.sub(.5).mul(i.noiseAmplitude).mul($).mul(.6)))).toVar(),We=J(q,ne(0,1,0)).normalize().toVar(),je=Q.sub(i.interactorPos).sub(We.mul(Be(Q.sub(i.interactorPos),We))).toVar(),Je=Pe(je),Ve=Ce(_(1).sub(ye(0,i.interactorRadius,Je)).mul(i.interactorStrength).mul(i.interactorEnabled),0,1),et=je.div(Je.max(_(1e-5)));return De.addAssign(et.mul(Ve).mul(i.bladeHeight).mul(.9).mul($)),De.y.assign(De.y.mul(_(1).sub(Ve.mul(.25).mul($)))),De.add(Q)})();let re=i.baseColor;e.map&&(re=i.baseColor.mul(Ue(new Le(e.map),Me).rgb));const de=ae(re,i.tipColor,i.tipMix.mul(i.useExplicitTipColor));return Z.positionNode=we,Z.colorNode=ae(re,de,xt($,1.2)).mul(ae(_(.75),_(1.25),le)).mul(ae(_(.82),_(1),Re)).add(ye(.7,1,$).mul(.12)),Z.opacityNode=Re,Z},[r,N,g,G,e.map,i]);o.useEffect(()=>()=>{N.dispose(),V?.dispose()},[N,V]),o.useEffect(()=>{i.baseColor.value.copy(z),i.bladeHeight.value=f,i.curvature.value=R,i.interactorRadius.value=S,i.interactorStrength.value=Y,i.noiseAmplitude.value=O,i.noiseFrequency.value=T,i.tipColor.value.copy(d),i.tipMix.value=x,i.useExplicitTipColor.value=H?1:0,i.waveAmplitude.value=B,i.waveDirection.value.copy(h),i.waveLength.value=A,i.waveSpeed.value=v,i.windStrength.value=k},[f,R,S,Y,O,T,z,d,h,B,x,H,i,A,v,k]);const X=o.useCallback(Z=>{!w||!U.current||(Z.stopPropagation(),P.current.copy(Z.point),U.current.worldToLocal(P.current),i.interactorEnabled.value=1,i.interactorPos.value.copy(P.current))},[w,i]),L=o.useCallback(()=>{i.interactorEnabled.value=0},[i]);return Te((Z,Q)=>{i.time.value+=Q,!G&&e.isSkinnedMesh&&e.mesh&&fa(g,e.mesh)}),g?G&&e.mesh?p.jsx(xr,{alphaTexturePath:t,bladeHeight:s,curvature:R,geometry:g,interactionRadius:D,interactionStrength:Y,interactive:w,noiseAmplitude:C,noiseFrequency:T,rootColor:n,showInteractionSurface:j,source:e,tipColor:l,tipMix:x,waveAmplitude:u,waveDirection:m,waveLength:A,waveSpeed:v,windStrength:k,...M}):p.jsxs(_e,{ref:U,source:e,...M,children:[p.jsx("mesh",{frustumCulled:!1,geometry:g,material:V}),p.jsx(ze,{onPointerDown:w?X:void 0,onPointerLeave:w?L:void 0,onPointerMove:w?X:void 0,showInteractionSurface:j,source:e})]}):null}function Mr({technique:e=he.strand,sourceGeometry:a=null,sourceMaterial:s=null,sourceMesh:c=null,...t}){const n=va({sourceGeometry:a,sourceMaterial:s,sourceMesh:c});return n.geometry?e===he.shell?p.jsx(gr,{...t,source:n}):e===he.strand?p.jsx(Cr,{...t,source:n}):null:null}function ha(e){return ra(c=>c.gl)?.isWebGPURenderer===!0?p.jsx(Mr,{...e}):p.jsx(cr,{...e})}const pa=.875,Ct=.16;function Ar({radius:e=pa,height:a=Ct,widthSegments:s=64,heightSegments:c=24}={}){const t=new ka(e,s,c,0,Math.PI*2,0,Math.PI/2),n=t.getAttribute("position");for(let l=0;l<n.count;l+=1){const x=lt.clamp(n.getY(l)/e,0,1);n.setY(l,x*a)}return n.needsUpdate=!0,t.computeVertexNormals(),t.computeBoundingBox(),t.computeBoundingSphere(),t}const Pr=o.forwardRef(function({colorDark:a,colorLight:s,floorY:c,geometry:t},n){const l=o.useMemo(()=>{const x=new te(a),R=new te(s),k=t.boundingBox,T=t.boundingSphere?.radius??1,C=k?k.max.y-k.min.y:1,u=new Ta({color:x,metalness:0,roughness:.96});return u.onBeforeCompile=A=>{const v=A;v.uniforms.uPatchDark={value:x.clone()},v.uniforms.uPatchHeight={value:C},v.uniforms.uPatchLight={value:R.clone()},v.uniforms.uPatchRadius={value:T},v.vertexShader=v.vertexShader.replace("#include <common>",`#include <common>
