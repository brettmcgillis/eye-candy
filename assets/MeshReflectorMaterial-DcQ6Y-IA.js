import{_ as te}from"./extends-CF3RwP-h.js";import{ay as re,$ as E,by as ae,aM as u,a4 as H,a6 as Y,aI as I,bs as ie,bz as ne,aw as oe,ai as G,aA as se,aX as le,S as a,a1 as ue,Y as V,ac as fe,Z as w,aC as X,_ as q,aq as he,aK as me,bA as ve,bc as ce,a2 as de}from"./index-BnEdaNJi.js";import{v as pe}from"./constants-BOBXA0R7.js";class xe extends re{constructor(e=new E){super({uniforms:{inputBuffer:new u(null),depthBuffer:new u(null),resolution:new u(new E),texelSize:new u(new E),halfTexelSize:new u(new E),kernel:new u(0),scale:new u(1),cameraNear:new u(0),cameraFar:new u(1),minDepthThreshold:new u(0),maxDepthThreshold:new u(1),depthScale:new u(0),depthToBlurRatioBias:new u(.25)},fragmentShader:`#include <common>
      ...
      `)}get tDiffuse(){return this._tDiffuse.value}set tDiffuse(e){this._tDiffuse.value=e}get tDepth(){return this._tDepth.value}set tDepth(e){this._tDepth.value=e}get distortionMap(){return this._distortionMap.value}set distortionMap(e){this._distortionMap.value=e}get tDiffuseBlur(){return this._tDiffuseBlur.value}set tDiffuseBlur(e){this._tDiffuseBlur.value=e}get textureMatrix(){return this._textureMatrix.value}set textureMatrix(e){this._textureMatrix.value=e}get hasBlur(){return this._hasBlur.value}set hasBlur(e){this._hasBlur.value=e}get mirror(){return this._mirror.value}set mirror(e){this._mirror.value=e}get mixBlur(){return this._mixBlur.value}set mixBlur(e){this._mixBlur.value=e}get mixStrength(){return this._blurStrength.value}set mixStrength(e){this._blurStrength.value=e}get minDepthThreshold(){return this._minDepthThreshold.value}set minDepthThreshold(e){this._minDepthThreshold.value=e}get maxDepthThreshold(){return this._maxDepthThreshold.value}set maxDepthThreshold(e){this._maxDepthThreshold.value=e}get depthScale(){return this._depthScale.value}set depthScale(e){this._depthScale.value=e}get depthToBlurRatioBias(){return this._depthToBlurRatioBias.value}set depthToBlurRatioBias(e){this._depthToBlurRatioBias.value=e}get distortion(){return this._distortion.value}set distortion(e){this._distortion.value=e}get mixContrast(){return this._mixContrast.value}set mixContrast(e){this._mixContrast.value=e}};const Ue=a.forwardRef(({mixBlur:y=0,mixStrength:e=1,resolution:t=256,blur:s=[0,0],minDepthThreshold:m=.9,maxDepthThreshold:c=1,depthScale:d=0,depthToBlurRatioBias:p=.25,mirror:D=0,distortion:h=1,mixContrast:x=1,distortionMap:f,reflectorOffset:T=0,..._},P)=>{ue({MeshReflectorMaterialImpl:ge});const n=V(({gl:r})=>r),b=V(({camera:r})=>r),K=V(({scene:r})=>r);s=Array.isArray(s)?s:[s,s];const A=s[0]+s[1]>0,$=s[0],L=s[1],M=a.useRef(null);a.useImperativeHandle(P,()=>M.current,[]);const[U]=a.useState(()=>new fe),[g]=a.useState(()=>new w),[S]=a.useState(()=>new w),[W]=a.useState(()=>new w),[R]=a.useState(()=>new X),[z]=a.useState(()=>new w(0,0,-1)),[v]=a.useState(()=>new q),[F]=a.useState(()=>new w),[k]=a.useState(()=>new w),[C]=a.useState(()=>new q),[B]=a.useState(()=>new X),[l]=a.useState(()=>new he),Z=a.useCallback(()=>{var r;const i=M.current.parent||((r=M.current)==null||(r=r.__r3f.parent)==null?void 0:r.object);if(!i||(S.setFromMatrixPosition(i.matrixWorld),W.setFromMatrixPosition(b.matrixWorld),R.extractRotation(i.matrixWorld),g.set(0,0,1),g.applyMatrix4(R),S.addScaledVector(g,T),F.subVectors(S,W),F.dot(g)>0))return;F.reflect(g).negate(),F.add(S),R.extractRotation(b.matrixWorld),z.set(0,0,-1),z.applyMatrix4(R),z.add(W),k.subVectors(S,z),k.reflect(g).negate(),k.add(S),l.position.copy(F),l.up.set(0,1,0),l.up.applyMatrix4(R),l.up.reflect(g),l.lookAt(k),l.far=b.far,l.updateMatrixWorld(),l.projectionMatrix.copy(b.projectionMatrix),B.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),B.multiply(l.projectionMatrix),B.multiply(l.matrixWorldInverse),B.multiply(i.matrixWorld),U.setFromNormalAndCoplanarPoint(g,S),U.applyMatrix4(l.matrixWorldInverse),v.set(U.normal.x,U.normal.y,U.normal.z,U.constant);const o=l.projectionMatrix;C.x=(Math.sign(v.x)+o.elements[8])/o.elements[0],C.y=(Math.sign(v.y)+o.elements[9])/o.elements[5],C.z=-1,C.w=(1+o.elements[10])/o.elements[14],v.multiplyScalar(2/v.dot(C)),o.elements[2]=v.x,o.elements[6]=v.y,o.elements[10]=v.z+1,o.elements[14]=v.w},[b,T]),[O,J,Q,j]=a.useMemo(()=>{const r={minFilter:I,magFilter:I,type:Y},i=new H(t,t,r);i.depthBuffer=!0,i.depthTexture=new me(t,t),i.depthTexture.format=ve,i.depthTexture.type=ce;const o=new H(t,t,r),N=new _e({gl:n,resolution:t,width:$,height:L,minDepthThreshold:m,maxDepthThreshold:c,depthScale:d,depthToBlurRatioBias:p}),ee={mirror:D,textureMatrix:B,mixBlur:y,tDiffuse:i.texture,tDepth:i.depthTexture,tDiffuseBlur:o.texture,hasBlur:A,mixStrength:e,minDepthThreshold:m,maxDepthThreshold:c,depthScale:d,depthToBlurRatioBias:p,distortion:h,distortionMap:f,mixContrast:x,"defines-USE_BLUR":A?"":void 0,"defines-USE_DEPTH":d>0?"":void 0,"defines-USE_DISTORTION":f?"":void 0};return[i,o,N,ee]},[n,$,L,B,t,D,A,y,e,m,c,d,p,h,f,x]);return de(()=>{var r;const i=M.current.parent||((r=M.current)==null||(r=r.__r3f.parent)==null?void 0:r.object);if(!i)return;i.visible=!1;const o=n.xr.enabled,N=n.shadowMap.autoUpdate;Z(),n.xr.enabled=!1,n.shadowMap.autoUpdate=!1,n.setRenderTarget(O),n.state.buffers.depth.setMask(!0),n.autoClear||n.clear(),n.render(K,l),A&&Q.render(n,O,J),n.xr.enabled=o,n.shadowMap.autoUpdate=N,i.visible=!0,n.setRenderTarget(null)}),a.createElement("meshReflectorMaterialImpl",te({attach:"material",key:"key"+j["defines-USE_BLUR"]+j["defines-USE_DEPTH"]+j["defines-USE_DISTORTION"],ref:M},j,_))});export{Ue as M};
