...
export const PRESETS = {
  ...
  Pixelate: {
    // Identical to Default, with fullscreen fractal pixelation switched on
    // and sparkles switched off (the pixelation reads better without the
    // fine sparkle points fighting the blocky grid).
    backgroundColor: '#202030',
    fogColor: '#202030',
    fogNear: 10,
    fogFar: 25,
