...
assets = {
  debugFloor: new THREE.TextureLoader().load(
    '//cdn.wtlstudio.com/sample.wtlstudio.com/9f120108-34f1-4c8e-8340-42ab82b1110c.png',
    (texture) => {
  ...
  debugWall: new THREE.TextureLoader().load(
    '//cdn.wtlstudio.com/sample.wtlstudio.com/5cf2cf39-d43a-4d47-a1d4-6c2e04bf6805.png'
  ),
  debugGreen: new THREE.TextureLoader().load(
    '//cdn.wtlstudio.com/sample.wtlstudio.com/9a69fcdb-e1b0-4b1a-9869-2688080a6ef7.png'
  ),
  debugOrange: new THREE.TextureLoader().load(
    '//cdn.wtlstudio.com/sample.wtlstudio.com/6897a0b3-265f-4131-90f4-cba63ffe15c2.png'
  ),
  debugRed: new THREE.TextureLoader().load(
    '//cdn.wtlstudio.com/sample.wtlstudio.com/0a6c4374-d249-41a7-aa46-e96ca643a100.png'
  ),
  debugPurple: new THREE.TextureLoader().load(
    '//cdn.wtlstudio.com/sample.wtlstudio.com/00cc7870-9fb6-4a0c-8aaf-72b5fa9d92fb.png'
  ),
  grassModel:
  ...
  background:
    '//cdn.wtlstudio.com/sample.wtlstudio.com/2b211464-b704-4060-a50c-126fc53a8f27.jpg',
  environment:
    '//cdn.wtlstudio.com/sample.wtlstudio.com/8e560393-27e2-4092-acb1-a33b17b6a113.hdr',
};
