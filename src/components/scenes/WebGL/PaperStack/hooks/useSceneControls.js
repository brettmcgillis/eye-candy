...
import { COLOR_PRESETS, WINDOW_PRESETS } from '../presets/presets';
...
export default function useSceneControls() {
  ...
  const initialSnapshot =
    WINDOW_PRESETS[initialPreset] || WINDOW_PRESETS.Default;

  const initialColorPreset = initialSnapshot.colorPreset || 'Default';
  const initialColors =
    COLOR_PRESETS[initialColorPreset] || COLOR_PRESETS.Default;
      ...
      Stack: folder(
        {
          ...
          stackRotXDeg: {
            label: 'Rot X (°)',
            value: initialSnapshot.stackRotXDeg,
            min: -180,
            max: 180,
            step: 1,
          },
          stackRotYDeg: {
            label: 'Rot Y (°)',
            value: initialSnapshot.stackRotYDeg,
            min: -180,
            max: 180,
            step: 1,
          },
          stackRotZDeg: {
            label: 'Rot Z (°)',
            value: initialSnapshot.stackRotZDeg,
            min: -180,
            max: 180,
            step: 1,
          },
          ...
          layerDepth: {
            value: initialSnapshot.layerDepth,
            min: 0.005,
            max: 0.1,
          },
          layerDepthBuffer: {
            value: initialSnapshot.layerDepthBuffer,
            min: 0,
            max: 0.1,
          },
        },
      ...
      Window: folder(
        {
          windowSize01: {
            label: 'Size',
            value: initialSnapshot.windowSize01,
            min: 0,
            max: 1,
          },
          minSizeRatio: {
            label: 'Min Size %',
            value: initialSnapshot.minSizeRatio,
            min: 0.02,
            max: 0.4,
          },
          maxSizeRatio: {
            label: 'Max Size %',
            value: initialSnapshot.maxSizeRatio,
            min: 0.1,
            max: 0.48,
          },
          ...
          squareSpacing: {
            value: initialSnapshot.squareSpacing,
            min: 0.4,
            max: 1.4,
          },
          patternRotationDeg: {
            label: 'Pattern Rot (°)',
            value: initialSnapshot.patternRotationDeg,
            min: 0,
            max: 180,
            step: 1,
          },
          windowRotationDeg: {
            label: 'Square Rot (°)',
            value: initialSnapshot.windowRotationDeg,
            min: 0,
            max: 90,
            step: 1,
          },
      ...
      Stepping: folder(
        {
          ...
          taperCurve: {
            value: initialSnapshot.taperCurve,
            min: 0.4,
            max: 4,
            step: 0.1,
          },
      ...
      Spiral: folder(
        {
          spiralTwistDeg: {
            label: 'Total Spiral (°)',
            value: initialSnapshot.spiralTwistDeg,
            min: -360,
            max: 360,
            step: 1,
          },
          spiralCurve: {
            label: 'Spiral Curve',
            value: initialSnapshot.spiralCurve,
            min: 0.2,
            max: 4,
            step: 0.1,
          },
      ...
      Chips: folder(
        {
          ...
          chipsPitchDeg: {
            label: 'Pitch (°)',
            value: initialSnapshot.chipsPitchDeg,
            min: -180,
            max: 180,
            step: 1,
          },
          chipsRotXDeg: {
            label: 'Rot X (°)',
            value: initialSnapshot.chipsRotXDeg,
            min: -180,
            max: 180,
            step: 1,
          },
          chipsRotYDeg: {
            label: 'Rot Y (°)',
            value: initialSnapshot.chipsRotYDeg,
            min: -180,
            max: 180,
            step: 1,
          },
          chipsRotZDeg: {
            label: 'Rot Z (°)',
            value: initialSnapshot.chipsRotZDeg,
            min: -180,
            max: 180,
            step: 1,
          },
      ...
      Scene: folder(
        {
          ...
          ambientIntensity: {
            label: 'Ambient Light',
            value: initialSnapshot.ambientIntensity ?? 1,
            min: 0,
            max: 10,
            step: 0.1,
          },
      ...
      Animation: folder(
        {
          ...
          animColor: {
            label: 'Layer Color',
            value: initialSnapshot.animColor || '#ffffff',
          },
          animEmissive: {
            label: 'Emissive',
            value: initialSnapshot.animEmissive || '#ffffff',
          },
          animEmissiveIntensity: {
            label: 'Emissive Intensity',
            value: initialSnapshot.animEmissiveIntensity ?? 2,
            min: 0,
            max: 10,
            step: 0.1,
          },
          animSpeed: {
            label: 'Speed (layers/s)',
            value: initialSnapshot.animSpeed ?? 3,
            min: 0.1,
            max: 20,
            step: 0.1,
          },
      ...
      Shadows: folder(
        {
          accumFrames: {
            label: 'Frames',
            value: initialSnapshot.accumFrames,
            min: 1,
            max: 400,
            step: 1,
          },
          ...
          accumColorBlend: {
            label: 'Color Blend',
            value: initialSnapshot.accumColorBlend,
            min: 0,
            max: 1,
            step: 0.01,
          },
          accumOpacity: {
            label: 'Opacity',
            value: initialSnapshot.accumOpacity,
            min: 0,
            max: 1,
            step: 0.01,
          },
          accumScale: {
            label: 'Scale',
            value: initialSnapshot.accumScale,
            min: 1,
            max: 40,
            step: 0.1,
          },
          accumAlphaTest: {
            label: 'Alpha Test',
            value: initialSnapshot.accumAlphaTest,
            min: 0,
            max: 1,
            step: 0.01,
          },
          ...
          lightAmount: {
            label: 'Light Amount',
            value: initialSnapshot.lightAmount,
            min: 1,
            max: 24,
            step: 1,
          },
          lightRadius: {
            label: 'Light Radius',
            value: initialSnapshot.lightRadius,
            min: 0.1,
            max: 20,
            step: 0.1,
          },
          lightAmbient: {
            label: 'Light Ambient',
            value: initialSnapshot.lightAmbient,
            min: 0,
            max: 1,
            step: 0.01,
          },
          lightBias: {
            label: 'Light Bias',
            value: initialSnapshot.lightBias,
            min: 0,
            max: 0.02,
            step: 0.0001,
          },
          lightDebug: {
            label: 'Debug Light Pos',
            value: initialSnapshot.lightDebug,
          },
          lightX: {
            label: 'Light X',
            value: initialSnapshot.lightX,
            min: -20,
            max: 20,
            step: 0.1,
          },
