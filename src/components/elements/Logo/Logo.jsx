...
export default function Logo({
  ...
  pixelateShape = 'quad',
  pixelateDriver = 'noise',
  pixelateCellSize = 12,
  pixelateLevels = 3,
  pixelateThreshold = 0.55,
  pixelateVarianceThreshold = 0.12,
      ...
      <group ref={logoRef}>
        ...
        >
          <InteractiveBret
            ...
            pixelateShape={pixelateShape}
            pixelateDriver={pixelateDriver}
            pixelateCellSize={pixelateCellSize}
            pixelateLevels={pixelateLevels}
            pixelateThreshold={pixelateThreshold}
            pixelateVarianceThreshold={pixelateVarianceThreshold}
