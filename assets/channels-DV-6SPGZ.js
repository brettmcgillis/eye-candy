import{r as y,d as pe,aN as Pt,n as tr,aP as Ot,a as G,j as C,F as K,aG as Ke,U as Q,ao as me,C as Ee,e as ee,W as _e,d0 as _t,d1 as At,aq as qe,d2 as rr,o as ze,L as nr,S as H,a9 as ar,ax as or,am as ir,d3 as ue,aL as fe,I as ge,ai as Ae,an as ur,a3 as te,az as N,cl as De}from"./index-Dv5U39OI.js";import{s as xe}from"./shaderMaterial-DHnUL294.js";import{_ as sr}from"./extends-CF3RwP-h.js";import{u as lr}from"./Fbo-KvbySqls.js";import{C as cr}from"./crtStaticMaterial-ziLmgeMj.js";import{u as M,t as X,k as ie,J as ve,m as et,R as tt,C as Ce,o as ne,a0 as Ue,aq as Ne,r as de,e as Y,P as ye,Y as rt,F as W,v as _,f as re,c as J,d as V,O as mr,a as fr,ar as vr,T as le,s as hr,aB as ce,b as dr,D as pr}from"./three.tsl-DoeFUlGW.js";import{S as nt}from"./tracks-DQtmcKVK.js";import{B as gr}from"./Bret-DDjnSpXC.js";import{I as xr}from"./Reversal-Bc7oNQVW.js";import{P as Sr}from"./PerspectiveCamera-1Kr8QWI0.js";const br=y.forwardRef(({children:e,compute:t,width:r,height:n,samples:a=8,renderPriority:o=0,eventPriority:u=0,frames:s=1/0,stencilBuffer:l=!1,depthBuffer:i=!0,generateMipmaps:c=!1,...f},m)=>{const{size:h,viewport:v}=pe(),d=lr((r||h.width)*v.dpr,(n||h.height)*v.dpr,{samples:a,stencilBuffer:l,depthBuffer:i,generateMipmaps:c}),[p]=y.useState(()=>new Pt),x=y.useCallback((S,R,w)=>{var T,k;let g=(T=d.texture)==null||(T=T.__r3f.parent)==null?void 0:T.object;for(;g&&!(g instanceof tr);){var b;g=(b=g.__r3f.parent)==null?void 0:b.object}if(!g)return!1;w.raycaster.camera||w.events.compute(S,w,(k=w.previousRoot)==null?void 0:k.getState());const[E]=w.raycaster.intersectObject(g);if(!E)return!1;const B=E.uv;if(!B)return!1;R.raycaster.setFromCamera(R.pointer.set(B.x*2-1,B.y*2-1),R.camera)},[]);return y.useImperativeHandle(m,()=>d.texture,[d]),y.createElement(y.Fragment,null,Ot(y.createElement(yr,{renderPriority:o,frames:s,fbo:d},e,y.createElement("group",{onPointerOver:()=>null})),p,{events:{compute:t||x,priority:u}}),y.createElement("primitive",sr({object:d.texture},f)))});function yr({frames:e,renderPriority:t,children:r,fbo:n}){let a=0,o,u,s,l;return G(i=>{(e===1/0||a<e)&&(o=i.gl.autoClear,u=i.gl.xr.enabled,s=i.gl.getRenderTarget(),l=i.gl.xr.isPresenting,i.gl.autoClear=!0,i.gl.xr.enabled=!1,i.gl.xr.isPresenting=!1,i.gl.setRenderTarget(n),i.gl.render(i.scene,i.camera),i.gl.setRenderTarget(s),i.gl.autoClear=o,i.gl.xr.enabled=u,i.gl.xr.isPresenting=l,a++)},t),y.createElement(y.Fragment,null,r)}function Xn({color:e="#111111",metalness:t=.2,position:r=[0,-.02,0],roughness:n=.92,rotation:a=[-Math.PI/2,0,0],size:o=30}){return C.jsxs("mesh",{position:r,rotation:a,receiveShadow:!0,children:[C.jsx("planeGeometry",{args:[o,o]}),C.jsx("meshStandardMaterial",{color:e,metalness:t,roughness:n})]})}function Kn({boardColor:e="#7a5337",boardMetalness:t=.03,boardRoughness:r=.92,panels:n,columns:a=3,panelHeight:o=2,panelWidth:u=2,spacingX:s=3.3,spacingZ:l=2.8}){const i=Math.ceil(n.length/a),c=(a-1)/2,f=(i-1)/2;return C.jsx("group",{children:n.map((m,h)=>{const v=h%a,d=Math.floor(h/a),p=(v-c)*s,x=(d-f)*l,S=(v-c)*.025;return C.jsxs("group",{position:[p,.08,x],rotation:[-Math.PI/2,0,S],children:[C.jsxs("mesh",{castShadow:!0,receiveShadow:!0,children:[C.jsx("boxGeometry",{args:[u+.48,o+.48,.16]}),C.jsx("meshStandardMaterial",{color:e,metalness:t,roughness:r})]}),C.jsxs("mesh",{position:[0,0,.081],children:[C.jsx("planeGeometry",{args:[u,o]}),m.video]})]},m.key)})})}const wr=`
...
`,Dt=xe({uTime:0,uTextTexture:null,uScreenColor:new Ee(.05,.18,.85),uNoiseStrength:.08,uGlowStrength:.35,uCurvature:.06,uVignette:.85,uScanlineStrength:.08,uScanlineDensity:900,uRollSpeed:.4,uRollStrength:.4,uChromaOffset:.0025},Tr,Mr);ee({CrtBlueScreenMaterial:Dt});function Cr(e,t,r,n,a,o){const u=t.split("");let s="";const l=[];return u.forEach(i=>{if(i===`
`)l.push(s),s="";else{const c=s+i;e.measureText(c).width>a&&s?(l.push(s),s=i):s=c}}),s&&l.push(s),l.forEach((i,c)=>{e.fillText(i,r,n+c*o)}),{lines:l,y:n+(l.length-1)*o}}function kr({canvas:e,text:t,font:r,fontSize:n,fontColor:a,showCaret:o,caretMode:u,horizontalPadding:s,verticalPadding:l}){const i=e.getContext("2d");i.clearRect(0,0,e.width,e.height),i.font=r,i.fillStyle=a,i.textBaseline="top";const c=n*1.3,f=e.width-s*2,{lines:m,y:h}=Cr(i,t,s,l,f,c);if(o&&m.length){const v=m[m.length-1],d=i.measureText(v),p=s+d.width+4,x=d.actualBoundingBoxAscent+d.actualBoundingBoxDescent||n;u==="underscore"?i.fillRect(p,h+n*1.05,n*.8,3):u==="line"?i.fillRect(p,h+2,Math.max(4,n*.08),x):i.fillRect(p,h+2,n*.6,x)}}function Rr(){const e=document.createElement("canvas");e.width=1024,e.height=512;const t=new Ke(e);return t.minFilter=Q,t.magFilter=Q,t.wrapS=me,t.wrapT=me,{canvas:e,texture:t}}const Ut={screenText:`12:00 FEB. 28, 1986\r
...
`,Br=xe({uScene:null,uFeedback:null,uTime:0,uDecay:.85,uZoom:1.01,uWarp:.6,uStaticAmount:.04,uScanlineStrength:.4,uCurvature:.12,uVignette:.85},Er,Fr);ee({CrtAccumMaterial:Br});function jr({resolution:e=1024,decay:t=.85,zoom:r=1.01,warp:n=.6,staticAmount:a=.04,scanlineStrength:o=.4,curvature:u=.12,vignette:s=.85,side:l=K}){const i=y.useRef(),{gl:c,scene:f,camera:m}=pe(),h=y.useMemo(()=>new _e(e,e),[e]),v=y.useMemo(()=>new _e(e,e),[e]),d=y.useMemo(()=>new _e(e,e),[e]),p=y.useRef(!1);return G((x,S)=>{if(!i.current)return;i.current.uTime+=S;const R=c.getRenderTarget();c.setRenderTarget(h),c.clear(),c.render(f,m);const w=p.current?v:d,T=p.current?d:v;i.current.uScene=h.texture,i.current.uFeedback=w.texture,c.setRenderTarget(T),c.clear(),c.render(f,m),c.setRenderTarget(R),p.current=!p.current,i.current.uFeedback=T.texture}),C.jsx("crtAccumMaterial",{ref:i,side:l,uDecay:t,uZoom:r,uWarp:n,uStaticAmount:a,uScanlineStrength:o,uCurvature:u,uVignette:s,toneMapped:!1})}const Pr=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,_r=xe({uMap:null,uTime:0,uStaticAmount:.1,uStaticScale:600,uStaticSpeed:6,uScanlineStrength:.4,uCurvature:.12,uVignette:.85,uChromaDrift:.25,uBloom:.25},Pr,Or);ee({CrtSceneShaderMaterial:_r});function Ar({scene:e,resolution:t=1024,staticAmount:r=.12,staticScale:n=600,staticSpeed:a=6,scanlineStrength:o=.4,curvature:u=.12,vignette:s=.85,chromaDrift:l=.25,bloom:i=.25,side:c=K}){const f=y.useRef();return G((m,h)=>{f.current&&(f.current.uTime+=h)}),C.jsx("crtSceneShaderMaterial",{ref:f,side:c,uStaticAmount:r,uStaticScale:n,uStaticSpeed:a,uScanlineStrength:o,uCurvature:u,uVignette:s,uChromaDrift:l,uBloom:i,toneMapped:!1,children:C.jsx(br,{attach:"uMap",frames:1/0,width:t,height:t,anisotropy:8,children:e})})}const Dr=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,It=xe({uTime:0,uTexture:null,uStaticAmount:0,uStaticScale:0,uStaticSpeed:0,uSnap:0,uGlitchRate:0,uScanlineStrength:0,uColorBleed:0,uCurvature:0,uVignette:0,uMaskStrength:0,uFlyback:0,uConverge:0,uBloom:0,uBreath:0,uRetrace:0,uBeamWidth:0,uChromaDrift:0,uHum:0,uThermalDrift:0,uSpotNoise:0,uMaskMode:0,uBarrelConverge:0,uPadX:0,uPadY:0},Dr,Ur);ee({CrtShowMaterial:It});function at({src:e=_t("ren_and_stimpy.mp4"),useWebcam:t=!1,padX:r=.06,padY:n=.08,staticAmount:a=.35,staticScale:o=700,staticSpeed:u=9,snap:s=24,glitchRate:l=.18,scanlineStrength:i=.55,colorBleed:c=.14,curvature:f=.12,vignette:m=.75,maskStrength:h=.35,flybackStrength:v=.35,convergenceDrift:d=.4,bloomStrength:p=.25,breathStrength:x=.35,retraceStrength:S=.35,beamWidth:R=.5,chromaDrift:w=.3,humStrength:T=.25,barrelConvergence:k=.6,spotNoise:g=.35,thermalDrift:b=.15,maskMode:E=0,side:B=K}){const D=y.useRef();return y.useEffect(()=>{if(!D.current)return;let j=null,z=!1;const P=document.createElement("video");P.crossOrigin="anonymous",P.loop=!0,P.muted=!0,P.playsInline=!0,P.autoplay=!0;const O=()=>{if(z)return;const A=new At(P);A.colorSpace=qe,A.minFilter=Q,A.magFilter=Q,A.generateMipmaps=!1,D.current.uTexture=A},U=async()=>{try{P.src=e,await P.play(),O()}catch(A){console.error("[CRTShowMaterial] Video failed to play:",A)}};return t?(async()=>{try{const A=navigator,q=A.mediaDevices?.getUserMedia||A.getUserMedia||A.webkitGetUserMedia||A.mozGetUserMedia;if(!q)throw new Error("getUserMedia not supported on this device");A.mediaDevices?.getUserMedia?j=await A.mediaDevices.getUserMedia({video:{facingMode:"user"},audio:!1}):j=await new Promise((Oe,Z)=>{q.call(A,{video:!0,audio:!1},Oe,Z)}),P.srcObject=j,await P.play(),O()}catch(A){console.warn("[CRTShowMaterial] Webcam failed, falling back to video:",A),U()}})():U(),()=>{z=!0,j&&j.getTracks().forEach(A=>A.stop()),D.current?.uTexture&&D.current.uTexture.dispose(),P.pause(),P.remove()}},[e,t]),G((j,z)=>{D.current&&(D.current.uTime+=z)}),C.jsx("crtShowMaterial",{ref:D,side:B,toneMapped:!1,uPadX:r,uPadY:n,uStaticAmount:a,uStaticScale:o,uStaticSpeed:u,uSnap:s,uGlitchRate:l,uScanlineStrength:i,uColorBleed:c,uCurvature:f,uVignette:m,uMaskStrength:h,uFlyback:v,uConverge:d,uBloom:p,uBreath:x,uRetrace:S,uBeamWidth:R,uChromaDrift:w,uHum:T,uThermalDrift:b,uSpotNoise:g,uMaskMode:E,uBarrelConverge:k},It.key)}const Nr=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
