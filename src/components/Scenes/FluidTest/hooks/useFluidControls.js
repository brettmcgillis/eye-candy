...
function copySettingsToClipboard(get) {
  const settings = {
    ...
    stationarySplatRate: get('Fluid.Interaction.stationarySplatRate'),
    stationarySplatBurst: get('Fluid.Interaction.stationarySplatBurst'),
      ...
      Interaction: folder(
        {
          ...
          stationarySplatRate: {
            value: FLUID_PRESETS.default.stationarySplatRate,
            min: 0,
            max: 30,
            step: 0.25,
          },
          stationarySplatBurst: {
            value: FLUID_PRESETS.default.stationarySplatBurst,
            min: 1,
            max: 8,
            step: 1,
          },
