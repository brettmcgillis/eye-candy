import{r as f,V as u,b as Ae,Q as De,a0 as Ze,f as F,a as Le,j as p,E as st,L as nt,y as Ke,a9 as ot,aT as me,c$ as Ce,S as lt,m as re,aL as Je,F as ct,aq as Qe,B as ft,aO as ut,G as dt,d0 as N,bd as ve,H as ke,Y as pt,U as $,bg as ee,d as xe,aF as ht,a3 as mt,az as O}from"./index-CmsPVbmj.js";import{c as $e,R as et,d as vt,i as Be,e as Me,P as xt}from"./react-three-rapier.esm-CdsMevcN.js";import{u as tt}from"./Gltf-CwuXXnr2.js";import{bu as k,bv as se,u as o,d as gt,t as C,av as ie,F as yt,j as wt,m as Oe,f as te,s as bt,aA as H,bw as h,aC as B,bx as ce,by as fe,ay as ge}from"./three.tsl-VQrHxgdf.js";import{P as zt}from"./PerspectiveCamera-CziDtd3b.js";import{O as St}from"./OrbitControls-BNbCWcP8.js";import"./constants-FtBkotmJ.js";import"./extends-CF3RwP-h.js";import"./Fbo-Dz6sKFHX.js";const Te=0,Dt=1,Re=new u(0,1,0);function Fe(t,e){const a=t.clone();return a.scale(e,e,e),a.computeBoundingBox(),a}function ye(t,e){const a=t.clone();return a.translate(e.x,e.y,e.z),a.computeBoundingBox(),a}function we(t){const e=new u;return t.computeBoundingBox(),t.boundingBox.getCenter(e),e}function je(t,e,a){const r=a.clone().applyAxisAngle(Re,F.degToRad(e));return[t[0]+r.x,t[1]+r.y,t[2]+r.z]}function Ee(t,e){const{min:a,max:r}=t.boundingBox,i=(a.y+r.y)*.5;return[new u(a.x,i,(a.z+r.z)*.5),new u(r.x,i,(a.z+r.z)*.5),new u((a.x+r.x)*.5,i,a.z),new u((a.x+r.x)*.5,i,r.z)].reduce((l,n)=>n.distanceToSquared(e)>l.distanceToSquared(e)?n:l)}function We({bodyRef:t,geometry:e,material:a,oars:r,onBodyReady:i,physics:s,position:l,probePoint:n,rotationY:c,sampleHeight:d}){const b=t,z=f.useRef(new u),m=f.useRef(new u),g=f.useRef(new u),y=f.useRef(new u),v=f.useRef(),j=f.useRef(new u),R=f.useRef(new u),X=f.useRef(new u),S=f.useMemo(()=>[0,F.degToRad(c),0],[c]);return $e(()=>{const D=t.current;if(!D||!v.current)return;D.resetForces(!1),D.resetTorques(!1);const x=X.current,K=z.current,E=m.current,Y=Math.max(.001,Math.abs(s.gravity[1])),W=g.current,G=y.current,_=j.current,A=R.current,L=D.angvel(),w=D.translation(),I=D.linvel();x.copy(n),v.current.localToWorld(x),K.set(w.x,w.y,w.z),W.set(I.x,I.y,I.z),G.set(L.x,L.y,L.z),_.copy(x).sub(K),A.copy(G).cross(_).add(W);const V=d(x.x,x.z)+r.probeLift-x.y;if(V<=0)return;const Z=Math.max(0,Math.min(V,r.maxSubmersion)*r.buoyancy*s.oarMass*Y-A.y*r.buoyancyDamping*s.oarMass);E.set(0,Z,0),D.addForceAtPoint(E,x,!0)}),p.jsx(et,{ref:D=>{b.current=D,i?.(D)},angularDamping:r.angularDamping,canSleep:!1,collisionGroups:Be(Dt,[]),colliders:"hull",linearDamping:r.linearDamping,mass:s.oarMass,position:l,rotation:S,type:"dynamic",children:p.jsx("mesh",{ref:v,castShadow:!0,geometry:e,material:a})})}function Bt({asset:t,boat:e,geometries:a,hullColliderRef:r,hullRef:i,materials:s,onBodyReady:l,physics:n,sampleHeight:c}){const d=i,b=f.useRef(new u),z=f.useRef(new u),m=f.useRef(new De),g=f.useRef(new u),y=f.useRef(new u),v=f.useRef(!0),j=f.useRef(new u),R=f.useRef(new u),X=f.useRef([new u,new u,new u,new u]),S=f.useRef([new u,new u,new u,new u]),D=f.useMemo(()=>[a.hull.attributes.position.array],[a.hull]);return f.useEffect(()=>{v.current=!0},[e.rotationY,e.startPosition]),$e(()=>{const x=i.current;if(!x)return;if(v.current){const P=r.current;P&&Math.abs(x.mass()-e.mass)>=.01&&(P.setMass(e.mass),x.recomputeMassPropertiesFromColliders()),x.setTranslation({x:e.startPosition[0],y:e.startPosition[1],z:e.startPosition[2]},!1),x.setRotation(new De().setFromEuler(new st(0,F.degToRad(e.rotationY),0)),!1),x.setLinvel({x:0,y:0,z:0},!1),x.setAngvel({x:0,y:0,z:0},!1),v.current=!1;return}x.resetForces(!1),x.resetTorques(!1);const K=Math.max(.001,Math.abs(n.gravity[1])),E=Math.min(e.probeForward,t.maxProbeForward),Y=Math.min(e.probeSide,t.maxProbeSide),W=x.mass(),G=z.current,_=m.current,A=g.current,L=y.current,w=b.current,I=X.current,ne=S.current,V=j.current,Z=R.current,U=I.length,q=x.angvel(),J=x.rotation(),oe=x.translation(),Q=x.linvel();G.set(oe.x,oe.y,oe.z),_.set(J.x,J.y,J.z,J.w),L.set(Q.x,Q.y,Q.z),w.set(q.x,q.y,q.z),I[0].set(-Y,t.probeY,E),I[1].set(Y,t.probeY,E),I[2].set(-Y,t.probeY,-E),I[3].set(Y,t.probeY,-E);for(let P=0;P<U;P+=1){const M=ne[P];M.copy(I[P]).applyQuaternion(_).add(G);const le=c(M.x,M.z)+e.draft+e.probeLift-M.y;if(le>0){V.copy(M).sub(G),Z.copy(w).cross(V).add(L);const he=Math.max(0,Math.min(le,t.maxSubmersion)*e.buoyancy*(W/U)*K-Z.y*e.buoyancyDamping*(W/U));A.set(0,he,0),x.addForceAtPoint(A,M,!0)}}}),p.jsxs(et,{ref:x=>{d.current=x,l?.(x)},angularDamping:e.angularDamping,canSleep:!1,collisionGroups:Be(Te,[]),colliders:!1,linearDamping:e.linearDamping,position:e.startPosition,rotation:[0,F.degToRad(e.rotationY),0],type:"dynamic",children:[p.jsx(vt,{args:D,collisionGroups:Be(Te,[]),ref:r}),p.jsx("mesh",{castShadow:!0,geometry:a.hull,material:s.rowboat_1}),p.jsx("mesh",{castShadow:!0,geometry:a.frontBench,material:s.rowboat_2}),p.jsx("mesh",{castShadow:!0,geometry:a.middleBench,material:s.rowboat_2}),p.jsx("mesh",{castShadow:!0,geometry:a.rearBench,material:s.rowboat_2}),p.jsx("mesh",{castShadow:!0,geometry:a.horizontalSupports,material:s.rowboat_1}),p.jsx("mesh",{castShadow:!0,geometry:a.supports,material:s.rowboat_1}),p.jsx("mesh",{castShadow:!0,geometry:a.upperEdge,material:s.rowboat_2}),p.jsx("mesh",{castShadow:!0,geometry:a.leftLock,material:s.rowboat_2}),p.jsx("mesh",{castShadow:!0,geometry:a.rightLock,material:s.rowboat_2})]})}function Rt({asset:t,hullRef:e,leftJointLimits:a,leftOarRef:r,rightJointLimits:i,rightOarRef:s}){return Me(e,r,[t.leftAnchor.toArray(),[0,0,0],Re.toArray(),a]),Me(e,s,[t.rightAnchor.toArray(),[0,0,0],Re.toArray(),i]),null}function Pt({boat:t,oars:e,physics:a,runtimeRef:r,sampler:i}){const s=f.useRef(),l=f.useRef(),n=f.useRef(),c=f.useRef(),[d,b]=f.useState(!1),z=f.useRef(new u),m=f.useRef(new Ae),g=f.useRef(new u),y=f.useRef(new De),v=f.useRef(new u(1,1,1)),{materials:j,nodes:R}=tt(Ze("/rowboat.glb")),X=f.useCallback((_,A)=>i?i.sampleSurfaceHeight(_,A,z.current):0,[i]),S=f.useMemo(()=>{const _=Fe(R.hull_mesh.geometry,t.scale),L=we(_).clone().multiplyScalar(-1),w=he=>ye(Fe(he,t.scale),L),I=w(R.left_oar_lock_mesh.geometry),ne=w(R.right_oar_lock_mesh.geometry),V=w(R.left_oar_mesh.geometry),Z=w(R.right_oar_mesh.geometry),U=we(I),q=we(ne),J=Ee(V,U).sub(U),oe=Ee(Z,q).sub(q),Q={frontBench:w(R.front_bench_mesh.geometry),horizontalSupports:w(R.horizontal_support_strips_mesh.geometry),hull:w(R.hull_mesh.geometry),leftLock:I,leftOar:ye(V,U.clone().multiplyScalar(-1)),middleBench:w(R.middle_bench_mesh.geometry),rearBench:w(R.rear_bench_mesh.geometry),rightLock:ne,rightOar:ye(Z,q.clone().multiplyScalar(-1)),supports:w(R.support_strips_mesh.geometry),upperEdge:w(R.upper_edge_mesh.geometry)},P=Q.hull.boundingBox,M=P.max.y-P.min.y,pe=P.max.z-P.min.z,le=P.max.x-P.min.x;return{geometries:Q,hullDepth:pe,hullHeight:M,hullWidth:le,leftAnchor:U,leftProbe:J,maxProbeForward:pe*.46,maxProbeSide:le*.42,maxSubmersion:M*.7,probeY:P.min.y+M*.08,restYOffset:-(P.min.y+M*.31),rightAnchor:q,rightProbe:oe}},[t.scale,R]),D=f.useMemo(()=>[t.position[0],t.position[1]+S.restYOffset,t.position[2]],[S.restYOffset,t.position]),x=f.useMemo(()=>je(D,t.rotationY,S.leftAnchor),[S.leftAnchor,t.rotationY,D]),K=f.useMemo(()=>je(D,t.rotationY,S.rightAnchor),[S.rightAnchor,t.rotationY,D]),E=f.useMemo(()=>[-F.degToRad(e.jointMaxAngle),-F.degToRad(e.jointMinAngle)],[e.jointMaxAngle,e.jointMinAngle]),Y=f.useMemo(()=>[F.degToRad(e.jointMinAngle),F.degToRad(e.jointMaxAngle)],[e.jointMaxAngle,e.jointMinAngle]),W=f.useCallback(()=>{b(!!(l.current&&n.current&&c.current))},[]),G=f.useMemo(()=>({...e,maxSubmersion:S.hullHeight*.5}),[S.hullHeight,e]);return Le(()=>{const _=r?.current?.oceanManager?.hullMask;if(!_)return;const A=l.current;if(!A||!t.hideInteriorWater){_.enabled.value=0;return}const L=A.translation(),w=A.rotation();g.current.set(L.x,L.y,L.z),y.current.set(w.x,w.y,w.z,w.w),m.current.compose(g.current,y.current,v.current).invert(),_.inverse.value.copy(m.current),_.extents.value.set(S.hullWidth*.5*t.interiorInset,S.hullDepth*.5*t.interiorInset),_.enabled.value=1}),p.jsxs(p.Fragment,{children:[p.jsx(Bt,{asset:S,boat:{...t,startPosition:D},geometries:S.geometries,hullColliderRef:s,hullRef:l,materials:j,onBodyReady:W,physics:a,sampleHeight:X}),p.jsx(We,{bodyRef:n,geometry:S.geometries.leftOar,material:j.rowboat_2,oars:G,onBodyReady:W,physics:a,position:x,probePoint:S.leftProbe,rotationY:t.rotationY,sampleHeight:X}),p.jsx(We,{bodyRef:c,geometry:S.geometries.rightOar,material:j.rowboat_2,oars:G,onBodyReady:W,physics:a,position:K,probePoint:S.rightProbe,rotationY:t.rotationY,sampleHeight:X}),d?p.jsx(Rt,{asset:S,hullRef:l,leftJointLimits:E,leftOarRef:n,rightJointLimits:Y,rightOarRef:c}):null]})}tt.preload(Ze("/rowboat.glb"));const _t=60;function It({lighting:t,runtimeRef:e}){const a=f.useRef();return Le(()=>{const r=e?.current?.oceanManager?.sun;!r||!a.current||a.current.position.copy(r).multiplyScalar(_t)}),p.jsxs(p.Fragment,{children:[p.jsx("hemisphereLight",{args:[t.skyColor,t.groundColor,t.hemisphere]}),p.jsx("directionalLight",{castShadow:!0,color:t.sunColor,intensity:t.sun,ref:a,"shadow-camera-bottom":-10,"shadow-camera-far":200,"shadow-camera-left":-10,"shadow-camera-right":10,"shadow-camera-top":10,"shadow-mapSize-height":1024,"shadow-mapSize-width":1024})]})}class At{constructor(e){this.params=e,this.init(e)}destroy(){this.params.group.remove(this.mesh),this.geometry.dispose()}hide(){this.mesh.visible=!1}show(){this.mesh.visible=!0}init(e){this.geometry=new nt,this.mesh=new Ke(this.geometry,e.material);const a=new u(e.offset.x,e.offset.y);a.applyMatrix4(e.transform),this.geometry.boundingSphere=new ot(a,e.lod>3?e.width*1.75:e.width*3),this.mesh.castShadow=!1,this.mesh.layers.set(e.layer),this.mesh.receiveShadow=!0,e.group.add(this.mesh)}rebuildMeshFromData(e){this.geometry.setAttribute("position",new me(e.positions,3)),this.geometry.setAttribute("normal",new me(e.normals,3)),this.geometry.setAttribute("vindex",new Ce(e.vindices,1)),this.geometry.setAttribute("width",new me(e.width,1)),this.geometry.setAttribute("lod",new Ce(e.lod,1)),this.geometry.setIndex(new lt(e.indices,1)),this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.normal.needsUpdate=!0,this.geometry.attributes.vindex.needsUpdate=!0,this.geometry.attributes.width.needsUpdate=!0,this.geometry.attributes.lod.needsUpdate=!0}}const ae=new u,Ge=new u,be=new u,Ne=new u,T=new u,He=new u;function Lt(t){const e=[];for(let a=0;a<t;a+=1)for(let r=0;r<t;r+=1)e.push(a*(t+1)+r,(a+1)*(t+1)+r+1,a*(t+1)+r+1),e.push((a+1)*(t+1)+r,(a+1)*(t+1)+r+1,a*(t+1)+r);return e}function Ct(t,e){const a=new Array(t.length).fill(0);for(let r=0;r<e.length;r+=3){const i=e[r]*3,s=e[r+1]*3,l=e[r+2]*3;Ge.fromArray(t,i),be.fromArray(t,s),Ne.fromArray(t,l),T.subVectors(Ne,be),He.subVectors(Ge,be),T.cross(He),a[i]+=T.x,a[s]+=T.x,a[l]+=T.x,a[i+1]+=T.y,a[s+1]+=T.y,a[l+1]+=T.y,a[i+2]+=T.z,a[s+2]+=T.z,a[l+2]+=T.z}return a}function kt({lod:t,offset:e,resolution:a,width:r,worldMatrix:i}){const s=[],l=[],n=[],c=[],d=r/2;let b=0;for(let g=0;g<=a;g+=1){const y=r*g/a;for(let v=0;v<=a;v+=1){const j=r*v/a;ae.set(y-d,j-d,0),ae.add(e),ae.applyMatrix4(i),s.push(ae.x,ae.y,ae.z),l.push(b),n.push(r),c.push(t),b+=1}}const z=Lt(a),m=Ct(s,z);return{indices:Uint32Array.from(z),lod:Uint32Array.from(c),normals:Float32Array.from(m),positions:Float32Array.from(s),vindices:Uint32Array.from(l),width:Float32Array.from(n)}}const Mt=15,Ot=36,Pe=se("vec3","rowItAloneDisplacedPosition"),at=se("vec3","rowItAloneMorphedPosition"),rt=se("vec3","rowItAloneCascadeScales"),Tt=se("vec2","rowItAloneTexelCoord0"),Ft=se("vec2","rowItAloneTexelCoord1"),jt=se("vec2","rowItAloneTexelCoord2"),Et=k(`
...
`);class Ht extends Ke{constructor(){const e={position:ie("position"),normal:ie("normal"),turbidity:o(10),rayleigh:o(3),mieCoefficient:o(.005),mieDirectionalG:o(.7),elevation:o(2),sunPosition:o(new u(0,0,0)),up:o(new u(0,1,0)),cameraPosition:o(new u(0,0,0))},a=new Je;a.colorNode=Nt(e),a.side=ft,a.colorSpace=Qe,super(new ut(1,1,1),a),this.parameters=e}}const Ye=new u,Ve=new u,ze=new u,Se=new u,Yt=160,it=192,Vt=2;function Ut(t={}){return{patchResolution:Math.max(Vt,Math.round(t.patchResolution??it)),patchSize:t.patchSize??Yt}}class qt{constructor(e){this.params=e,this.currentConfig=null,this.patch=null,this.patchSignature="",this.patchTransform=new Ae().makeRotationX(-Math.PI/2),this.sun=new u}init(){const e=new Gt({foamStrength:this.params.waveGenerator.foamStrength,foamThreshold:this.params.waveGenerator.foamThreshold,ifftResolution:this.params.waveGenerator.size,gridResolution:it,lodScale:this.params.waveGenerator.lodScale,morphBlend:0,cascades:this.params.waveGenerator.cascades,sunPosition:this.sun});this.material=e.material,this.materialParameters=e.parameters,this.hullMask=e.hullMask,this.group=new dt,this.params.scene.add(this.group),this.sky=new Ht,this.sky.layers.set(2),this.sky.scale.setScalar(5e5),this.params.scene.add(this.sky),this.ensurePatch()}ensurePatch(e){const{patchResolution:a,patchSize:r}=Ut(e),i=`${r}:${a}`;this.patchSignature!==i&&(this.patch?.destroy(),ze.set(0,0,0),this.patch=new At({group:this.group,layer:this.params.layer,lod:0,material:this.material,offset:ze.clone(),transform:this.patchTransform,width:r}),this.patch.rebuildMeshFromData(kt({lod:0,offset:ze,resolution:a,width:r,worldMatrix:this.patchTransform})),this.patch.show(),this.materialParameters.gridResolution.value=a,this.patchSignature=i)}applyConfig(e){if(this.currentConfig=e,!e)return;this.ensurePatch(e.ocean),this.material.wireframe=e.ocean.wireframe,this.params.waveGenerator.setFoamStrength(e.foam.foamStrength),this.params.waveGenerator.setFoamThreshold(e.foam.foamThreshold),this.params.waveGenerator.setLodScale(e.ocean.lodScale),this.sky.parameters.rayleigh.value=e.sky.rayleigh,this.sky.parameters.turbidity.value=e.sky.turbidity,this.sky.parameters.mieCoefficient.value=e.sky.mieCoefficient,this.sky.parameters.mieDirectionalG.value=e.sky.mieDirectionalG,this.sky.parameters.elevation.value=e.sky.elevation,this.sky.parameters.up.value.fromArray(e.sky.up);const a=F.degToRad(90-e.sky.elevation),r=F.degToRad(e.sky.azimuth);this.sun.setFromSphericalCoords(1,a,r),this.sky.parameters.sunPosition.value.copy(this.sun),typeof e.sky.exposure=="number"&&(this.params.renderer.toneMappingExposure=e.sky.exposure)}update(e=this.params.camera){this.params.camera=e,this.params.camera.getWorldPosition(Ye),this.params.scene.getWorldPosition(Ve),Se.subVectors(Ye,Ve),this.sky.parameters.cameraPosition.value.copy(Se),this.patch&&(this.patch.show(),this.patch.mesh.material.wireframe=this.currentConfig?.ocean?.wireframe??!1),this.materialParameters.cameraPosition.value.copy(Se),this.materialParameters.sunPosition.value.copy(this.sun)}dispose(){this.patch?.destroy(),this.patch=null,this.patchSignature="",this.params.scene.remove(this.group),this.params.scene.remove(this.sky),this.material.dispose(),this.sky.geometry.dispose(),this.sky.material.dispose()}}const Xt=192;class Ue{constructor({modeCount:e=Xt}={}){this.modeCount=e,this.ready=!1,this.time=0,this.lambda=1,this.count=0}async load({cascade:e,renderer:a}){const r=new Float32Array(await a.getArrayBufferAsync(e.spectrumBuffer)),i=new Float32Array(await a.getArrayBufferAsync(e.waveDataBuffer)),s=Math.min(r.length,i.length)/4,l=[];for(let c=0;c<s;c+=1){const d=c*4,b=i[d+3],z=r[d],m=r[d+1],g=r[d+2],y=r[d+3],v=z*z+m*m+g*g+y*y;b!==0&&v>0&&l.push({energy:v,index:c})}l.sort((c,d)=>d.energy-c.energy);const n=Math.min(this.modeCount,l.length);this.count=n,this.kx=new Float32Array(n),this.kz=new Float32Array(n),this.invK=new Float32Array(n),this.omega=new Float32Array(n),this.h0pr=new Float32Array(n),this.h0pi=new Float32Array(n),this.h0mr=new Float32Array(n),this.h0mi=new Float32Array(n),this.hr=new Float32Array(n),this.hi=new Float32Array(n);for(let c=0;c<n;c+=1){const d=l[c].index*4;this.kx[c]=i[d],this.invK[c]=i[d+1],this.kz[c]=i[d+2],this.omega[c]=i[d+3],this.h0pr[c]=r[d],this.h0pi[c]=r[d+1],this.h0mr[c]=r[d+2],this.h0mi[c]=r[d+3]}return this.lambda=e.params.lambda,this.ready=!0,this.setTime(this.time),this}setTime(e){if(this.time=e,!!this.ready)for(let a=0;a<this.count;a+=1){const r=this.omega[a]*e,i=Math.cos(r),s=Math.sin(r);this.hr[a]=this.h0pr[a]*i-this.h0pi[a]*s+this.h0mr[a]*i+this.h0mi[a]*s,this.hi[a]=this.h0pr[a]*s+this.h0pi[a]*i-this.h0mr[a]*s+this.h0mi[a]*i}}sampleHeight(e,a){if(!this.ready)return 0;let r=0;for(let i=0;i<this.count;i+=1){const s=this.kx[i]*e+this.kz[i]*a;r+=this.hr[i]*Math.cos(s)-this.hi[i]*Math.sin(s)}return r}sampleDisplacement(e,a,r){if(!this.ready)return r.set(0,0,0);let i=0,s=0,l=0;for(let n=0;n<this.count;n+=1){const c=this.kx[n]*e+this.kz[n]*a,d=Math.cos(c),b=Math.sin(c),z=this.hr[n]*d-this.hi[n]*b,g=-(this.hr[n]*b+this.hi[n]*d)*this.invK[n];i+=g*this.kx[n],s+=z,l+=g*this.kz[n]}return r.set(i*this.lambda,s,l*this.lambda)}sampleNormal(e,a,r,i=.35){const s=this.sampleHeight(e-i,a),l=this.sampleHeight(e+i,a),n=this.sampleHeight(e,a-i),c=this.sampleHeight(e,a+i);return r.set(s-l,i*2,n-c).normalize()}sampleSurfaceHeight(e,a,r,i=2){if(!this.ready)return 0;let s=e,l=a;for(let n=0;n<i;n+=1)this.sampleDisplacement(s,l,r),s=e-r.x,l=a-r.z;return this.sampleDisplacement(s,l,r),r.y}dispose(){this.ready=!1,this.count=0}}const Zt=k(`
...
`);class ia{constructor(e){this.params=e,this.init(e)}init(e){this.squareSize=e.size**2,this.bufferSize=this.squareSize*4,this.spectrumBuffer=new N(new Float32Array(this.bufferSize),4),this.waveDataBuffer=new N(new Float32Array(this.bufferSize),4),this.initialSpectrum=aa({spectrumBuffer:h(this.spectrumBuffer,"vec4",this.spectrumBuffer.count),waveDataBuffer:h(this.waveDataBuffer,"vec4",this.waveDataBuffer.count),index:H,size:e.size,waveLength:o(e.lengthScale),boundaryLow:o(e.boundaryLow),boundaryHigh:o(e.boundaryHigh),...e.waveSettings}).compute(this.squareSize),this.initialSpectrumWithInverse=ra({spectrumBuffer:h(this.spectrumBuffer,"vec4",this.spectrumBuffer.count),index:H,size:e.size}).compute(this.squareSize),e.renderer.compute(this.initialSpectrum),e.renderer.compute(this.initialSpectrumWithInverse)}update(){this.params.renderer.compute(this.initialSpectrum),this.params.renderer.compute(this.initialSpectrumWithInverse)}dispose(){this.spectrumBuffer?.dispose?.(),this.waveDataBuffer?.dispose?.()}}const sa=[16,16,1],na=[250,17,5],oa=[.9,.9,.9],de=Object.freeze({Low:Object.freeze({resolution:128}),Medium:Object.freeze({resolution:256}),High:Object.freeze({resolution:512})}),ue="Medium";de[ue].resolution;const la=o(.8),ca=o(2.7),fa=o(3.7);function ua(t=ue){return de[t]||de[ue]}const _e={depth:o(20),scaleHeight:o(1),windSpeed:o(1),windDirection:o(0),fetch:o(1e5),spreadBlend:o(1),swell:o(.198),peakEnhancement:o(3.3),shortWaveFade:o(0),fadeLimit:o(0)},da={depth:{min:.1,max:100},scaleHeight:{min:0,max:1},windSpeed:{min:.01,max:10},windDirection:{min:0,max:2*Math.PI},fetch:{min:10,max:5e5},spreadBlend:{min:0,max:1},swell:{min:0,max:1},peakEnhancement:{min:1,max:5},shortWaveFade:{min:0,max:5},fadeLimit:{min:0,max:1}},Ie={d_depth:o(20),d_scaleHeight:o(1),d_windSpeed:o(1),d_windDirection:o(240/360*2*Math.PI),d_fetch:o(3e5),d_spreadBlend:o(1),d_swell:o(.5),d_peakEnhancement:o(3.3),d_shortWaveFade:o(0),d_fadeLimit:o(0)},pa={d_depth:{min:.1,max:100},d_scaleHeight:{min:0,max:1},d_windSpeed:{min:.01,max:10},d_windDirection:{min:0,max:2*Math.PI},d_fetch:{min:10,max:5e5},d_spreadBlend:{min:0,max:1},d_swell:{min:0,max:1},d_peakEnhancement:{min:1,max:5},d_shortWaveFade:{min:0,max:5},d_fadeLimit:{min:0,max:1}};class ha{constructor(e){this.init(e)}init(e){this.params=e,this.logN=Math.log2(e.size),this.squareSize=e.size**2,this.bufferSize=this.squareSize*2,this.initialSpectrum=new ia(e),this.spectrumBuffer=this.initialSpectrum.spectrumBuffer,this.waveDataBuffer=this.initialSpectrum.waveDataBuffer,this.dxDzBuffer=new N(new Float32Array(this.bufferSize),2),this.dyDxzBuffer=new N(new Float32Array(this.bufferSize),2),this.dyxDyzBuffer=new N(new Float32Array(this.bufferSize),2),this.dxxDzzBuffer=new N(new Float32Array(this.bufferSize),2),this.pingpongBuffer=new N(new Float32Array(this.bufferSize*2),4),this.turbulenceBuffer=new N(new Float32Array(this.bufferSize/2),1),this.displacementIndex=o(0),this.ifftStep=o(0),this.pingpong=o(0),this.deltaTime=o(0),this.displacement=new ve(e.size,e.size),this.derivative=new ve(e.size,e.size),this.jacobian=new ve(e.size,e.size),this.displacement.type=ke,this.derivative.type=ke,this.jacobian.type=pt,this.displacement.generateMipmaps=!1,this.derivative.generateMipmaps=!1,this.jacobian.generateMipmaps=!1,this.displacement.magFilter=$,this.derivative.magFilter=$,this.jacobian.magFilter=$,this.displacement.minFilter=$,this.derivative.minFilter=$,this.jacobian.minFilter=$,this.displacement.wrapS=ee,this.displacement.wrapT=ee,this.derivative.wrapS=ee,this.derivative.wrapT=ee,this.jacobian.wrapS=ee,this.jacobian.wrapT=ee,this.workgroupSize=sa,this.dispatchSize=[e.size/this.workgroupSize[0],e.size/this.workgroupSize[1]],this.computeTimeSpectrum=Kt({writeDxDzBuffer:h(this.dxDzBuffer,"vec2",this.dxDzBuffer.count),writeDyDxzBuffer:h(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count),writeDyxDyzBuffer:h(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count),writeDxxDzzBuffer:h(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count),spectrumBuffer:h(this.spectrumBuffer,"vec4",this.spectrumBuffer.count),waveDataBuffer:h(this.waveDataBuffer,"vec4",this.waveDataBuffer.count),index:H,size:B(e.size),time:o(0)}).computeKernel(this.workgroupSize),this.computeInitialize=$t({size:B(e.size),step:B(this.ifftStep),logN:B(this.logN),butterflyBuffer:h(e.butterflyBuffer,"vec4",e.butterflyBuffer.count).toReadOnly(),DxDzBuffer:h(this.dxDzBuffer,"vec2",this.dxDzBuffer.count).toReadOnly(),DyDxzBuffer:h(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count).toReadOnly(),DyxDyzBuffer:h(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count).toReadOnly(),DxxDzzBuffer:h(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count).toReadOnly(),pingpongBuffer:h(this.pingpongBuffer,"vec4",this.pingpongBuffer.count),initBufferIndex:B(this.displacementIndex),index:H,workgroupSize:o(new re().fromArray(this.workgroupSize)),workgroupId:fe,localId:ce}).computeKernel(this.workgroupSize),this.computeHorizontalPingPong=Jt({size:B(e.size),step:B(this.ifftStep),logN:B(this.logN),butterflyBuffer:h(e.butterflyBuffer,"vec4",e.butterflyBuffer.count).toReadOnly(),pingpongBuffer:h(this.pingpongBuffer,"vec4",this.pingpongBuffer.count),initBufferIndex:B(this.displacementIndex),pingpong:B(this.pingpong),index:H,workgroupSize:o(new re().fromArray(this.workgroupSize)),workgroupId:fe,localId:ce}).computeKernel(this.workgroupSize),this.computeVerticalPingPong=Qt({size:B(e.size),step:B(this.ifftStep),logN:B(this.logN),butterflyBuffer:h(e.butterflyBuffer,"vec4",e.butterflyBuffer.count).toReadOnly(),pingpongBuffer:h(this.pingpongBuffer,"vec4",this.pingpongBuffer.count),initBufferIndex:B(this.displacementIndex),pingpong:B(this.pingpong),index:H,workgroupSize:o(new re().fromArray(this.workgroupSize)),workgroupId:fe,localId:ce}).computeKernel(this.workgroupSize),this.computePermute=ea({size:B(e.size),pingpongBuffer:h(this.pingpongBuffer,"vec4",this.pingpongBuffer.count).toReadOnly(),DxDzBuffer:h(this.dxDzBuffer,"vec2",this.dxDzBuffer.count),DyDxzBuffer:h(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count),DyxDyzBuffer:h(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count),DxxDzzBuffer:h(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count),initBufferIndex:B(this.displacementIndex),index:H,workgroupSize:o(new re().fromArray(this.workgroupSize)),workgroupId:fe,localId:ce}).computeKernel(this.workgroupSize),this.computeMergeTextures=ta({size:B(e.size),index:H,lambda:o(e.lambda),deltaTime:this.deltaTime,DxDzBuffer:h(this.dxDzBuffer,"vec2",this.dxDzBuffer.count).toReadOnly(),DyDxzBuffer:h(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count).toReadOnly(),DyxDyzBuffer:h(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count).toReadOnly(),DxxDzzBuffer:h(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count).toReadOnly(),turbulenceBuffer:h(this.turbulenceBuffer,"float",this.turbulenceBuffer.count),writeDisplacement:ge(this.displacement),writeDerivative:ge(this.derivative),writeJacobian:ge(this.jacobian),workgroupSize:o(new re().fromArray(this.workgroupSize)),workgroupId:fe,localId:ce}).computeKernel(this.workgroupSize)}update(e){this.waveTime=performance.now()/1e3,this.computeTimeSpectrum.computeNode.parameters.time.value=this.waveTime,this.params.renderer.compute(this.computeTimeSpectrum,this.dispatchSize),this.ifft(0),this.ifft(1),this.ifft(2),this.ifft(3),this.deltaTime.value=e,this.params.renderer.compute(this.computeMergeTextures,this.dispatchSize)}ifft(e){this.displacementIndex.value=e;let a=!0;this.ifftStep.value=0,this.params.renderer.compute(this.computeInitialize,this.dispatchSize);for(let r=1;r<this.logN;r+=1)a=!a,this.ifftStep.value=r,this.pingpong.value=a?1:0,this.params.renderer.compute(this.computeHorizontalPingPong,this.dispatchSize);for(let r=0;r<this.logN;r+=1)a=!a,this.ifftStep.value=r,this.pingpong.value=a?1:0,this.params.renderer.compute(this.computeVerticalPingPong,this.dispatchSize);this.params.renderer.compute(this.computePermute,this.dispatchSize)}dispose(){this.displacement?.dispose?.(),this.derivative?.dispose?.(),this.jacobian?.dispose?.(),this.initialSpectrum?.dispose?.()}}class ma{constructor(e){this.params=e,this.quality=e.quality??ue}init(){this.qualityPreset=ua(this.quality),this.size=this.qualityPreset.resolution,this.butterflyBuffer=new N(new Float32Array(Math.log2(this.size)*this.size*4),4),this.butterfly=Zt({butterflyBuffer:h(this.butterflyBuffer,"vec4",this.butterflyBuffer.count),index:H,N:this.size}).compute(Math.log2(this.size)*this.size),this.params.renderer.compute(this.butterfly),this.waveSettings={..._e,...Ie},this.cascades=[],this.foamStrength=la,this.foamThreshold=ca,this.waveLengths=na,this.lambda=oa,this.lodScale=fa,this.initCascades()}initCascades(){this.cascades.length=0;let e=1e-4;for(let a=0;a<this.waveLengths.length;a+=1){const r=a<this.waveLengths.length-1?2*Math.PI/this.waveLengths[a+1]*6:9999;this.cascades.push(new ha({...this.params,...this.getCascadeParams(a,e,r)})),e=r}}getCascadeParams(e,a,r){return{boundaryHigh:r,boundaryLow:a,butterflyBuffer:this.butterflyBuffer,lambda:this.lambda[e],lengthScale:this.waveLengths[e],size:this.size,waveSettings:this.waveSettings}}setFoamStrength(e){this.foamStrength.value=e}setFoamThreshold(e){this.foamThreshold.value=e}setLodScale(e){this.lodScale.value=e}applyWaveSettings(e){if(!e)return;let a=!1;Object.entries(e).forEach(([r,i])=>{Object.prototype.hasOwnProperty.call(this.waveSettings,r)&&this.waveSettings[r].value!==i&&(this.waveSettings[r].value=i,a=!0)}),a&&this.cascades.forEach(r=>{r.initialSpectrum.update()})}update(e){this.cascades.forEach(a=>{a.update(e)})}dispose(){this.cascades.forEach(e=>{e.dispose?.()}),this.cascades=[],this.butterflyBuffer?.dispose?.()}}async function va({cascade:t,renderer:e,sampler:a}){const r=new Float32Array(await e.getArrayBufferAsync(t.dyDxzBuffer)),{size:i}=t.params,{lengthScale:s}=t.params,l=Math.max(1,Math.floor(i/16));let n=0,c=0,d=0;a.setTime(t.waveTime??0);for(let b=0;b<i;b+=l)for(let z=0;z<i;z+=l){const m=r[(b*i+z)*2],g=a.sampleHeight(z*s/i,b*s/i);n=Math.max(n,Math.abs(m)),c=Math.max(c,Math.abs(m-g)),d+=1}return{maxAbsolute:n,maxError:c,modeCount:a.count,relativeError:n>0?c/n:0,sampleCount:d}}function xa(t){return 1e3/Math.max(1,t?.performance?.waveUpdateHz??30)}function ga(t){const e=xe(m=>m.camera),a=xe(m=>m.gl),r=xe(m=>m.scene),i=f.useRef(null),s=f.useRef(0),l=f.useRef(new Ue),[n,c]=f.useState(null),d=t?.performance?.quality,b=t?.performance?.pauseWater??!1,z=t?.buoyancy?.modeCount??192;return f.useEffect(()=>{if(!a?.isWebGPURenderer)return;let m=!1;const g=new ma({quality:d,renderer:a});g.init();const y=new qt({camera:e,layer:0,renderer:a,scene:r,waveGenerator:g});y.init(),y.applyConfig(t);const v=new Ue({modeCount:z});return l.current=v,i.current={oceanManager:y,sampler:v,waveGenerator:g},v.load({cascade:g.cascades[0],renderer:a}).then(()=>{m||(c(v),ht()&&typeof window<"u"&&(window.rowItAloneWaveCheck=()=>va({cascade:g.cascades[0],renderer:a,sampler:v})))}).catch(()=>{m||c(null)}),()=>{m=!0,s.current=0,i.current=null,c(null),v.dispose(),y.dispose(),g.dispose?.()}},[z,e,a,d,r]),Le((m,g)=>{const y=i.current;if(!y)return;if(y.waveGenerator.applyWaveSettings(t.waveSettings),y.oceanManager.applyConfig(t),b){s.current=0,y.oceanManager.update(m.camera),y.sampler.setTime(y.waveGenerator.cascades[0].waveTime??0);return}const v=xa(t);for(s.current=Math.min(s.current+g*1e3,v*3);s.current>=v;)y.waveGenerator.update(v),s.current-=v;y.oceanManager.update(m.camera),y.sampler.setTime(y.waveGenerator.cascades[0].waveTime??0)}),{runtimeRef:i,sampler:n,samplerRef:l}}function qe(t,e,a){return Object.fromEntries(Object.entries(e).map(([r,i])=>[`${t}${r}`,{label:r,max:a[r].max,min:a[r].min,value:i.value}]))}function Xe(t,e,a){return Object.fromEntries(Object.keys(a).map(r=>[r,t[`${e}${r}`]]))}function ya(){const t=mt("Row It Alone WebGPU",{Camera:O({camX:{label:"X",value:30,min:-200,max:200,step:.1},camY:{label:"Y",value:20,min:1,max:200,step:.1},camZ:{label:"Z",value:30,min:-200,max:200,step:.1},targetX:{label:"Target X",value:0,min:-100,max:100,step:.1},targetY:{label:"Target Y",value:0,min:-50,max:50,step:.1},targetZ:{label:"Target Z",value:0,min:-100,max:100,step:.1},fov:{value:50,min:20,max:90,step:1},minDistance:{value:10,min:1,max:200,step:1},maxDistance:{value:1200,min:50,max:1e4,step:10}},{collapsed:!0}),Sky:O({elevation:{value:2,min:0,max:90,step:.1},azimuth:{value:180,min:-180,max:180,step:.1},exposure:{value:1,min:.05,max:2.5,step:.01},rayleigh:{value:3,min:0,max:4,step:.001},turbidity:{value:10,min:1,max:20,step:.1},mieCoefficient:{value:.005,min:0,max:.02,step:1e-4},mieDirectionalG:{value:.7,min:0,max:1,step:.001}},{collapsed:!0}),"First Wave Spectrum":O(qe("first_",_e,da),{collapsed:!0}),"Second Wave Spectrum":O(qe("second_",Ie,pa),{collapsed:!0}),Foam:O({foamStrength:{value:.8,min:0,max:5,step:.1},foamThreshold:{value:2.7,min:0,max:5,step:.1}},{collapsed:!0}),Ocean:O({patchSize:{value:160,min:20,max:1e3,step:1},patchResolution:{value:192,min:16,max:512,step:1},wireframe:!1,lodScale:{value:3.7,min:0,max:20,step:.1}},{collapsed:!1}),Lighting:O({sunIntensity:{label:"Sun",value:2.6,min:0,max:10,step:.05},sunColor:{label:"Sun Color",value:"#fff2dd"},hemisphereIntensity:{label:"Hemisphere",value:.9,min:0,max:5,step:.05},hemisphereSkyColor:{label:"Sky Color",value:"#bcd9ff"},hemisphereGroundColor:{label:"Ground Color",value:"#2f4a5c"}},{collapsed:!0}),Boat:O({boatScale:{label:"Scale",value:1,min:.1,max:8,step:.05},boatPositionX:{label:"X",value:0,min:-60,max:60,step:.1},boatPositionY:{label:"Y",value:0,min:-5,max:5,step:.01},boatPositionZ:{label:"Z",value:0,min:-60,max:60,step:.1},boatRotationY:{label:"Rot Y",value:-20,min:-180,max:180,step:1},boatDraft:{label:"Draft",value:.03,min:-2,max:2,step:.01},boatMass:{label:"Mass",value:1.4,min:.05,max:50,step:.01},boatBuoyancy:{label:"Buoyancy",value:5.8,min:0,max:80,step:.1},boatBuoyancyDamping:{label:"Buoy Damp",value:3,min:0,max:20,step:.05},boatLinearDamping:{label:"Linear Damp",value:3.4,min:0,max:20,step:.05},boatAngularDamping:{label:"Angular Damp",value:8.5,min:0,max:20,step:.05},boatProbeLift:{label:"Probe Lift",value:.02,min:-1,max:2,step:.01},boatProbeForward:{label:"Probe Forward",value:.72,min:.05,max:5,step:.01},boatProbeSide:{label:"Probe Side",value:.34,min:.05,max:5,step:.01},hideInteriorWater:{label:"Hide Interior Water",value:!0},interiorInset:{label:"Interior Inset",value:.92,min:.3,max:1.2,step:.01}},{collapsed:!0}),Oars:O({jointMinAngle:{label:"Min Angle",value:-58,min:-180,max:0,step:1},jointMaxAngle:{label:"Max Angle",value:36,min:0,max:180,step:1},oarLinearDamping:{label:"Linear Damp",value:1.8,min:0,max:8,step:.05},oarAngularDamping:{label:"Angular Damp",value:5.5,min:0,max:20,step:.05},oarBuoyancy:{label:"Buoyancy",value:12,min:0,max:40,step:.1},oarBuoyancyDamping:{label:"Buoy Damp",value:2.2,min:0,max:10,step:.05},oarProbeLift:{label:"Probe Lift",value:.1,min:-1,max:2,step:.01}},{collapsed:!0}),Physics:O({gravityY:{label:"Gravity Y",value:-9.81,min:-20,max:0,step:.01},oarMass:{label:"Oar Mass",value:.25,min:.05,max:10,step:.01},timeStep:{label:"Time Step",value:.011111111111111112,min:.004166666666666667,max:.03333333333333333,step:5e-4},buoyancyModeCount:{label:"Wave Modes",value:192,min:32,max:1024,step:32}},{collapsed:!0}),Performance:O({quality:{options:Object.keys(de),value:ue},pauseWater:{label:"Pause water",value:!1},waveUpdateHz:{value:30,min:5,max:60,step:1}},{collapsed:!0})});return{lighting:{groundColor:t.hemisphereGroundColor,hemisphere:t.hemisphereIntensity,skyColor:t.hemisphereSkyColor,sun:t.sunIntensity,sunColor:t.sunColor},boat:{angularDamping:t.boatAngularDamping,buoyancy:t.boatBuoyancy,buoyancyDamping:t.boatBuoyancyDamping,draft:t.boatDraft,hideInteriorWater:t.hideInteriorWater,interiorInset:t.interiorInset,linearDamping:t.boatLinearDamping,mass:t.boatMass,position:[t.boatPositionX,t.boatPositionY,t.boatPositionZ],probeForward:t.boatProbeForward,probeLift:t.boatProbeLift,probeSide:t.boatProbeSide,rotationY:t.boatRotationY,scale:t.boatScale},oars:{angularDamping:t.oarAngularDamping,buoyancy:t.oarBuoyancy,buoyancyDamping:t.oarBuoyancyDamping,jointMaxAngle:t.jointMaxAngle,jointMinAngle:t.jointMinAngle,linearDamping:t.oarLinearDamping,probeLift:t.oarProbeLift},physics:{gravity:[0,t.gravityY,0],oarMass:t.oarMass,timeStep:t.timeStep},buoyancy:{modeCount:t.buoyancyModeCount},camera:{fov:t.fov,maxDistance:t.maxDistance,minDistance:t.minDistance,position:[t.camX,t.camY,t.camZ],target:[t.targetX,t.targetY,t.targetZ]},ocean:{lodScale:t.lodScale,patchResolution:t.patchResolution,patchSize:t.patchSize,wireframe:t.wireframe},foam:{foamStrength:t.foamStrength,foamThreshold:t.foamThreshold},sky:{azimuth:t.azimuth,elevation:t.elevation,exposure:t.exposure,mieCoefficient:t.mieCoefficient,mieDirectionalG:t.mieDirectionalG,rayleigh:t.rayleigh,turbidity:t.turbidity,up:[0,1,0]},performance:{pauseWater:t.pauseWater,quality:t.quality,waveUpdateHz:t.waveUpdateHz},waveSettings:{...Xe(t,"first_",_e),...Xe(t,"second_",Ie)}}}function Ia(){const t=ya(),{runtimeRef:e,sampler:a}=ga(t);return p.jsxs(p.Fragment,{children:[p.jsx(zt,{makeDefault:!0,position:t.camera.position,fov:t.camera.fov,near:.1,far:1e6}),p.jsx(St,{makeDefault:!0,target:t.camera.target,minDistance:t.camera.minDistance,maxDistance:t.camera.maxDistance,maxPolarAngle:Math.PI*.495}),p.jsx("color",{attach:"background",args:["#87ceeb"]}),p.jsx(It,{lighting:t.lighting,runtimeRef:e}),p.jsx(xt,{gravity:t.physics.gravity,interpolate:!0,paused:!a,timeStep:t.physics.timeStep,children:p.jsx(f.Suspense,{fallback:null,children:p.jsx(Pt,{boat:t.boat,oars:t.oars,physics:t.physics,runtimeRef:e,sampler:a})})})]})}export{Ia as default};
