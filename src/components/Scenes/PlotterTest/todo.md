...
- [ ] Upgrade comparison to true dual synchronized viewports/canvases, currently need to press a button or space to re-render. would be nice to do it every few frames automatically, so i can reorient the scene or toggle plotter renderer controls and see live updates.
- [ ] Can we update the plotter renderer to do a second opposing hatching pass, to get crosshatching?
