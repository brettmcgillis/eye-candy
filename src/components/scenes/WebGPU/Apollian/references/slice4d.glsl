// REFERENCE ONLY — not compiled by the app.
// "Slicing a 4D apollian" by mrange, CC0
// https://www.shadertoy.com/view/wl3fR7
//
// PASTE THE FULL SHADERTOY IMAGE-PASS SOURCE BELOW THIS LINE, VERBATIM.
