...
export default function OdotUtilityPole(props) {
  const { nodes, materials } = useGLTF(modelFile('odot_utility_pole.glb'));
  return (
...
useGLTF.preload(modelFile('odot_utility_pole.glb'));
