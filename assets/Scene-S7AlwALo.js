...
`;function Qa({source:e,geometry:a,bladeHeight:s=.045,alphaTexturePath:d=Xa,rootColor:t=null,tipColor:o=null,tipMix:u=.18,curvature:y=.05,windStrength:R=.18,noiseFrequency:P=.4,noiseAmplitude:T=.02,waveAmplitude:C=.025,waveLength:l=.7,waveSpeed:A=1.2,waveDirection:v=[1,0],interactive:m=!0,interactionRadius:w=.18,interactionStrength:D=1.2,showInteractionSurface:Y=!1,...W}){const j=n.useRef(),M=n.useRef(new I),F=o!=null,k=e.radius||1,H=s*k,U=w*k,f=T*k,N=C*k,S=n.useMemo(()=>Fe(),[]),O=De(d),B=n.useMemo(()=>{const z=e.baseColor.clone();return t&&z.set(t),z},[t,e.baseColor]),x=n.useMemo(()=>o?new J(o):e.baseColor.clone(),[e.baseColor,o]),E=n.useMemo(()=>it(v),[v]),r=n.useMemo(()=>{const z=new Jt({fragmentShader:$a,side:Re,uniforms:{uAlphaMap:{value:O||S},uBaseColor:{value:B.clone()},uBladeHeight:{value:H},uCurvature:{value:y},uInteractorEnabled:{value:0},uInteractorPos:{value:new I(1e3,1e3,1e3)},uInteractorRadius:{value:U},uInteractorStrength:{value:D},uNoiseAmplitude:{value:f},uNoiseFrequency:{value:P},uSourceMap:{value:e.map||S},uTime:{value:0},uTipColor:{value:x.clone()},uTipMix:{value:u},uUseExplicitTipColor:{value:F?1:0},uUseSourceMap:{value:e.map?1:0},uWaveAmplitude:{value:N},uWaveDirection:{value:E.clone()},uWaveLength:{value:l},uWaveSpeed:{value:A},uWindStrength:{value:R}},vertexShader:Za});return z.skinning=!0,z},[]);n.useEffect(()=>()=>{S.dispose(),r.dispose()},[S,r]),n.useEffect(()=>{r.uniforms.uAlphaMap.value=O||S,r.uniforms.uBaseColor.value.copy(B),r.uniforms.uBladeHeight.value=H,r.uniforms.uCurvature.value=y,r.uniforms.uInteractorRadius.value=U,r.uniforms.uInteractorStrength.value=D,r.uniforms.uNoiseAmplitude.value=f,r.uniforms.uNoiseFrequency.value=P,r.uniforms.uSourceMap.value=e.map||S,r.uniforms.uTipColor.value.copy(x),r.uniforms.uTipMix.value=u,r.uniforms.uUseExplicitTipColor.value=F?1:0,r.uniforms.uUseSourceMap.value=e.map?1:0,r.uniforms.uWaveAmplitude.value=N,r.uniforms.uWaveDirection.value.copy(E),r.uniforms.uWaveLength.value=l,r.uniforms.uWaveSpeed.value=A,r.uniforms.uWindStrength.value=R},[O,y,S,D,r,P,B,H,U,f,x,N,E,e.map,u,F,l,A,R]);const g=n.useCallback(z=>{!m||!j.current||(z.stopPropagation(),M.current.copy(z.point),j.current.worldToLocal(M.current),r.uniforms.uInteractorEnabled.value=1,r.uniforms.uInteractorPos.value.copy(M.current))},[m,r]),G=n.useCallback(()=>{r.uniforms.uInteractorEnabled.value=0},[r]);return we((z,c)=>{r.uniforms.uTime.value+=c}),!a||!e.mesh?null:p.jsxs(ze,{ref:j,source:e,...W,children:[p.jsx(lt,{frustumCulled:!1,geometry:a,material:r,sourceMesh:e.mesh}),p.jsx(Ue,{onPointerDown:m?g:void 0,onPointerLeave:m?G:void 0,onPointerMove:m?g:void 0,showInteractionSurface:Y,source:e})]})}const ut=new I,ct=new I,Nt=new I,Et=new ya,Ve=new pt,Ye=new I,He=new I,Lt=new I,Bt=new pe,Ft=new pe,Ut=new pe,zt=new pe,Ge=new pe,_t=new pe,Ot=new pe,jt=new pe,Vt=new pe,ue=new I,qe=new I,Ne=new I,Xe=new I,Ze=new I,ve=new I,dt=3,Ka=.65,Ja=1.5,er=.82,tr=1.12;function ar(e,a,s=Math.random,d={normals:new Float32Array(a*3),positions:new Float32Array(a*3),uvs:new Float32Array(a*2)}){const t=d;let o=e;o.index||(o=o.toNonIndexed());const u=o.getAttribute("position");if(!u)throw new Error("Strand fur source geometry is missing a position attribute.");o.getAttribute("normal")||o.computeVertexNormals();const y=o.getAttribute("normal"),R=o.getAttribute("skinIndex"),P=o.getAttribute("skinWeight"),T=o.getAttribute("uv"),C=!!(R&&P),l=o.index?.array,A=l?l.length/3:u.count/3,v=new Float32Array(A),m=new I,w=new I,D=new I,Y=new I,W=new I,j=new I,M=new I,F=new I,k=new I,H=new Map,U=new $e,f=new $e,N=new $e,S=new $e;C&&(t.skinIndices||=new Float32Array(a*4),t.skinWeights||=new Float32Array(a*4));let O=0;for(let x=0;x<A;x+=1){const E=l?l[x*3]:x*3,r=l?l[x*3+1]:x*3+1,g=l?l[x*3+2]:x*3+2;m.fromBufferAttribute(u,E),w.fromBufferAttribute(u,r),D.fromBufferAttribute(u,g),O+=Y.copy(w).sub(m).cross(W.copy(D).sub(m)).length()*.5,v[x]=O}const B=x=>{let E=0,r=A-1;for(;E<r;){const g=Math.floor((E+r)/2);x<=v[g]?r=g:E=g+1}return E};for(let x=0;x<a;x+=1){const E=B(s()*O),r=l?l[E*3]:E*3,g=l?l[E*3+1]:E*3+1,G=l?l[E*3+2]:E*3+2;let z=s(),c=s();z+c>1&&(z=1-z,c=1-c);const h=1-z-c;if(m.fromBufferAttribute(u,r),w.fromBufferAttribute(u,g),D.fromBufferAttribute(u,G),t.positions[x*3]=m.x*h+w.x*z+D.x*c,t.positions[x*3+1]=m.y*h+w.y*z+D.y*c,t.positions[x*3+2]=m.z*h+w.z*z+D.z*c,M.fromBufferAttribute(y,r),F.fromBufferAttribute(y,g),k.fromBufferAttribute(y,G),j.copy(M).multiplyScalar(h).addScaledVector(F,z).addScaledVector(k,c).normalize(),t.normals[x*3]=j.x,t.normals[x*3+1]=j.y,t.normals[x*3+2]=j.z,C){H.clear(),Bt.fromBufferAttribute(R,r),Ft.fromBufferAttribute(R,g),Ut.fromBufferAttribute(R,G),Ot.fromBufferAttribute(P,r),jt.fromBufferAttribute(P,g),Vt.fromBufferAttribute(P,G),[[Bt,Ot,h],[Ft,jt,z],[Ut,Vt,c]].forEach(([X,L,Z])=>{for(let $=0;$<4;$+=1){const ce=X.getComponent($),K=L.getComponent($)*Z;Number.isFinite(ce)&&K>1e-5&&H.set(ce,(H.get(ce)||0)+K)}});const i=Array.from(H.entries()).sort((X,L)=>L[1]-X[1]).slice(0,4),V=i.reduce((X,[,L])=>X+L,0);for(let X=0;X<4;X+=1){const L=x*4+X,Z=i[X];t.skinIndices[L]=Z?.[0]??0,t.skinWeights[L]=Z?Z[1]/Math.max(V,1e-6):0}}T?(U.fromBufferAttribute(T,r),f.fromBufferAttribute(T,g),N.fromBufferAttribute(T,G),S.copy(U).multiplyScalar(h).addScaledVector(f,z).addScaledVector(N,c),t.uvs[x*2]=S.x,t.uvs[x*2+1]=S.y):(t.uvs[x*2]=0,t.uvs[x*2+1]=0)}return t}function ht(e,a=new pt){const s=new I(0,1,0);if(s.dot(e)<-.9995){const d=new I(1,0,0).cross(s);return d.lengthSq()<1e-6&&d.set(0,0,1),d.normalize(),a.setFromAxisAngle(d,Math.PI),a}return a.setFromUnitVectors(s,e.clone().normalize()),a}function la({bladeWidth:e=.008,isSkinnedMesh:a=!1,seed:s=1,sourceGeometry:d,strandCount:t=4e3}){if(!d)return null;const o=Math.max(5e-4,Math.min(.5,e*.5)),u=dt*3,y=new Float32Array(u*3),R=new Float32Array(u*2),P=new Float32Array(u*3),T=new Uint16Array(u),C=new Mt;for(let f=0;f<dt;f+=1){const N=Math.PI/dt*f,S=Math.cos(N),O=Math.sin(N),B=f*3,x=f*6;ue.set(-o,0,0),qe.set(ue.x*S-ue.z*O,ue.y,ue.x*O+ue.z*S),Ne.copy(qe),ue.set(o,0,0),qe.set(ue.x*S-ue.z*O,ue.y,ue.x*O+ue.z*S),Xe.copy(qe),Ze.set(0,1,0),ve.copy(Xe).sub(Ne).cross(qe.copy(Ze).sub(Ne)).normalize(),y.set([Ne.x,Ne.y,Ne.z,Xe.x,Xe.y,Xe.z,Ze.x,Ze.y,Ze.z],B*3),R.set([0,0,1,0,.5,1],x),P.set([ve.x,ve.y,ve.z,ve.x,ve.y,ve.z,ve.x,ve.y,ve.z],B*3),T.set([B,B+1,B+2],B)}C.setAttribute("position",new ge(y,3)),C.setAttribute("uv",new ge(R,2)),C.setAttribute("normal",new ge(P,3)),C.setIndex(new ge(T,1));const l=ar(d,t,It(s)),A=It(s*17+5),v=new I,m=new pt,w=a?er:Ka,Y=(a?tr:Ja)-w;if(a&&l.skinIndices&&l.skinWeights){const f=C.getAttribute("position").count,N=C.index.count,S=f*t,O=N*t,B=C.getAttribute("position").array,x=C.getAttribute("uv").array,E=C.getAttribute("normal").array,r=C.index.array,g=new Mt,G=new Float32Array(S*3),z=new Float32Array(S*2),c=new Float32Array(S*3),h=8,i=6,V=new Float32Array(S*h),X=new Float32Array(S*i),L=new Uint16Array(S*4),Z=new Float32Array(S*4),$=S>65535?new Uint32Array(O):new Uint16Array(O),ce=new At(V,h),K=new At(X,i);for(let q=0;q<t;q+=1){const Me=w+A()*Y,Ae=A()*Math.PI*2,ke=q*f;v.set(l.normals[q*3],l.normals[q*3+1],l.normals[q*3+2]).normalize(),ht(v,m);for(let Q=0;Q<f;Q+=1){const de=ke+Q,re=de*3,me=de*2,ee=de*4,ie=de*h,ne=de*i,te=Q*3,fe=Q*2;G[re]=B[te],G[re+1]=B[te+1],G[re+2]=B[te+2],c[re]=E[te],c[re+1]=E[te+1],c[re+2]=E[te+2],z[me]=x[fe],z[me+1]=x[fe+1],V[ie]=l.positions[q*3],V[ie+1]=l.positions[q*3+1],V[ie+2]=l.positions[q*3+2],V[ie+3]=l.normals[q*3],V[ie+4]=l.normals[q*3+1],V[ie+5]=l.normals[q*3+2],V[ie+6]=l.uvs[q*2],V[ie+7]=l.uvs[q*2+1],X[ne]=Me,X[ne+1]=Ae,X[ne+2]=m.x,X[ne+3]=m.y,X[ne+4]=m.z,X[ne+5]=m.w,L[ee]=l.skinIndices[q*4],L[ee+1]=l.skinIndices[q*4+1],L[ee+2]=l.skinIndices[q*4+2],L[ee+3]=l.skinIndices[q*4+3],Z[ee]=l.skinWeights[q*4],Z[ee+1]=l.skinWeights[q*4+1],Z[ee+2]=l.skinWeights[q*4+2],Z[ee+3]=l.skinWeights[q*4+3]}for(let Q=0;Q<N;Q+=1)$[q*N+Q]=r[Q]+ke}return g.setAttribute("position",new ge(G,3)),g.setAttribute("uv",new ge(z,2)),g.setAttribute("normal",new ge(c,3)),g.setAttribute("aRootPosition",new We(ce,3,0)),g.setAttribute("aRootNormal",new We(ce,3,3)),g.setAttribute("aScale",new We(K,1,0)),g.setAttribute("aPhase",new We(K,1,1)),g.setAttribute("aQuat",new We(K,4,2)),g.setAttribute("aRootUv",new We(ce,2,6)),g.setAttribute("skinIndex",new ba(L,4)),g.setAttribute("skinWeight",new Sa(Z,4)),g.setIndex(new ge($,1)),g.userData.furSkinning=null,g.userData.strandGeometryType="skinned",g}const W=new xa;W.index=C.index,W.attributes.position=C.attributes.position,W.attributes.uv=C.attributes.uv,W.attributes.normal=C.attributes.normal;const j=new Float32Array(t*3),M=new Float32Array(t*3),F=new Float32Array(t),k=new Float32Array(t),H=new Float32Array(t*4),U=new Float32Array(t*2);for(let f=0;f<t;f+=1)j[f*3]=l.positions[f*3],j[f*3+1]=l.positions[f*3+1],j[f*3+2]=l.positions[f*3+2],M[f*3]=l.normals[f*3],M[f*3+1]=l.normals[f*3+1],M[f*3+2]=l.normals[f*3+2],v.set(l.normals[f*3],l.normals[f*3+1],l.normals[f*3+2]).normalize(),ht(v,m),H[f*4]=m.x,H[f*4+1]=m.y,H[f*4+2]=m.z,H[f*4+3]=m.w,U[f*2]=l.uvs[f*2],U[f*2+1]=l.uvs[f*2+1],F[f]=w+A()*Y,k[f]=A()*Math.PI*2;return W.setAttribute("aOffset",new Te(j,3)),W.setAttribute("aRootPosition",new Te(j,3)),W.setAttribute("aRootNormal",new Te(M,3)),W.setAttribute("aScale",new Te(F,1)),W.setAttribute("aPhase",new Te(k,1)),W.setAttribute("aQuat",new Te(H,4)),W.setAttribute("aRootUv",new Te(U,2)),l.skinIndices&&l.skinWeights?(W.userData.furSkinning={bindNormals:l.normals,bindPositions:l.positions,skinIndices:l.skinIndices,skinWeights:l.skinWeights},W.getAttribute("aOffset").setUsage(kt),W.getAttribute("aQuat").setUsage(kt)):W.userData.furSkinning=null,W.instanceCount=t,W.userData.strandGeometryType="instanced",W}function Yt(e,a,s,d,t){zt.set(a.x,a.y,a.z,1).applyMatrix4(e.bindMatrix),Ge.set(0,0,0,0);for(let o=0;o<4;o+=1){const u=d[o];u>1e-5&&(Et.fromArray(e.skeleton.boneMatrices,s[o]*16),_t.copy(zt).applyMatrix4(Et),Ge.addScaledVector(_t,u))}return t.set(Ge.x,Ge.y,Ge.z),t.applyMatrix4(e.bindMatrixInverse),t}function ua(e,a){const s=e?.userData?.furSkinning;if(!s||!a?.isSkinnedMesh||!a.skeleton)return!1;const d=e.getAttribute("aOffset"),t=e.getAttribute("aQuat");if(!d||!t)return!1;a.skeleton.update();for(let o=0;o<d.count;o+=1)ut.fromArray(s.bindPositions,o*3),ct.fromArray(s.bindNormals,o*3).normalize(),Nt.copy(ut).addScaledVector(ct,.025),Yt(a,ut,s.skinIndices.subarray(o*4,o*4+4),s.skinWeights.subarray(o*4,o*4+4),He),Yt(a,Nt,s.skinIndices.subarray(o*4,o*4+4),s.skinWeights.subarray(o*4,o*4+4),Lt),Ye.copy(Lt).sub(He),Ye.lengthSq()<=1e-6?Ye.copy(ct):Ye.normalize(),ht(Ye,Ve),d.setXYZ(o,He.x,He.y,He.z),t.setXYZW(o,Ve.x,Ve.y,Ve.z,Ve.w);return d.needsUpdate=!0,t.needsUpdate=!0,!0}const rr="/textures/fur/uneven-alpha.png",nr=`
precision highp float;
...
`;function sr({source:e,count:a=5e3,bladeHeight:s=.045,bladeWidth:d=.008,alphaTexturePath:t=rr,rootColor:o=null,tipColor:u=null,tipMix:y=.18,curvature:R=.05,windStrength:P=.18,noiseFrequency:T=.4,noiseAmplitude:C=.02,waveAmplitude:l=.025,waveLength:A=.7,waveSpeed:v=1.2,waveDirection:m=[1,0],interactive:w=!0,interactionRadius:D=.18,interactionStrength:Y=1.2,seed:W=1,showInteractionSurface:j=!1,...M}){const F=n.useRef(),k=n.useRef(new I),H=u!=null,U=e.radius||1,f=s*U,N=d*U,S=D*U,O=C*U,B=l*U,x=n.useMemo(()=>ia(a,e.isSkinnedMesh),[a,e.isSkinnedMesh]),E=n.useMemo(()=>Fe(),[]),r=De(t),g=n.useMemo(()=>la({bladeWidth:N,isSkinnedMesh:e.isSkinnedMesh,seed:W,sourceGeometry:e.geometry,strandCount:x}),[N,x,W,e.geometry,e.isSkinnedMesh]),G=g?.userData?.strandGeometryType==="skinned",z=n.useMemo(()=>{const L=e.baseColor.clone();return o&&L.set(o),L},[o,e.baseColor]),c=n.useMemo(()=>u?new J(u):e.baseColor.clone(),[e.baseColor,u]),h=n.useMemo(()=>it(m),[m]),i=n.useRef({uAlphaMap:{value:r||E},uBaseColor:{value:z.clone()},uBladeHeight:{value:f},uCurvature:{value:R},uInteractorEnabled:{value:0},uInteractorPos:{value:new I(1e3,1e3,1e3)},uInteractorRadius:{value:S},uInteractorStrength:{value:Y},uNoiseAmplitude:{value:O},uNoiseFrequency:{value:T},uSourceMap:{value:e.map||E},uTime:{value:0},uTipColor:{value:c.clone()},uTipMix:{value:y},uUseExplicitTipColor:{value:H?1:0},uUseSourceMap:{value:e.map?1:0},uWaveAmplitude:{value:B},uWaveDirection:{value:h.clone()},uWaveLength:{value:A},uWaveSpeed:{value:v},uWindStrength:{value:P}});n.useEffect(()=>()=>E.dispose(),[E]),n.useEffect(()=>{const L=i.current;L.uAlphaMap.value=r||E,L.uBaseColor.value.copy(z),L.uTipColor.value.copy(c),L.uBladeHeight.value=f,L.uCurvature.value=R,L.uInteractorRadius.value=S,L.uInteractorStrength.value=Y,L.uNoiseAmplitude.value=O,L.uNoiseFrequency.value=T,L.uSourceMap.value=e.map||E,L.uTipMix.value=y,L.uUseExplicitTipColor.value=H?1:0,L.uUseSourceMap.value=e.map?1:0,L.uWaveAmplitude.value=B,L.uWaveDirection.value.copy(h),L.uWaveLength.value=A,L.uWaveSpeed.value=v,L.uWindStrength.value=P},[r,f,R,E,S,Y,O,T,z,c,h,B,e.map,y,H,A,v,P]);const V=n.useCallback(L=>{!w||!F.current||(L.stopPropagation(),k.current.copy(L.point),F.current.worldToLocal(k.current),i.current.uInteractorEnabled.value=1,i.current.uInteractorPos.value.copy(k.current))},[w]),X=n.useCallback(()=>{i.current.uInteractorEnabled.value=0},[]);return we((L,Z)=>{i.current.uTime.value+=Z,!G&&e.isSkinnedMesh&&e.mesh&&ua(g,e.mesh)}),g?G&&e.mesh?p.jsx(Qa,{alphaTexturePath:t,bladeHeight:s,curvature:R,geometry:g,interactionRadius:D,interactionStrength:Y,interactive:w,noiseAmplitude:C,noiseFrequency:T,rootColor:o,showInteractionSurface:j,source:e,tipColor:u,tipMix:y,waveAmplitude:l,waveDirection:m,waveLength:A,waveSpeed:v,windStrength:P,...M}):p.jsxs(ze,{ref:F,source:e,...M,children:[p.jsx("mesh",{frustumCulled:!1,geometry:g,children:p.jsx("rawShaderMaterial",{fragmentShader:or,side:Re,uniforms:i.current,vertexShader:nr})}),p.jsx(Ue,{onPointerDown:w?V:void 0,onPointerLeave:w?X:void 0,onPointerMove:w?V:void 0,showInteractionSurface:j,source:e})]}):null}function ca({sourceGeometry:e=null,sourceMaterial:a=null,sourceMesh:s=null}){const[d,t]=n.useState(()=>Tt(s));return n.useLayoutEffect(()=>{const o=Tt(s);o!==d&&t(o)},[d,s]),n.useMemo(()=>{const o=vt(a)||vt(d?.material);return{baseColor:za(o),geometry:e||d?.geometry||null,isSkinnedMesh:d?.isSkinnedMesh===!0,map:_a(o),material:o,mesh:d,radius:Oa(e||d?.geometry)}},[d,e,a])}function ir({technique:e=he.strand,sourceGeometry:a=null,sourceMaterial:s=null,sourceMesh:d=null,...t}){const o=ca({sourceGeometry:a,sourceMaterial:s,sourceMesh:d});return o.geometry?e===he.shell?p.jsx(qa,{...t,source:o}):e===he.strand?p.jsx(sr,{...t,source:o}):null:null}const Ht=[.6,.6,.6,1],Gt=[1,1,1,0],lr="/textures/fur/uneven-alpha.png",ur=6.2831852,cr=.1376,dr=.3726,mr=.2546;function qt(){return null}function Xt(e,a){const s=Array.isArray(e)?e:a;return{alpha:s[3]??a[3],color:new J(s[0],s[1],s[2])}}function fr({alphaEnd:e,alphaMap:a,alphaStart:s,baseColor:d,colorEnd:t,colorStart:o,layerIndex:u,layerThickness:y,layersCount:R,sourceMap:P,interactionRadius:T,interactionStrength:C,stiffness:l,useSourceMap:A,waveScale:v}){const m={alphaEnd:b(e),alphaStart:b(s),baseColor:b(d.clone()),colorEnd:b(t.clone()),colorStart:b(o.clone()),interactorEnabled:b(0),interactorDir:b(new I(1,0,0)),interactorNormal:b(new I(0,1,0)),interactorPos:b(new I(1e3,1e3,1e3)),interactorRadius:b(T),interactorStrength:b(C),layerIndex:b(u),layerThickness:b(y),layersCount:b(R),stiffness:b(l),time:b(0),useSourceMap:b(A?1:0),waveScale:b(v)},w=new gt({alphaTest:.001,depthWrite:!1,side:Re,transparent:!0}),D=m.layerIndex.div(m.layersCount.max(_(1))),Y=m.layerIndex.add(1).mul(m.layerThickness),W=m.waveScale.mul(bt(D.max(_(1e-4)),m.stiffness)),j=m.time.mul(ur),M=se.toVar(),F=Ia.normalize().toVar(),k=m.interactorNormal.normalize(),H=oe(M.x.add(F.x.mul(Y)).add(xe(j.add(M.x.add(M.y).add(M.z).mul(cr))).mul(W)),M.y.add(F.y.mul(Y)).add(St(j.add(M.x.sub(M.y).add(M.z).mul(dr))).mul(W)),M.z.add(F.z.mul(Y)).add(xe(j.add(M.x.add(M.y).sub(M.z).mul(mr))).mul(W))),U=H.sub(m.interactorPos).toVar(),f=Le(U,k).toVar(),N=U.sub(k.mul(f)).toVar(),S=Ie(N),O=N.div(S.max(_(1e-5))),B=m.interactorDir.sub(k.mul(Le(m.interactorDir,k))).toVar(),x=Ie(B),E=ae(O,B.div(x.max(_(1e-5))),Ra(_(1e-4),x)),r=m.layerThickness.mul(2).max(m.interactorRadius.mul(.08)),g=_(1).sub(ye(r,r.mul(2.5),wa(f.sub(Y)))),G=ae(_(1),_(.45),D),z=ae(_(.35),_(1),D),c=_(1).sub(ye(0,m.interactorRadius,S)).mul(g).mul(m.interactorStrength).mul(m.interactorEnabled),h=Ce(c.mul(G).mul(.32),0,.6),i=ae(H.add(E.mul(c).mul(z).mul(.85)),M,h).sub(F.mul(c).mul(G).mul(.08));let V=m.baseColor;P&&(V=ae(m.baseColor,m.baseColor.mul(Be(new Ee(P),at()).rgb),m.useSourceMap)),w.vertexNode=ta.mul(aa).mul(ra(i,1));const X=V.mul(ae(m.colorStart,m.colorEnd,D));return w.colorNode=X,w.opacityNode=Be(new Ee(a),at()).r.mul(ae(m.alphaStart,m.alphaEnd,D)),{material:w,uniforms:m}}function vr({source:e,layers:a=null,shellCount:s=20,thickness:d=null,shellSpacing:t=null,waveScale:o=.06,stiffness:u=2.75,startColor:y=Ht,endColor:R=Gt,alphaTexturePath:P=lr,rootColor:T=null,interactive:C=!1,interactionRadius:l=.18,interactionStrength:A=1.2,showInteractionSurface:v=!1,...m}){const w=n.useRef(),D=n.useRef(new I),Y=n.useRef(new I(0,1,0)),W=n.useRef(new I),j=n.useRef(new I(1,0,0)),M=n.useRef(),F=n.useMemo(()=>Fe(),[]),k=De(P),H=C||v,U=n.useMemo(()=>sa(a??s),[a,s]),f=n.useMemo(()=>{const c=e.baseColor.clone();return T&&c.set(T),c},[T,e.baseColor]),N=n.useMemo(()=>Xt(y,Ht),[y]),S=n.useMemo(()=>Xt(R,Gt),[R]),O=d??t??.018,B=l*(e.radius||1),x=o,E=B,r=n.useMemo(()=>Array.from({length:U},(c,h)=>fr({alphaEnd:S.alpha,alphaMap:k||F,alphaStart:N.alpha,baseColor:f,colorEnd:S.color,colorStart:N.color,interactionRadius:B,interactionStrength:A,layerIndex:h,layerThickness:O,layersCount:U,sourceMap:e.map||F,stiffness:u,useSourceMap:!!e.map,waveScale:x})),[k,F,f,S.alpha,S.color,B,A,U,O,N.alpha,N.color,x,e.map,u]);n.useEffect(()=>{k&&(k.colorSpace=Kt,k.wrapS=tt,k.wrapT=tt,k.needsUpdate=!0)},[k]),n.useEffect(()=>()=>{F.dispose()},[F]),n.useEffect(()=>()=>{r.forEach(({material:c})=>c.dispose())},[r]),n.useEffect(()=>{r.forEach((c,h)=>{const{uniforms:i}=c;i.alphaEnd.value=S.alpha,i.alphaStart.value=N.alpha,i.baseColor.value.copy(f),i.colorEnd.value.copy(S.color),i.colorStart.value.copy(N.color),i.interactorRadius.value=B,i.interactorStrength.value=A,i.layerIndex.value=h,i.layerThickness.value=O,i.layersCount.value=U,i.stiffness.value=u,i.useSourceMap.value=e.map?1:0,i.waveScale.value=x})},[r,f,S.alpha,S.color,B,A,U,O,N.alpha,N.color,x,e.map,u]);const g=n.useCallback(()=>{!M.current||!v||(M.current.visible=!0,M.current.position.copy(D.current))},[v]),G=n.useCallback(c=>{if(!C||!w.current)return;c.stopPropagation(),D.current.copy(c.point),w.current.worldToLocal(D.current),c.face?.normal&&Y.current.copy(c.face.normal).normalize();const h=new I().subVectors(D.current,W.current);h.lengthSq()>1e-8&&j.current.copy(h.normalize()),W.current.copy(D.current),r.forEach(({uniforms:i})=>{const V=i;V.interactorEnabled.value=1,V.interactorDir.value.copy(j.current),V.interactorNormal.value.copy(Y.current),V.interactorPos.value.copy(D.current)}),g()},[C,r,g]),z=n.useCallback(()=>{r.forEach(({uniforms:c})=>{const h=c;h.interactorEnabled.value=0,h.interactorDir.value.set(1,0,0),h.interactorNormal.value.set(0,1,0)}),M.current&&(M.current.visible=!1)},[r]);return n.useEffect(()=>{M.current&&(M.current.visible=!1)},[v]),we((c,h)=>{r.forEach(i=>{const V=i.uniforms;V.time.value+=h})}),p.jsxs(ze,{ref:w,source:e,...m,children:[r.map(({material:c},h)=>e.isSkinnedMesh&&e.mesh?p.jsx(lt,{frustumCulled:!1,material:c,raycast:qt,renderOrder:20+h,sourceMesh:e.mesh},c.uuid):p.jsx("mesh",{frustumCulled:!1,geometry:e.geometry,material:c,raycast:qt,renderOrder:20+h},c.uuid)),H?p.jsx(Ue,{onPointerDown:C?G:void 0,onPointerLeave:C?z:void 0,onPointerMove:C?G:void 0,showInteractionSurface:v,source:e}):null,v?p.jsxs("mesh",{ref:M,renderOrder:200,children:[p.jsx("sphereGeometry",{args:[E,20,20]}),p.jsx("meshBasicMaterial",{color:"#00ff88",depthTest:!1,depthWrite:!1,opacity:.95,transparent:!0,wireframe:!0})]}):null]})}const hr="/textures/fur/uneven-alpha.png";function pr({source:e,geometry:a,bladeHeight:s=.045,alphaTexturePath:d=hr,rootColor:t=null,tipColor:o=null,tipMix:u=.18,curvature:y=.05,windStrength:R=.18,noiseFrequency:P=.4,noiseAmplitude:T=.02,waveAmplitude:C=.025,waveLength:l=.7,waveSpeed:A=1.2,waveDirection:v=[1,0],interactive:m=!0,interactionRadius:w=.18,interactionStrength:D=1.2,showInteractionSurface:Y=!1,...W}){const j=n.useRef(),M=n.useRef(new I),F=o!=null,k=e.radius||1,H=s*k,U=w*k,f=T*k,N=C*k,S=n.useMemo(()=>Fe(),[]),O=De(d),B=n.useMemo(()=>{const c=e.baseColor.clone();return t&&c.set(t),c},[t,e.baseColor]),x=n.useMemo(()=>o?new J(o):e.baseColor.clone(),[e.baseColor,o]),E=n.useMemo(()=>it(v),[v]),r=n.useMemo(()=>({baseColor:b(B.clone()),bladeHeight:b(H),curvature:b(y),interactorEnabled:b(0),interactorPos:b(new I(1e3,1e3,1e3)),interactorRadius:b(U),interactorStrength:b(D),noiseAmplitude:b(f),noiseFrequency:b(P),time:b(0),tipColor:b(x.clone()),tipMix:b(u),useExplicitTipColor:b(F?1:0),waveAmplitude:b(N),waveDirection:b(E.clone()),waveLength:b(l),waveSpeed:b(A),windStrength:b(R)}),[]),g=n.useMemo(()=>{const c=new gt({alphaTest:.01,side:Re}),h=Se("aRootPosition","vec3"),i=Se("aRootNormal","vec3").normalize(),V=Se("aScale","float"),X=Se("aPhase","float"),L=Se("aQuat","vec4"),Z=Se("aRootUv","vec2"),$=new Ca(e.mesh);$.skinIndexNode=Se("skinIndex","uvec4"),$.skinWeightNode=Se("skinWeight","vec4"),$.bindMatrixNode=b(e.mesh.bindMatrix,"mat4"),$.bindMatrixInverseNode=b(e.mesh.bindMatrixInverse,"mat4"),$.boneMatricesNode=Da(e.mesh.skeleton.boneMatrices,"mat4",e.mesh.skeleton.bones.length);const ce=rt(([re,me])=>{const ee=nt(re.xyz,me);return me.add(nt(re.xyz,ee.add(me.mul(re.w))).mul(2))}),K=Ce(se.y,0,1),q=r.waveDirection.div(Ie(r.waveDirection).max(_(1e-4))),Me=xe(h.x.mul(r.noiseFrequency.max(_(1e-4))).add(h.z.mul(r.noiseFrequency.max(_(1e-4)))).add(K.mul(4)).add(r.time.mul(.1))).mul(.5).add(.5),Ae=ye(_(.08),_(.65),Be(new Ee(O||S),at()).r),ke=rt(()=>{const re=oe(se.x,se.y.mul(r.bladeHeight).mul(V),se.z).toVar(),me=r.time.add(X),ee=xe(me.mul(1.3).add(h.x.mul(.2))).add(St(me.mul(.7).add(h.z.mul(.15)))).mul(r.windStrength).mul(K.mul(K)),ie=xe(Le(h.xz,q).div(r.waveLength.max(_(1e-4))).mul(6.2831852).sub(r.time.mul(r.waveSpeed))).mul(r.waveAmplitude).mul(K),ne=h.add(ce(L,re.add(oe(r.curvature.mul(K).mul(K),0,0)).add(oe(ee.mul(.4),0,ee.mul(.15))).add(oe(q.x.mul(ie),0,q.y.mul(ie))).add(oe(Me.sub(.5).mul(r.noiseAmplitude).mul(K),0,Me.sub(.5).mul(r.noiseAmplitude).mul(K).mul(.6))))).toVar(),te=$.getSkinnedPosition(void 0,h).toVar(),fe=$.getSkinnedNormal(void 0,i).normalize().toVar(),Qe=$.getSkinnedPosition(void 0,ne).toVar(),Pe=te.sub(r.interactorPos).sub(fe.mul(Le(te.sub(r.interactorPos),fe))).toVar(),_e=Ie(Pe),Oe=Ce(_(1).sub(ye(0,r.interactorRadius,_e)).mul(r.interactorStrength).mul(r.interactorEnabled),0,1),Ke=Pe.div(_e.max(_(1e-5)));return ae(Qe.add(Ke.mul(Oe).mul(r.bladeHeight).mul(.9).mul(K)),te,Oe.mul(.25).mul(K))})();let Q=r.baseColor;e.map&&(Q=r.baseColor.mul(Be(new Ee(e.map),Z).rgb));const de=ae(Q,r.tipColor,r.tipMix.mul(r.useExplicitTipColor));return c.vertexNode=ta.mul(aa).mul(ra(ke,1)),c.colorNode=ae(Q,de,bt(K,1.2)).mul(ae(_(.75),_(1.25),Me)).mul(ae(_(.82),_(1),Ae)).add(ye(.7,1,K).mul(.12)),c.opacityNode=Ae,c},[O,S,e.map,e.mesh,r]);n.useEffect(()=>()=>{S.dispose(),g.dispose()},[S,g]),n.useEffect(()=>{r.baseColor.value.copy(B),r.bladeHeight.value=H,r.curvature.value=y,r.interactorRadius.value=U,r.interactorStrength.value=D,r.noiseAmplitude.value=f,r.noiseFrequency.value=P,r.tipColor.value.copy(x),r.tipMix.value=u,r.useExplicitTipColor.value=F?1:0,r.waveAmplitude.value=N,r.waveDirection.value.copy(E),r.waveLength.value=l,r.waveSpeed.value=A,r.windStrength.value=R},[y,D,P,B,H,U,f,x,N,E,u,r,F,l,A,R]);const G=n.useCallback(c=>{!m||!j.current||(c.stopPropagation(),M.current.copy(c.point),j.current.worldToLocal(M.current),r.interactorEnabled.value=1,r.interactorPos.value.copy(M.current))},[m,r]),z=n.useCallback(()=>{r.interactorEnabled.value=0},[r]);return we((c,h)=>{r.time.value+=h,e.mesh?.skeleton?.update()}),!a||!e.mesh?null:p.jsxs(ze,{ref:j,source:e,...W,children:[p.jsx("mesh",{frustumCulled:!1,geometry:a,material:g}),p.jsx(Ue,{onPointerDown:m?G:void 0,onPointerLeave:m?z:void 0,onPointerMove:m?G:void 0,showInteractionSurface:Y,source:e})]})}const gr="/textures/fur/uneven-alpha.png";function br({source:e,count:a=5e3,bladeHeight:s=.045,bladeWidth:d=.008,alphaTexturePath:t=gr,rootColor:o=null,tipColor:u=null,tipMix:y=.18,curvature:R=.05,windStrength:P=.18,noiseFrequency:T=.4,noiseAmplitude:C=.02,waveAmplitude:l=.025,waveLength:A=.7,waveSpeed:v=1.2,waveDirection:m=[1,0],interactive:w=!0,interactionRadius:D=.18,interactionStrength:Y=1.2,seed:W=1,showInteractionSurface:j=!1,...M}){const F=n.useRef(),k=n.useRef(new I),H=u!=null,U=e.radius||1,f=s*U,N=d*U,S=D*U,O=C*U,B=l*U,x=n.useMemo(()=>ia(a,e.isSkinnedMesh),[a,e.isSkinnedMesh]),E=n.useMemo(()=>Fe(),[]),r=De(t),g=n.useMemo(()=>la({bladeWidth:N,isSkinnedMesh:e.isSkinnedMesh,seed:W,sourceGeometry:e.geometry,strandCount:x}),[N,x,W,e.geometry,e.isSkinnedMesh]),G=g?.userData?.strandGeometryType==="skinned",z=n.useMemo(()=>{const Z=e.baseColor.clone();return o&&Z.set(o),Z},[o,e.baseColor]),c=n.useMemo(()=>u?new J(u):e.baseColor.clone(),[e.baseColor,u]),h=n.useMemo(()=>it(m),[m]),i=n.useMemo(()=>({baseColor:b(z.clone()),bladeHeight:b(f),curvature:b(R),interactorEnabled:b(0),interactorPos:b(new I(1e3,1e3,1e3)),interactorRadius:b(S),interactorStrength:b(Y),noiseAmplitude:b(O),noiseFrequency:b(T),time:b(0),tipColor:b(c.clone()),tipMix:b(y),useExplicitTipColor:b(H?1:0),waveAmplitude:b(B),waveDirection:b(h.clone()),waveLength:b(A),waveSpeed:b(v),windStrength:b(P)}),[]),V=n.useMemo(()=>{if(!g||G)return null;const Z=new gt({alphaTest:.01,side:Re}),$=je(g.getAttribute("aOffset")),ce=je(g.getAttribute("aScale")),K=je(g.getAttribute("aPhase")),q=je(g.getAttribute("aQuat")),Me=je(g.getAttribute("aRootUv")),Ae=ye(_(.08),_(.65),Be(new Ee(r||E),at()).r),ke=rt(([ne,te])=>{const fe=nt(ne.xyz,te);return te.add(nt(ne.xyz,fe.add(te.mul(ne.w))).mul(2))}),Q=Ce(se.y,0,1),de=i.waveDirection.div(Ie(i.waveDirection).max(_(1e-4))),re=xe($.x.mul(i.noiseFrequency.max(_(1e-4))).add($.z.mul(i.noiseFrequency.max(_(1e-4)))).add(Q.mul(4)).add(i.time.mul(.1))).mul(.5).add(.5),me=rt(()=>{const ne=oe(se.x,se.y.mul(i.bladeHeight).mul(ce),se.z).toVar(),te=i.time.add(K),fe=xe(te.mul(1.3).add($.x.mul(.2))).add(St(te.mul(.7).add($.z.mul(.15)))).mul(i.windStrength).mul(Q.mul(Q)),Qe=xe(Le($.xz,de).div(i.waveLength.max(_(1e-4))).mul(6.2831852).sub(i.time.mul(i.waveSpeed))).mul(i.waveAmplitude).mul(Q),Pe=ke(q,ne.add(oe(i.curvature.mul(Q).mul(Q),0,0)).add(oe(fe.mul(.4),0,fe.mul(.15))).add(oe(de.x.mul(Qe),0,de.y.mul(Qe))).add(oe(re.sub(.5).mul(i.noiseAmplitude).mul(Q),0,re.sub(.5).mul(i.noiseAmplitude).mul(Q).mul(.6)))).toVar(),_e=ke(q,oe(0,1,0)).normalize().toVar(),Oe=$.sub(i.interactorPos).sub(_e.mul(Le($.sub(i.interactorPos),_e))).toVar(),Ke=Ie(Oe),yt=Ce(_(1).sub(ye(0,i.interactorRadius,Ke)).mul(i.interactorStrength).mul(i.interactorEnabled),0,1),fa=Oe.div(Ke.max(_(1e-5)));return Pe.addAssign(fa.mul(yt).mul(i.bladeHeight).mul(.9).mul(Q)),Pe.y.assign(Pe.y.mul(_(1).sub(yt.mul(.25).mul(Q)))),Pe.add($)})();let ee=i.baseColor;e.map&&(ee=i.baseColor.mul(Be(new Ee(e.map),Me).rgb));const ie=ae(ee,i.tipColor,i.tipMix.mul(i.useExplicitTipColor));return Z.positionNode=me,Z.colorNode=ae(ee,ie,bt(Q,1.2)).mul(ae(_(.75),_(1.25),re)).mul(ae(_(.82),_(1),Ae)).add(ye(.7,1,Q).mul(.12)),Z.opacityNode=Ae,Z},[r,E,g,G,e.map,i]);n.useEffect(()=>()=>{E.dispose(),V?.dispose()},[E,V]),n.useEffect(()=>{i.baseColor.value.copy(z),i.bladeHeight.value=f,i.curvature.value=R,i.interactorRadius.value=S,i.interactorStrength.value=Y,i.noiseAmplitude.value=O,i.noiseFrequency.value=T,i.tipColor.value.copy(c),i.tipMix.value=y,i.useExplicitTipColor.value=H?1:0,i.waveAmplitude.value=B,i.waveDirection.value.copy(h),i.waveLength.value=A,i.waveSpeed.value=v,i.windStrength.value=P},[f,R,S,Y,O,T,z,c,h,B,y,H,i,A,v,P]);const X=n.useCallback(Z=>{!w||!F.current||(Z.stopPropagation(),k.current.copy(Z.point),F.current.worldToLocal(k.current),i.interactorEnabled.value=1,i.interactorPos.value.copy(k.current))},[w,i]),L=n.useCallback(()=>{i.interactorEnabled.value=0},[i]);return we((Z,$)=>{i.time.value+=$,!G&&e.isSkinnedMesh&&e.mesh&&ua(g,e.mesh)}),g?G&&e.mesh?p.jsx(pr,{alphaTexturePath:t,bladeHeight:s,curvature:R,geometry:g,interactionRadius:D,interactionStrength:Y,interactive:w,noiseAmplitude:C,noiseFrequency:T,rootColor:o,showInteractionSurface:j,source:e,tipColor:u,tipMix:y,waveAmplitude:l,waveDirection:m,waveLength:A,waveSpeed:v,windStrength:P,...M}):p.jsxs(ze,{ref:F,source:e,...M,children:[p.jsx("mesh",{frustumCulled:!1,geometry:g,material:V}),p.jsx(Ue,{onPointerDown:w?X:void 0,onPointerLeave:w?L:void 0,onPointerMove:w?X:void 0,showInteractionSurface:j,source:e})]}):null}function Sr({technique:e=he.strand,sourceGeometry:a=null,sourceMaterial:s=null,sourceMesh:d=null,...t}){const o=ca({sourceGeometry:a,sourceMaterial:s,sourceMesh:d});return o.geometry?e===he.shell?p.jsx(vr,{...t,source:o}):e===he.strand?p.jsx(br,{...t,source:o}):null:null}function da(e){return ea(d=>d.gl)?.isWebGPURenderer===!0?p.jsx(Sr,{...e}):p.jsx(ir,{...e})}const ma=.875,xt=.16;function xr({radius:e=ma,height:a=xt,widthSegments:s=64,heightSegments:d=24}={}){const t=new Ma(e,s,d,0,Math.PI*2,0,Math.PI/2),o=t.getAttribute("position");for(let u=0;u<o.count;u+=1){const y=st.clamp(o.getY(u)/e,0,1);o.setY(u,y*a)}return o.needsUpdate=!0,t.computeVertexNormals(),t.computeBoundingBox(),t.computeBoundingSphere(),t}const yr=n.forwardRef(function({colorDark:a,colorLight:s,floorY:d,geometry:t},o){const u=n.useMemo(()=>{const y=new J(a),R=new J(s),P=t.boundingBox,T=t.boundingSphere?.radius??1,C=P?P.max.y-P.min.y:1,l=new Aa({color:y,metalness:0,roughness:.96});return l.onBeforeCompile=A=>{const v=A;v.uniforms.uPatchDark={value:y.clone()},v.uniforms.uPatchHeight={value:C},v.uniforms.uPatchLight={value:R.clone()},v.uniforms.uPatchRadius={value:T},v.vertexShader=v.vertexShader.replace("#include <common>",`#include <common>
