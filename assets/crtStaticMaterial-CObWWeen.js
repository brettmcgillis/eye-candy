import{r as w,ac as g,j as h,ak as x,ab as F}from"./index-B8ahIfg7.js";import{s as R}from"./shaderMaterial-CKxwg-iH.js";const b=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
`,o=R({uTime:0,uSnowAmount:1,uSnowScale:140,uSnowSpeed:1,uSnowSize:240,uSnap:60,uBandStrength:.35,uBandSpeed:.6,uBandScale:8,uRFStrength:.25,uRFScale:22,uRFSpeed:.4,uCurvature:0,uVignette:1.1},b,B);F({CrtStaticMaterial:o});function M({snowAmount:t=1,snowScale:n=180,snowSpeed:a=1,snowSize:u=240,curvature:r=.12,vignette:i=.75,bandStrength:l=.35,bandSpeed:v=.6,bandScale:c=8,snap:f=24,rfStrength:s=.25,rfScale:S=22,rfSpeed:d=.4,side:p=x}){const e=w.useRef();return g((y,m)=>{e.current&&(e.current.uTime+=m)}),h.jsx("crtStaticMaterial",{ref:e,side:p,transparent:!1,depthWrite:!0,toneMapped:!1,uSnowAmount:t,uSnowScale:n,uSnowSpeed:a,uSnowSize:u,uSnap:f,uBandStrength:l,uBandSpeed:v,uBandScale:c,uRFStrength:s,uRFScale:S,uRFSpeed:d,uCurvature:r,uVignette:i},o.key)}export{M as C};
