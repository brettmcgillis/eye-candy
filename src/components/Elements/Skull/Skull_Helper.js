...
export const Cranium = {
  ...
  show_Right_Parietal: "Show Right Parietal", //X
  show_Right_temporal: "Show Right Temporal", //X
  show_Right_zygomatic: "Show Right Zygomatic",
  show_Sphenoid: "Show Sphenoid",
  show_Teeth: "Show Teeth", //X
  ...
  show_Left_parietal: "Show Left Parietal", //X
  show_Left_temporal: "Show Left Temporal", //X
};
export const Mandible = {
  show_full_mandible: "Show Mandible", //X
