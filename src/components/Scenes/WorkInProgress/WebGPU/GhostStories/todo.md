...
- The water's mesh reacts to the ghost's movement over top of it, like the cursor interaction built into https://github.com/mrdoob/three.js/blob/master/examples/webgpu_compute_water.html
