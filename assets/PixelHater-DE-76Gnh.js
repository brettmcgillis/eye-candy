import{an as me,aq as ce,j as e,r as a,a6 as X,ae as F,a9 as U,aa as _,a7 as M,am as xe,aM as B,aI as re,aU as ve,bn as ye,ac as ne,ai as ae,bi as se,ar as Me,bx as pe,bH as be,ap as Ce,az as we,dg as Pe,by as Se,aW as Q,cC as Te,bt as ke,ab as je}from"./index-B8ahIfg7.js";import{E as ze,I as De,d as We,V as Be}from"./index-DKLXERmT.js";import{C as Re,R as Ve}from"./Record-BRpeST66.js";import{M as Ie}from"./MeshBVH-VRIA-Gya.js";import{O as Ee}from"./OrbitControls-C8yG8xqa.js";import{E as Ue}from"./Environment-pNQvk185.js";import{P as Ge}from"./shapes-BuBk0M1f.js";import"./Gltf-jojXY6t_.js";import"./constants-BP0QNkg_.js";import"./extends-CF3RwP-h.js";function Ne(){const{plPosition:n,plDecay:o,plDistance:i,plIntensity:p,plCastShadow:d,ambientLightIntensity:s}=me("Lighting Rig",{"Point Light":ce({plPosition:{label:"Position",value:{x:3,y:3,z:5}},plDecay:{label:"Decay",value:0,min:-10,max:10,step:.1},plDistance:{label:"Distance",value:-1,min:-10,max:10,step:.1},plIntensity:{label:"Intensity",value:.8,min:0,max:10,step:.1},plCastShadow:{label:"Cast Shadow",value:!0}},{collapsed:!0}),"Ambient Light":ce({ambientLightIntensity:{label:"Intensity",value:0,min:0,max:1,step:.1}},{collapsed:!0})},{collapsed:!0});return e.jsxs("group",{children:[e.jsx("ambientLight",{intensity:s}),e.jsx("pointLight",{position:[n.x,n.y,n.z],decay:o,distance:i,intensity:p,castShadow:d})]})}const Le=`
...
`,$e=new pe(new M(-.5,-.5,-.5),new M(.5,.5,.5)),ue=new WeakMap;function Ye(n){let o=ue.get(n);return o||(o=new Ie(n),ue.set(n,o)),o}function qe(n,o){let i=o;for(;i;){if(i===n)return!0;i=i.parent}return!1}function Xe({voxelSize:n=.25,cornerRadius:o=0,insideOnly:i=!1,maxInstances:p=8192,children:d,...s}){const g=a.useRef(),y=a.useRef(),t=a.useRef(),{gl:r,scene:m,camera:l}=X(),f=a.useMemo(()=>new F(1,1),[]),c=a.useMemo(()=>new U,[]),b=a.useMemo(()=>new _,[]),v=a.useMemo(()=>new B,[]),C=a.useMemo(()=>o>0?new le(1,1,1,4,Math.min(o,.49)):new se(1,1,1),[o]),h=a.useMemo(()=>new re({vertexShader:He,fragmentShader:Ke,uniforms:{fullSceneTexture:{value:null},resolution:{value:new U},fallbackColor:{value:new _(1,1,1)},viewProjectionMatrix:{value:new B}},transparent:!1,depthWrite:!0}),[]);return a.useEffect(()=>{t.current&&(t.current.geometry=C)},[C]),a.useEffect(()=>()=>{f.dispose(),C.dispose(),h.dispose()},[f,C,h]),a.useLayoutEffect(()=>{const x=y.current,w=t.current,R=g.current;if(!x||!w||!R||!x.geometry)return;x.updateWorldMatrix(!0,!1),x.geometry.computeBoundingBox();const u=x.geometry.boundingBox;if(!u)return;const D=u.clone().applyMatrix4(x.matrixWorld),k=new pe,P=[];if(m.traverse(T=>{if(!T.isMesh||!T.visible||!T.geometry||!T.geometry.attributes?.position||qe(R,T)||(T.geometry.boundingBox||T.geometry.computeBoundingBox(),!T.geometry.boundingBox)||(k.copy(T.geometry.boundingBox).applyMatrix4(T.matrixWorld),!k.intersectsBox(D)))return;const O=Ye(T.geometry);P.push({bvh:O,worldToLocal:new B().copy(T.matrixWorld).invert()})}),P.length===0){w.count=0,w.instanceMatrix.needsUpdate=!0;return}const z=Math.max(n,.01),S=u.getSize(new M),V=Math.ceil(S.x/z)*Math.ceil(S.y/z)*Math.ceil(S.z/z),I=Math.max(p*4,2e4),J=V>I?Math.ceil(Math.cbrt(V/I)):1,j=z*J,G=new M,E=new M,N=new B,L=new B,A=new B,ge=new Ce,he=new M().setScalar(j),K=new be;K.direction.set(0,0,1);let $=0,Z=!1;for(let T=u.min.x+j*.5;T<=u.max.x;T+=j){for(let O=u.min.y+j*.5;O<=u.max.y;O+=j){for(let ee=u.min.z+j*.5;ee<=u.max.z;ee+=j){if($>=p){Z=!0;break}G.set(T,O,ee),N.compose(G,ge,he),L.multiplyMatrices(x.matrixWorld,N),E.copy(G),x.localToWorld(E);let Y=!1,oe=!1;for(let te=0;te<P.length;te+=1){const q=P[te];if(A.multiplyMatrices(q.worldToLocal,L),q.bvh.intersectsBox($e,A)&&(Y=!0),!Y||i){K.origin.copy(E).applyMatrix4(q.worldToLocal);const ie=q.bvh.raycastFirst(K,we);ie&&ie.face.normal.dot(K.direction)>0&&(oe=!0)}if(Y&&oe)break}(Y&&!i||oe)&&(w.setMatrixAt($,N),$+=1)}if(Z)break}if(Z)break}w.count=$,w.instanceMatrix.needsUpdate=!0},[n,i,p,m]),ne(()=>{const x=g.current;if(!x)return;r.getDrawingBufferSize(c),(f.width!==c.x||f.height!==c.y)&&f.setSize(c.x,c.y),h.uniforms.resolution.value.copy(c),v.multiplyMatrices(l.projectionMatrix,l.matrixWorldInverse),h.uniforms.viewProjectionMatrix.value.copy(v);const w=r.getRenderTarget(),R=r.toneMapping,u=r.getClearAlpha();r.getClearColor(b),r.toneMapping=ae,m.background&&m.background.isColor?h.uniforms.fallbackColor.value.copy(m.background):h.uniforms.fallbackColor.value.setRGB(1,1,1),x.visible=!1,r.setClearColor(b,u),r.setRenderTarget(f),r.clear(),r.render(m,l),r.setRenderTarget(w),r.toneMapping=R,r.setClearColor(b,u),x.visible=!0,h.uniforms.fullSceneTexture.value=f.texture}),e.jsxs("group",{ref:g,...s,children:[e.jsx("mesh",{ref:y,visible:!1,children:d}),e.jsx("instancedMesh",{ref:t,args:[C,h,p],frustumCulled:!1})]})}function Je({effectShape:n,pixelSize:o,refraction:i,planeWidth:p,planeHeight:d,voxelMode:s,voxelSize:g,voxelSteps:y,cornerRadius:t,insideOnly:r}){const m=s!=="pixel";let l=Re;m&&(s==="voxelInstanced"?l=Qe:s==="voxelInterior"?l=Xe:l=Fe);let f={};m&&(s==="voxelInstanced"?f={voxelSize:g}:s==="voxelInterior"?f={voxelSize:g,cornerRadius:t,insideOnly:r}:f={mode:s,voxelSize:g,voxelSteps:y});const c=m?{pixelSize:o,...f}:{pixelSize:o,refraction:i};return e.jsxs(e.Fragment,{children:[n==="Plane"&&e.jsx(l,{...c,children:e.jsx("planeGeometry",{args:[p,d]})}),n==="TwoPanes"&&e.jsxs(e.Fragment,{children:[e.jsx(l,{...c,position:[.5,.5,0],children:e.jsx("planeGeometry",{args:[1,1]})}),e.jsx(l,{...c,position:[-.5,-.5,0],children:e.jsx("planeGeometry",{args:[1,1]})})]}),n==="Cube"&&e.jsx(l,{...c,children:e.jsx("boxGeometry",{args:[1,1,1]})}),n==="Cubes"&&e.jsx(l,{...c,clipOffset:.5,position:[0,0,1],children:e.jsx("boxGeometry",{args:[1,1,1]})}),n==="Torus"&&e.jsx(l,{...c,children:e.jsx("torusGeometry",{args:[.5,.15,16,100]})}),n==="Sphere"&&e.jsx(l,{...c,children:e.jsx("sphereGeometry",{args:[.4,32,32]})}),n==="Knot"&&e.jsx(l,{...c,children:e.jsx("torusKnotGeometry",{args:[.5,.1,100,16]})})]})}const fe=a.createContext(null);function Ze({children:n}){const o=a.useContext(fe);return o?Pe(e.jsx("group",{children:a.Children.map(n,i=>a.isValidElement(i)?a.cloneElement(i,{material:new Se({color:"white"})}):null)}),o):null}class de extends ze{constructor(o,i,{pixelSize:p=8,maskScene:d}){super("PixelMaskEffect",`
