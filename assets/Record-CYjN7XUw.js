import{cX as t,d6 as Q,cy as T,cq as b,z,cr as S,bn as P,bR as V,S as B,cp as F,d0 as E,cT as v,b8 as N,cV as w}from"./index-CGUqMB6g.js";import{u as y}from"./Gltf-CuQfDIhz.js";const _=`
...
`;function G({pixelSize:s=8,refraction:i=0,clipOffset:c=0,children:p,...k}){const g=t.useRef(),{gl:e,scene:l,camera:d}=Q(),r=t.useMemo(()=>new T(1,1),[]),n=t.useMemo(()=>new T(1,1),[]),a=t.useMemo(()=>new b,[]),m=t.useMemo(()=>new z,[]),x=t.useMemo(()=>new S,[]),C=t.useMemo(()=>new S,[]),f=t.useMemo(()=>new P,[]),o=t.useMemo(()=>new V({vertexShader:_,fragmentShader:j,uniforms:{sceneTexture:{value:null},sceneDepthTexture:{value:null},fullSceneTexture:{value:null},fallbackColor:{value:new z(1,1,1)},resolution:{value:new b},pixelSize:{value:s},refractionStrength:{value:i}},transparent:!1,depthWrite:!0}),[]);return t.useEffect(()=>{r.depthTexture=new B(1,1),r.depthTexture.type=F},[r]),t.useEffect(()=>()=>{r.dispose(),n.dispose(),o.dispose()},[r,n,o]),E(()=>{const u=g.current;if(!u)return;e.getDrawingBufferSize(a),(r.width!==a.x||r.height!==a.y)&&(r.setSize(a.x,a.y),n.setSize(a.x,a.y)),o.uniforms.pixelSize.value=s,o.uniforms.refractionStrength.value=i,o.uniforms.resolution.value.copy(a),u.getWorldPosition(x),d.getWorldDirection(C),f.setFromNormalAndCoplanarPoint(C,x),f.constant+=c,u.visible=!1;const D=e.clippingPlanes,R=e.toneMapping;e.toneMapping=N;const h=e.getClearAlpha();e.getClearColor(m),l.background&&l.background.isColor?o.uniforms.fallbackColor.value.copy(l.background):o.uniforms.fallbackColor.value.setRGB(1,1,1);const M=e.getRenderTarget();e.setClearColor(m,h),e.clippingPlanes=[],e.setRenderTarget(n),e.clear(),e.render(l,d),e.setClearColor(0,0),e.clippingPlanes=[f],e.setRenderTarget(r),e.clear(),e.render(l,d),e.setRenderTarget(M),e.toneMapping=R,e.setClearColor(m,h),e.clippingPlanes=D,u.visible=!0,o.uniforms.sceneTexture.value=r.texture,o.uniforms.sceneDepthTexture.value=r.depthTexture,o.uniforms.fullSceneTexture.value=n.texture}),v.jsx("mesh",{ref:g,material:o,...k,children:p})}function I({sideA:s=!0,...i}){const{nodes:c,materials:p}=y(w("Record.glb"));return v.jsx("group",{...i,dispose:null,children:v.jsx("mesh",{castShadow:!0,receiveShadow:!0,geometry:c["REC33#RECTextures"].geometry,material:p.RECTextures,rotation:[s?0:Math.PI,0,0]})})}y.preload(w("Record.glb"));export{G as C,I as R};
