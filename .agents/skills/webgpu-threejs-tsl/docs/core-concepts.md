...
```javascript
import { bool, float, int, uint } from 'three/tsl';
...
```javascript
import { color, vec2, vec3, vec4 } from 'three/tsl';
...
```javascript
import { Break, Continue, Loop } from 'three/tsl';
...
```javascript
import { oscSawtooth, oscSine, oscSquare, oscTriangle } from 'three/tsl';
...
```javascript
import { abs, ceil, clamp, floor, fract, max, min, mod, sign } from 'three/tsl';
...
```javascript
import { acos, asin, atan, atan2, cos, sin, tan } from 'three/tsl';
...
```javascript
import { exp, inverseSqrt, log, pow, sqrt } from 'three/tsl';
...
```javascript
import { mix, smoothstep, step } from 'three/tsl';
...
```javascript
import { EPSILON, HALF_PI, PI, TWO_PI } from 'three/tsl';
...
```javascript
import { checker, hash, range, remap, rotate } from 'three/tsl';
