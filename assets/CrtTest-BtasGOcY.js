...
`,Te=te({uTime:0,uTextTexture:null,uScreenColor:new Ye(.05,.18,.85),uNoiseStrength:.08,uGlowStrength:.35,uCurvature:.06,uVignette:.85,uScanlineStrength:.08,uScanlineDensity:900,uRollSpeed:.4,uRollStrength:.4,uChromaOffset:.0025},ht,xt);ee({CrtBlueScreenMaterial:Te});function gt(r,l,h,n,o,s){const u=l.split("");let i="";const c=[];return u.forEach(t=>{if(t===`
