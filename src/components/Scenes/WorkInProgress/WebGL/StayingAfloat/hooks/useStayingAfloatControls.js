          ...
          'Ink + Hatch': folder(
            {
              outlineEnabled: {
                label: 'Outline',
                value: DEFAULTS.outlineEnabled,
              },
              outlineStrength: {
                label: 'Outline Strength',
                value: DEFAULTS.outlineStrength,
                min: 0,
                max: 2,
                step: 0.01,
              },
              outlineThreshold: {
                ...
                value: DEFAULTS.outlineThreshold,
                min: 0,
                max: 1,
                step: 0.01,
              },
              outlineSoftness: {
                ...
                value: DEFAULTS.outlineSoftness,
                min: 0.001,
                max: 1,
                step: 0.005,
              },
              hatchingEnabled: {
                label: 'Hatching',
                value: DEFAULTS.hatchingEnabled,
              },
              hatchScale: {
                label: 'Hatch Scale',
                value: DEFAULTS.hatchScale,
                min: 1,
                max: 24,
                step: 0.1,
              },
