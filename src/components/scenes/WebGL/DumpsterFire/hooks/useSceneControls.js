      ...
      Scene: folder(
        {
          ...
          sceneAmbientIntensity: {
            label: 'Ambient',
            value: initialPresetSnapshot.sceneAmbientIntensity,
            min: 0,
            max: 4,
            step: 0.01,
          },
          sceneDirectionalIntensity: {
            label: 'Directional',
            value: initialPresetSnapshot.sceneDirectionalIntensity,
            min: 0,
            max: 4,
            step: 0.01,
          },
          sceneEnvMapIntensity: {
            label: 'Env Map',
            value: initialPresetSnapshot.sceneEnvMapIntensity,
            min: 0,
            max: 4,
            step: 0.01,
          },
...
${allEntries}
  ...
  return {
    ...
    sceneEnvironment: {
      ...
      fogFar: sceneFogFar,
      ambientIntensity: sceneAmbientIntensity,
      directionalIntensity: sceneDirectionalIntensity,
      envMapIntensity: sceneEnvMapIntensity,
    },
