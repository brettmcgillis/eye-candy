/* eslint-disable */
// Vendored from three-sketches (https://github.com/gkjohnson/three-sketches, MIT)
// surface-flow/src/SurfaceWalker.js — verbatim copy.
...
export class SurfaceWalker {
  ...
  movePoint(
    ...
    while (dist > 0) {
      ...
      const index = halfEdgeMap.getSiblingTriangleIndex(
        targetPoint.index,
        edgeIndex
      );
