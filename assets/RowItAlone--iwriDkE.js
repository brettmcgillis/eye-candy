import{aN as de,aG as te,V as f,aW as le,b1 as O,c_ as Y,K as pe,aS as re,t as he,ax as ae,B as ve,b0 as me,am as xe,aF as ge,M as U,c$ as m,d0 as T,H as q,a8 as we,a6 as z,bj as b,a1 as _,n as M,r as E,o as ye,y as ze,E as y,j as D}from"./index-C4dhyc_M.js";import{ae as l,af as I,u as i,j as be,r as d,W as B,a0 as x,ag as s,a1 as o,ah as L,ai as P,aj as F}from"./three.tsl-CyZb892l.js";import{P as De}from"./PerspectiveCamera-C-jwo_7i.js";import{O as Se}from"./OrbitControls-TJUen-Cn.js";import"./extends-CF3RwP-h.js";import"./Fbo-BBxYtyT-.js";class Be{constructor(e){this.params=e,this.init(e)}destroy(){this.params.group.remove(this.mesh),this.geometry.dispose()}hide(){this.mesh.visible=!1}show(){this.mesh.visible=!0}init(e){this.geometry=new de,this.mesh=new te(this.geometry,e.material);const r=new f(e.offset.x,e.offset.y);r.applyMatrix4(e.transform),this.geometry.boundingSphere=new le(r,e.lod>3?e.width*1.75:e.width*3),this.mesh.castShadow=!1,this.mesh.layers.set(e.layer),this.mesh.receiveShadow=!0,e.group.add(this.mesh)}rebuildMeshFromData(e){this.geometry.setAttribute("position",new O(e.positions,3)),this.geometry.setAttribute("normal",new O(e.normals,3)),this.geometry.setAttribute("vindex",new Y(e.vindices,1)),this.geometry.setAttribute("width",new O(e.width,1)),this.geometry.setAttribute("lod",new Y(e.lod,1)),this.geometry.setIndex(new pe(e.indices,1)),this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.normal.needsUpdate=!0,this.geometry.attributes.vindex.needsUpdate=!0,this.geometry.attributes.width.needsUpdate=!0,this.geometry.attributes.lod.needsUpdate=!0}}const S=new f,X=new f,N=new f,Z=new f,p=new f,K=new f;function Ie(t){const e=[];for(let r=0;r<t;r+=1)for(let a=0;a<t;a+=1)e.push(r*(t+1)+a,(r+1)*(t+1)+a+1,r*(t+1)+a+1),e.push((r+1)*(t+1)+a,(r+1)*(t+1)+a+1,r*(t+1)+a);return e}function _e(t,e){const r=new Array(t.length).fill(0);for(let a=0;a<e.length;a+=3){const n=e[a]*3,u=e[a+1]*3,h=e[a+2]*3;X.fromArray(t,n),N.fromArray(t,u),Z.fromArray(t,h),p.subVectors(Z,N),K.subVectors(X,N),p.cross(K),r[n]+=p.x,r[u]+=p.x,r[h]+=p.x,r[n+1]+=p.y,r[u+1]+=p.y,r[h+1]+=p.y,r[n+2]+=p.z,r[u+2]+=p.z,r[h+2]+=p.z}return r}function Le({lod:t,offset:e,resolution:r,width:a,worldMatrix:n}){const u=[],h=[],c=[],v=[],g=a/2;let w=0;for(let R=0;R<=r;R+=1){const ce=a*R/r;for(let A=0;A<=r;A+=1){const ue=a*A/r;S.set(ce-g,ue-g,0),S.add(e),S.applyMatrix4(n),u.push(S.x,S.y,S.z),h.push(w),c.push(a),v.push(t),w+=1}}const V=Ie(r),fe=_e(u,V);return{indices:Uint32Array.from(V),lod:Uint32Array.from(v),normals:Float32Array.from(fe),positions:Float32Array.from(u),vindices:Uint32Array.from(h),width:Float32Array.from(c)}}const Pe=15,ke=36,ie=I("vec3","rowItAloneDisplacedPosition"),se=I("vec3","rowItAloneMorphedPosition"),ne=I("vec3","rowItAloneCascadeScales"),Ce=I("vec2","rowItAloneTexelCoord0"),Re=I("vec2","rowItAloneTexelCoord1"),Ae=I("vec2","rowItAloneTexelCoord2"),Oe=l(`
...
`);class Fe extends te{constructor(){const e={position:B("position"),normal:B("normal"),turbidity:i(10),rayleigh:i(3),mieCoefficient:i(.005),mieDirectionalG:i(.7),elevation:i(2),sunPosition:i(new f(0,0,0)),up:i(new f(0,1,0)),cameraPosition:i(new f(0,0,0))},r=new re;r.colorNode=Ee(e),r.side=ve,r.colorSpace=ae,super(new me(1,1,1),r),this.parameters=e}}const J=new f,$=new f,W=new f,G=new f,Ne=160,oe=192,We=2;function Ge(t={}){return{patchResolution:Math.max(We,Math.round(t.patchResolution??oe)),patchSize:t.patchSize??Ne}}class je{constructor(e){this.params=e,this.currentConfig=null,this.patch=null,this.patchSignature="",this.patchTransform=new xe().makeRotationX(-Math.PI/2),this.sun=new f}init(){const e=new Me({foamStrength:this.params.waveGenerator.foamStrength,foamThreshold:this.params.waveGenerator.foamThreshold,ifftResolution:this.params.waveGenerator.size,gridResolution:oe,lodScale:this.params.waveGenerator.lodScale,morphBlend:0,cascades:this.params.waveGenerator.cascades,sunPosition:this.sun});this.material=e.material,this.materialParameters=e.parameters,this.group=new ge,this.params.scene.add(this.group),this.sky=new Fe,this.sky.layers.set(2),this.sky.scale.setScalar(5e5),this.params.scene.add(this.sky),this.ensurePatch()}ensurePatch(e){const{patchResolution:r,patchSize:a}=Ge(e),n=`${a}:${r}`;this.patchSignature!==n&&(this.patch?.destroy(),W.set(0,0,0),this.patch=new Be({group:this.group,layer:this.params.layer,lod:0,material:this.material,offset:W.clone(),transform:this.patchTransform,width:a}),this.patch.rebuildMeshFromData(Le({lod:0,offset:W,resolution:r,width:a,worldMatrix:this.patchTransform})),this.patch.show(),this.materialParameters.gridResolution.value=r,this.patchSignature=n)}applyConfig(e){if(this.currentConfig=e,!e)return;this.ensurePatch(e.ocean),this.material.wireframe=e.ocean.wireframe,this.params.waveGenerator.setFoamStrength(e.foam.foamStrength),this.params.waveGenerator.setFoamThreshold(e.foam.foamThreshold),this.params.waveGenerator.setLodScale(e.ocean.lodScale),this.sky.parameters.rayleigh.value=e.sky.rayleigh,this.sky.parameters.turbidity.value=e.sky.turbidity,this.sky.parameters.mieCoefficient.value=e.sky.mieCoefficient,this.sky.parameters.mieDirectionalG.value=e.sky.mieDirectionalG,this.sky.parameters.elevation.value=e.sky.elevation,this.sky.parameters.up.value.fromArray(e.sky.up);const r=U.degToRad(90-e.sky.elevation),a=U.degToRad(e.sky.azimuth);this.sun.setFromSphericalCoords(1,r,a),this.sky.parameters.sunPosition.value.copy(this.sun),typeof e.sky.exposure=="number"&&(this.params.renderer.toneMappingExposure=e.sky.exposure)}update(e=this.params.camera){this.params.camera=e,this.params.camera.getWorldPosition(J),this.params.scene.getWorldPosition($),G.subVectors(J,$),this.sky.parameters.cameraPosition.value.copy(G),this.patch&&(this.patch.show(),this.patch.mesh.material.wireframe=this.currentConfig?.ocean?.wireframe??!1),this.materialParameters.cameraPosition.value.copy(G),this.materialParameters.sunPosition.value.copy(this.sun)}dispose(){this.patch?.destroy(),this.patch=null,this.patchSignature="",this.params.scene.remove(this.group),this.params.scene.remove(this.sky),this.material.dispose(),this.sky.geometry.dispose(),this.sky.material.dispose()}}const He=l(`
...
`);class $e{constructor(e){this.params=e,this.init(e)}init(e){this.squareSize=e.size**2,this.bufferSize=this.squareSize*4,this.spectrumBuffer=new m(new Float32Array(this.bufferSize),4),this.waveDataBuffer=new m(new Float32Array(this.bufferSize),4),this.initialSpectrum=Ke({spectrumBuffer:s(this.spectrumBuffer,"vec4",this.spectrumBuffer.count),waveDataBuffer:s(this.waveDataBuffer,"vec4",this.waveDataBuffer.count),index:x,size:e.size,waveLength:i(e.lengthScale),boundaryLow:i(e.boundaryLow),boundaryHigh:i(e.boundaryHigh),...e.waveSettings}).compute(this.squareSize),this.initialSpectrumWithInverse=Je({spectrumBuffer:s(this.spectrumBuffer,"vec4",this.spectrumBuffer.count),index:x,size:e.size}).compute(this.squareSize),e.renderer.compute(this.initialSpectrum),e.renderer.compute(this.initialSpectrumWithInverse)}update(){this.params.renderer.compute(this.initialSpectrum),this.params.renderer.compute(this.initialSpectrumWithInverse)}dispose(){this.spectrumBuffer?.dispose?.(),this.waveDataBuffer?.dispose?.()}}const Qe=[16,16,1],et=[250,17,5],tt=[.9,.9,.9],C=Object.freeze({Low:Object.freeze({resolution:128}),Medium:Object.freeze({resolution:256}),High:Object.freeze({resolution:512})}),k="Medium";C[k].resolution;const rt=i(.8),at=i(2.7),it=i(3.7);function st(t=k){return C[t]||C[k]}const j={depth:i(20),scaleHeight:i(1),windSpeed:i(1),windDirection:i(0),fetch:i(1e5),spreadBlend:i(1),swell:i(.198),peakEnhancement:i(3.3),shortWaveFade:i(0),fadeLimit:i(0)},nt={depth:{min:.1,max:100},scaleHeight:{min:0,max:1},windSpeed:{min:.01,max:10},windDirection:{min:0,max:2*Math.PI},fetch:{min:10,max:5e5},spreadBlend:{min:0,max:1},swell:{min:0,max:1},peakEnhancement:{min:1,max:5},shortWaveFade:{min:0,max:5},fadeLimit:{min:0,max:1}},H={d_depth:i(20),d_scaleHeight:i(1),d_windSpeed:i(1),d_windDirection:i(240/360*2*Math.PI),d_fetch:i(3e5),d_spreadBlend:i(1),d_swell:i(.5),d_peakEnhancement:i(3.3),d_shortWaveFade:i(0),d_fadeLimit:i(0)},ot={d_depth:{min:.1,max:100},d_scaleHeight:{min:0,max:1},d_windSpeed:{min:.01,max:10},d_windDirection:{min:0,max:2*Math.PI},d_fetch:{min:10,max:5e5},d_spreadBlend:{min:0,max:1},d_swell:{min:0,max:1},d_peakEnhancement:{min:1,max:5},d_shortWaveFade:{min:0,max:5},d_fadeLimit:{min:0,max:1}};class ft{constructor(e){this.init(e)}init(e){this.params=e,this.logN=Math.log2(e.size),this.squareSize=e.size**2,this.bufferSize=this.squareSize*2,this.initialSpectrum=new $e(e),this.spectrumBuffer=this.initialSpectrum.spectrumBuffer,this.waveDataBuffer=this.initialSpectrum.waveDataBuffer,this.dxDzBuffer=new m(new Float32Array(this.bufferSize),2),this.dyDxzBuffer=new m(new Float32Array(this.bufferSize),2),this.dyxDyzBuffer=new m(new Float32Array(this.bufferSize),2),this.dxxDzzBuffer=new m(new Float32Array(this.bufferSize),2),this.pingpongBuffer=new m(new Float32Array(this.bufferSize*2),4),this.turbulenceBuffer=new m(new Float32Array(this.bufferSize/2),1),this.displacementIndex=i(0),this.ifftStep=i(0),this.pingpong=i(0),this.deltaTime=i(0),this.displacement=new T(e.size,e.size),this.derivative=new T(e.size,e.size),this.jacobian=new T(e.size,e.size),this.displacement.type=q,this.derivative.type=q,this.jacobian.type=we,this.displacement.generateMipmaps=!1,this.derivative.generateMipmaps=!1,this.jacobian.generateMipmaps=!1,this.displacement.magFilter=z,this.derivative.magFilter=z,this.jacobian.magFilter=z,this.displacement.minFilter=z,this.derivative.minFilter=z,this.jacobian.minFilter=z,this.displacement.wrapS=b,this.displacement.wrapT=b,this.derivative.wrapS=b,this.derivative.wrapT=b,this.jacobian.wrapS=b,this.jacobian.wrapT=b,this.workgroupSize=Qe,this.dispatchSize=[e.size/this.workgroupSize[0],e.size/this.workgroupSize[1]],this.computeTimeSpectrum=Ve({writeDxDzBuffer:s(this.dxDzBuffer,"vec2",this.dxDzBuffer.count),writeDyDxzBuffer:s(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count),writeDyxDyzBuffer:s(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count),writeDxxDzzBuffer:s(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count),spectrumBuffer:s(this.spectrumBuffer,"vec4",this.spectrumBuffer.count),waveDataBuffer:s(this.waveDataBuffer,"vec4",this.waveDataBuffer.count),index:x,size:o(e.size),time:i(0)}).computeKernel(this.workgroupSize),this.computeInitialize=qe({size:o(e.size),step:o(this.ifftStep),logN:o(this.logN),butterflyBuffer:s(e.butterflyBuffer,"vec4",e.butterflyBuffer.count).toReadOnly(),DxDzBuffer:s(this.dxDzBuffer,"vec2",this.dxDzBuffer.count).toReadOnly(),DyDxzBuffer:s(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count).toReadOnly(),DyxDyzBuffer:s(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count).toReadOnly(),DxxDzzBuffer:s(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count).toReadOnly(),pingpongBuffer:s(this.pingpongBuffer,"vec4",this.pingpongBuffer.count),initBufferIndex:o(this.displacementIndex),index:x,workgroupSize:i(new _().fromArray(this.workgroupSize)),workgroupId:P,localId:L}).computeKernel(this.workgroupSize),this.computeHorizontalPingPong=Ye({size:o(e.size),step:o(this.ifftStep),logN:o(this.logN),butterflyBuffer:s(e.butterflyBuffer,"vec4",e.butterflyBuffer.count).toReadOnly(),pingpongBuffer:s(this.pingpongBuffer,"vec4",this.pingpongBuffer.count),initBufferIndex:o(this.displacementIndex),pingpong:o(this.pingpong),index:x,workgroupSize:i(new _().fromArray(this.workgroupSize)),workgroupId:P,localId:L}).computeKernel(this.workgroupSize),this.computeVerticalPingPong=Ue({size:o(e.size),step:o(this.ifftStep),logN:o(this.logN),butterflyBuffer:s(e.butterflyBuffer,"vec4",e.butterflyBuffer.count).toReadOnly(),pingpongBuffer:s(this.pingpongBuffer,"vec4",this.pingpongBuffer.count),initBufferIndex:o(this.displacementIndex),pingpong:o(this.pingpong),index:x,workgroupSize:i(new _().fromArray(this.workgroupSize)),workgroupId:P,localId:L}).computeKernel(this.workgroupSize),this.computePermute=Xe({size:o(e.size),pingpongBuffer:s(this.pingpongBuffer,"vec4",this.pingpongBuffer.count).toReadOnly(),DxDzBuffer:s(this.dxDzBuffer,"vec2",this.dxDzBuffer.count),DyDxzBuffer:s(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count),DyxDyzBuffer:s(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count),DxxDzzBuffer:s(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count),initBufferIndex:o(this.displacementIndex),index:x,workgroupSize:i(new _().fromArray(this.workgroupSize)),workgroupId:P,localId:L}).computeKernel(this.workgroupSize),this.computeMergeTextures=Ze({size:o(e.size),index:x,lambda:i(e.lambda),deltaTime:this.deltaTime,DxDzBuffer:s(this.dxDzBuffer,"vec2",this.dxDzBuffer.count).toReadOnly(),DyDxzBuffer:s(this.dyDxzBuffer,"vec2",this.dyDxzBuffer.count).toReadOnly(),DyxDyzBuffer:s(this.dyxDyzBuffer,"vec2",this.dyxDyzBuffer.count).toReadOnly(),DxxDzzBuffer:s(this.dxxDzzBuffer,"vec2",this.dxxDzzBuffer.count).toReadOnly(),turbulenceBuffer:s(this.turbulenceBuffer,"float",this.turbulenceBuffer.count),writeDisplacement:F(this.displacement),writeDerivative:F(this.derivative),writeJacobian:F(this.jacobian),workgroupSize:i(new _().fromArray(this.workgroupSize)),workgroupId:P,localId:L}).computeKernel(this.workgroupSize)}update(e){this.computeTimeSpectrum.computeNode.parameters.time.value=performance.now()/1e3,this.params.renderer.compute(this.computeTimeSpectrum,this.dispatchSize),this.ifft(0),this.ifft(1),this.ifft(2),this.ifft(3),this.deltaTime.value=e,this.params.renderer.compute(this.computeMergeTextures,this.dispatchSize)}ifft(e){this.displacementIndex.value=e;let r=!0;this.ifftStep.value=0,this.params.renderer.compute(this.computeInitialize,this.dispatchSize);for(let a=1;a<this.logN;a+=1)r=!r,this.ifftStep.value=a,this.pingpong.value=r?1:0,this.params.renderer.compute(this.computeHorizontalPingPong,this.dispatchSize);for(let a=0;a<this.logN;a+=1)r=!r,this.ifftStep.value=a,this.pingpong.value=r?1:0,this.params.renderer.compute(this.computeVerticalPingPong,this.dispatchSize);this.params.renderer.compute(this.computePermute,this.dispatchSize)}dispose(){this.displacement?.dispose?.(),this.derivative?.dispose?.(),this.jacobian?.dispose?.(),this.initialSpectrum?.dispose?.()}}class ct{constructor(e){this.params=e,this.quality=e.quality??k}init(){this.qualityPreset=st(this.quality),this.size=this.qualityPreset.resolution,this.butterflyBuffer=new m(new Float32Array(Math.log2(this.size)*this.size*4),4),this.butterfly=He({butterflyBuffer:s(this.butterflyBuffer,"vec4",this.butterflyBuffer.count),index:x,N:this.size}).compute(Math.log2(this.size)*this.size),this.params.renderer.compute(this.butterfly),this.waveSettings={...j,...H},this.cascades=[],this.foamStrength=rt,this.foamThreshold=at,this.waveLengths=et,this.lambda=tt,this.lodScale=it,this.initCascades()}initCascades(){this.cascades.length=0;let e=1e-4;for(let r=0;r<this.waveLengths.length;r+=1){const a=r<this.waveLengths.length-1?2*Math.PI/this.waveLengths[r+1]*6:9999;this.cascades.push(new ft({...this.params,...this.getCascadeParams(r,e,a)})),e=a}}getCascadeParams(e,r,a){return{boundaryHigh:a,boundaryLow:r,butterflyBuffer:this.butterflyBuffer,lambda:this.lambda[e],lengthScale:this.waveLengths[e],size:this.size,waveSettings:this.waveSettings}}setFoamStrength(e){this.foamStrength.value=e}setFoamThreshold(e){this.foamThreshold.value=e}setLodScale(e){this.lodScale.value=e}applyWaveSettings(e){if(!e)return;let r=!1;Object.entries(e).forEach(([a,n])=>{Object.prototype.hasOwnProperty.call(this.waveSettings,a)&&this.waveSettings[a].value!==n&&(this.waveSettings[a].value=n,r=!0)}),r&&this.cascades.forEach(a=>{a.initialSpectrum.update()})}update(e){this.cascades.forEach(r=>{r.update(e)})}dispose(){this.cascades.forEach(e=>{e.dispose?.()}),this.cascades=[],this.butterflyBuffer?.dispose?.()}}function ut(t){return 1e3/Math.max(1,t?.performance?.waveUpdateHz??30)}function dt({config:t}){const e=M(c=>c.camera),r=M(c=>c.gl),a=M(c=>c.scene),n=E.useRef(null),u=E.useRef(0),h=t?.performance?.quality;return E.useEffect(()=>{if(!r?.isWebGPURenderer)return;const c=new ct({quality:h,renderer:r});c.init();const v=new je({camera:e,layer:0,renderer:r,scene:a,waveGenerator:c});return v.init(),v.applyConfig(t),n.current={oceanManager:v,waveGenerator:c},()=>{u.current=0,n.current=null,v.dispose(),c.dispose?.()}},[e,r,h,a]),ye((c,v)=>{const g=n.current;if(!g)return;const w=ut(t);for(g.waveGenerator.applyWaveSettings(t.waveSettings),g.oceanManager.applyConfig(t),u.current=Math.min(u.current+v*1e3,w*3);u.current>=w;)g.waveGenerator.update(w),u.current-=w;g.oceanManager.update(c.camera)}),null}function Q(t,e,r){return Object.fromEntries(Object.entries(e).map(([a,n])=>[`${t}${a}`,{label:a,max:r[a].max,min:r[a].min,value:n.value}]))}function ee(t,e,r){return Object.fromEntries(Object.keys(r).map(a=>[a,t[`${e}${a}`]]))}function lt(){const t=ze("Row It Alone WebGPU",{Camera:y({camX:{label:"X",value:30,min:-200,max:200,step:.1},camY:{label:"Y",value:20,min:1,max:200,step:.1},camZ:{label:"Z",value:30,min:-200,max:200,step:.1},targetX:{label:"Target X",value:0,min:-100,max:100,step:.1},targetY:{label:"Target Y",value:0,min:-50,max:50,step:.1},targetZ:{label:"Target Z",value:0,min:-100,max:100,step:.1},fov:{value:50,min:20,max:90,step:1},minDistance:{value:10,min:1,max:200,step:1},maxDistance:{value:1200,min:50,max:1e4,step:10}},{collapsed:!0}),Sky:y({elevation:{value:2,min:0,max:90,step:.1},azimuth:{value:180,min:-180,max:180,step:.1},exposure:{value:1,min:.05,max:2.5,step:.01},rayleigh:{value:3,min:0,max:4,step:.001},turbidity:{value:10,min:1,max:20,step:.1},mieCoefficient:{value:.005,min:0,max:.02,step:1e-4},mieDirectionalG:{value:.7,min:0,max:1,step:.001}},{collapsed:!0}),"First Wave Spectrum":y(Q("first_",j,nt),{collapsed:!0}),"Second Wave Spectrum":y(Q("second_",H,ot),{collapsed:!0}),Foam:y({foamStrength:{value:.8,min:0,max:5,step:.1},foamThreshold:{value:2.7,min:0,max:5,step:.1}},{collapsed:!0}),Ocean:y({patchSize:{value:160,min:20,max:1e3,step:1},patchResolution:{value:192,min:16,max:512,step:1},wireframe:!1,lodScale:{value:3.7,min:0,max:20,step:.1}},{collapsed:!1}),Performance:y({quality:{options:Object.keys(C),value:k},waveUpdateHz:{value:30,min:5,max:60,step:1}},{collapsed:!0})});return{camera:{fov:t.fov,maxDistance:t.maxDistance,minDistance:t.minDistance,position:[t.camX,t.camY,t.camZ],target:[t.targetX,t.targetY,t.targetZ]},ocean:{lodScale:t.lodScale,patchResolution:t.patchResolution,patchSize:t.patchSize,wireframe:t.wireframe},foam:{foamStrength:t.foamStrength,foamThreshold:t.foamThreshold},sky:{azimuth:t.azimuth,elevation:t.elevation,exposure:t.exposure,mieCoefficient:t.mieCoefficient,mieDirectionalG:t.mieDirectionalG,rayleigh:t.rayleigh,turbidity:t.turbidity,up:[0,1,0]},performance:{quality:t.quality,waveUpdateHz:t.waveUpdateHz},waveSettings:{...ee(t,"first_",j),...ee(t,"second_",H)}}}function wt(){const t=lt();return D.jsxs(D.Fragment,{children:[D.jsx(De,{makeDefault:!0,position:t.camera.position,fov:t.camera.fov,near:.1,far:1e6}),D.jsx(Se,{makeDefault:!0,target:t.camera.target,minDistance:t.camera.minDistance,maxDistance:t.camera.maxDistance,maxPolarAngle:Math.PI*.495}),D.jsx("color",{attach:"background",args:["#87ceeb"]}),D.jsx(dt,{config:t})]})}export{wt as default};
