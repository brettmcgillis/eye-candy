import{s as ye,V as J,v as te,G as D,r as C,C as le,g as be,F as Se,b as ve,j as W,e as Ce,w as Te,Y as ze,aK as Be,a as Re,t as pe,ba as Me,a7 as Ee,W as ie,c as we,aL as Ae,az as Ge,I as H}from"./index-B4YcrCIe.js";import{b as De,d as oe,a as _e}from"./Line2-l5P3OEaA.js";import{u as xe}from"./Texture-DU49_Bb6.js";import{u as I}from"./Fbo-BHMYgkbP.js";class k extends ye{constructor(e=(o,s,n)=>n.set(o,s,Math.cos(o)*Math.sin(s)),a=8,r=8){super(),this.type="ParametricGeometry",this.parameters={func:e,slices:a,stacks:r};const o=[],s=[],n=[],u=[],i=1e-5,l=new J,c=new J,f=new J,m=new J,x=new J,d=a+1;for(let g=0;g<=r;g++){const p=g/r;for(let b=0;b<=a;b++){const y=b/a;e(y,p,c),s.push(c.x,c.y,c.z),y-i>=0?(e(y-i,p,f),m.subVectors(c,f)):(e(y+i,p,f),m.subVectors(f,c)),p-i>=0?(e(y,p-i,f),x.subVectors(c,f)):(e(y,p+i,f),x.subVectors(f,c)),l.crossVectors(m,x).normalize(),n.push(l.x,l.y,l.z),u.push(y,p)}}for(let g=0;g<r;g++)for(let p=0;p<a;p++){const b=g*d+p,y=g*d+p+1,E=(g+1)*d+p+1,w=(g+1)*d+p;o.push(b,y,w),o.push(y,E,w)}this.setIndex(o),this.setAttribute("position",new te(s,3)),this.setAttribute("normal",new te(n,3)),this.setAttribute("uv",new te(u,2))}}function ue(t,e,a){const r=a.length-t-1;if(e>=a[r])return r-1;if(e<=a[t])return t;let o=t,s=r,n=Math.floor((o+s)/2);for(;e<a[n]||e>=a[n+1];)e<a[n]?s=n:o=n,n=Math.floor((o+s)/2);return n}function ce(t,e,a,r){const o=[],s=[],n=[];o[0]=1;for(let u=1;u<=a;++u){s[u]=e-r[t+1-u],n[u]=r[t+u]-e;let i=0;for(let l=0;l<u;++l){const c=n[l+1],f=s[u-l],m=o[l]/(c+f);o[l]=i+c*m,i=f*m}o[u]=i}return o}function We(t,e,a,r,o,s,n,u){const i=ue(t,s,a),l=ue(e,n,r),c=ce(i,s,t,a),f=ce(l,n,e,r),m=[];for(let d=0;d<=e;++d){m[d]=new D(0,0,0,0);for(let g=0;g<=t;++g){const p=o[i-t+g][l-e+d].clone(),b=p.w;p.x*=b,p.y*=b,p.z*=b,m[d].add(p.multiplyScalar(c[g]))}}const x=new D(0,0,0,0);for(let d=0;d<=e;++d)x.add(m[d].multiplyScalar(f[d]));x.divideScalar(x.w),u.set(x.x,x.y,x.z)}class re{constructor(e,a,r,o,s){this.degree1=e,this.degree2=a,this.knots1=r,this.knots2=o,this.controlPoints=[];const n=r.length-e-1,u=o.length-a-1;for(let i=0;i<n;++i){this.controlPoints[i]=[];for(let l=0;l<u;++l){const c=s[i][l];this.controlPoints[i][l]=new D(c.x,c.y,c.z,c.w)}}}getPoint(e,a,r){const o=this.knots1[0]+e*(this.knots1[this.knots1.length-1]-this.knots1[0]),s=this.knots2[0]+a*(this.knots2[this.knots2.length-1]-this.knots2[0]);We(this.degree1,this.degree2,this.knots1,this.knots2,this.controlPoints,o,s,r)}}Ce({Line2:_e});const qe=[{dx:.6,dz:.8,freq:1.2,amp:1},{dx:-.4,dz:.9,freq:2.5,amp:.4},{dx:.9,dz:-.3,freq:3.8,amp:.2},{dx:-.7,dz:-.6,freq:5,amp:.1}],Y=qe.map(t=>{const e=Math.sqrt(t.dx*t.dx+t.dz*t.dz);return{dx:t.dx/e,dz:t.dz/e,freq:t.freq,amp:t.amp}});let ae=0;function fe(t,e,a,r,o){let s=0;for(let n=0;n<Y.length;n+=1){const{dx:u,dz:i,freq:l,amp:c}=Y[n],f=c*a,m=o*l,x=(u*t+i*e)*l+ae*m;s+=f*Math.cos(x)}return s}function rt(t,e,a,r,o){let s=0,n=1,u=0;for(let l=0;l<Y.length;l+=1){const{dx:c,dz:f,freq:m,amp:x}=Y[l],d=x*a,g=r/(m*d*Y.length),p=o*m,b=(c*t+f*e)*m+ae*p,y=Math.sin(b),E=Math.cos(b),w=m*d;s-=c*w*y,u-=f*w*y,n-=g*w*E}const i=Math.sqrt(s*s+n*n+u*u);return{x:s/i,y:n/i,z:u/i}}const Ne=`
  uniform float uTime;
...
`;function Ve(t,e,a){const r=[0,0,0,0,1,1,1,1],o=[t,t/3,-t/3,-t],s=[-e,-e/3,e/3,e],n=o.map(u=>s.map(i=>new D(u,a,i,1)));return new re(3,3,r,r,n)}function Le(t,e,a){const r=[0,0,0,0,1,1,1,1],o=[-t,-t/3,t/3,t],s=[-e,-e/3,e/3,e],n=o.map(u=>s.map(i=>new D(u,a,i,1)));return new re(3,3,r,r,n)}function Z(t,e,a,r){const o=[0,0,0,0,1,1,1,1],s=[0,0,0,1,1,1],n=(a+r)/2,u=t.map(i=>{const l=e(i,a),c=e(i,r);return[new D(l.x,l.y,l.z,1),new D((l.x+c.x)/2,n,(l.z+c.z)/2,1),new D(c.x,c.y,c.z,1)]});return new re(3,2,o,s,u)}function je({width:t,depth:e,height:a}){const r=t/2,o=e/2,s=a/2,n=-a/2;return{top:Ve(r,o,s),bottom:Le(r,o,n),front:Z([-r,-r/3,r/3,r],(u,i)=>({x:u,y:i,z:o}),n,s),back:Z([r,r/3,-r/3,-r],(u,i)=>({x:u,y:i,z:-o}),n,s),right:Z([o,o/3,-o/3,-o],(u,i)=>({x:r,y:i,z:u}),n,s),left:Z([-o,-o/3,o/3,o],(u,i)=>({x:-r,y:i,z:u}),n,s)}}function Je(t,e,a,r){const o=Math.max(8,Math.round(e*(a/r))),s=Math.max(4,Math.round(e/4)),n=u=>(i,l,c)=>u.getPoint(i,l,c);return[new k(n(t.top),e,e),new k(n(t.bottom),s,s),new k(n(t.front),e,o),new k(n(t.back),e,o),new k(n(t.right),e,o),new k(n(t.left),e,o)]}const ee=32;function He(t,e,a,r){const o=new oe;o.setPositions([-t,r,-e,t,r,-e,t,r,e,-t,r,e,-t,r,-e]);const n=[[-t,-e],[t,-e],[t,e],[-t,e]].map(([l,c])=>{const f=new oe;return f.setPositions([l,r,c,l,a,c]),{geo:f,cx:l,cz:c}}),i=[{x0:-t,z0:-e,x1:t,z1:-e},{x0:t,z0:-e,x1:t,z1:e},{x0:t,z0:e,x1:-t,z1:e},{x0:-t,z0:e,x1:-t,z1:-e}].map(l=>{const c=[];for(let m=0;m<=ee;m+=1){const x=m/ee;c.push(l.x0+(l.x1-l.x0)*x,a,l.z0+(l.z1-l.z0)*x)}const f=new oe;return f.setPositions(c),{geo:f,edge:l}});return{bottomGeo:o,vertGeos:n,topGeos:i}}function at({width:t=3.6,depth:e=3.6,height:a=6,segments:r=24,topColor:o="#9edff0",bottomColor:s="#246f98",opacity:n=.34,transmission:u=.5,roughness:i=.3,ior:l=1.12,thickness:c=.35,waveHeight:f=.15,waveChoppiness:m=.5,waveSpeed:x=.6,edgeColor:d="#1f4455",edgeOpacity:g=.65,edgeLineWidth:p=1,showEdges:b=!0}){const y=C.useRef(0),E=C.useMemo(()=>({uTime:{value:y.current},uWaveHeight:{value:f},uWaveChoppiness:{value:m},uWaveSpeed:{value:x},uColumnTop:{value:a/2},uColumnBottom:{value:-a/2},uTopColor:{value:new le(o)},uBottomColor:{value:new le(s)}}),[o,s,a]),w=C.useMemo(()=>{const T=je({width:t,depth:e,height:a});return Je(T,r,a,Math.max(t,e))},[t,e,a,r]),F=C.useMemo(()=>{const T=new be({transparent:!0,opacity:n,transmission:u,roughness:i,metalness:0,ior:l,thickness:c,side:Se,depthWrite:!0});return T.onBeforeCompile=M=>{const z=M;Object.entries(E).forEach(([q,A])=>{z.uniforms[q]=A}),z.vertexShader=z.vertexShader.replace("#include <common>",Oe),z.vertexShader=z.vertexShader.replace("#include <beginnormal_vertex>",Ue),z.vertexShader=z.vertexShader.replace("#include <begin_vertex>",ke),z.fragmentShader=z.fragmentShader.replace("#include <common>",`#include <common>
${Pe}`),z.fragmentShader=z.fragmentShader.replace("#include <color_fragment>",Fe)},T},[E,n,u,i,l,c]),B=C.useMemo(()=>{if(!b)return null;const T=t/2,M=e/2;return He(T,M,a/2,-a/2)},[b,t,a,e]),R=C.useMemo(()=>new De({transparent:!0,depthTest:!0,depthWrite:!1,toneMapped:!1}),[]);return ve((T,M)=>{if(y.current+=M,E.uTime.value=y.current,E.uWaveHeight.value=f,E.uWaveChoppiness.value=m,E.uWaveSpeed.value=x,ae=y.current,b&&R&&(R.color.set(d),R.opacity=g,R.linewidth=p,R.resolution.set(T.size.width,T.size.height)),B){const z=a/2,q=-a/2;B.topGeos.forEach(({geo:A,edge:h})=>{const _=[];for(let G=0;G<=ee;G+=1){const S=G/ee,N=h.x0+(h.x1-h.x0)*S,O=h.z0+(h.z1-h.z0)*S,U=fe(N,O,f,m,x);_.push(N,z+U,O)}A.setPositions(_)}),B.vertGeos.forEach(({geo:A,cx:h,cz:_})=>{const G=fe(h,_,f,m,x);A.setPositions([h,q,_,h,z+G,_])})}}),W.jsxs("group",{children:[w.map((T,M)=>W.jsx("mesh",{geometry:T,material:F},M)),b&&B&&W.jsxs(W.Fragment,{children:[W.jsx("line2",{geometry:B.bottomGeo,material:R}),B.vertGeos.map(({geo:T},M)=>W.jsx("line2",{geometry:T,material:R},`v${M}`)),B.topGeos.map(({geo:T},M)=>W.jsx("line2",{geometry:T,material:R},`t${M}`))]})]})}const me=`
