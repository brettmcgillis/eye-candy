import{S as n,V as le,at as ce,X as ue,au as de,a0 as D,a2 as ee,j as v,aa as te,av as xe,Z as b,af as Q,aw as he,ai as ye,ay as fe,am as me,aC as Y,b1 as ge,bp as Se,aF as be,aG as ze,aJ as re,aI as ae,as as pe}from"./index-BnEdaNJi.js";import{S as Ce}from"./SmokeParticles-C-fu9Evr.js";import{V as we}from"./VolumetricSmokeParticles-C3qn4L0k.js";import{S as Pe}from"./SplineLine-DBJCMv0H.js";import{S as Me}from"./SplinePoints-DO8ta8HB.js";import{V as Ee}from"./VolumetricFire-B5yRuqrt.js";const Re=`
...
`;le.preload(ue,ce("explosion.png"));const Te=`
${Re}
...
`;function Je({position:o=[0,0,0],radius:e=20,detail:r=6,speed:t=1,weight:a=10,noiseFreq:i=.05,noiseAmp:u=5,texturePath:d="explosion.png",animated:l=!0,greyscale:h=!1,smokeLightColor:f="#4a4a58",smokeDarkColor:y="#1a1a22"}){const s=n.useMemo(()=>Date.now(),[]),m=le(ue,ce(d)),c=n.useMemo(()=>(m.colorSpace=de,m),[m]),p=n.useRef({tExplosion:{value:c},time:{value:0},weight:{value:a},noiseFreq:{value:i},noiseAmp:{value:u},greyscale:{value:h?1:0},smokeLightColor:{value:new D(f)},smokeDarkColor:{value:new D(y)}}).current;return p.tExplosion.value=c,p.weight.value=a,p.noiseFreq.value=i,p.noiseAmp.value=u,p.greyscale.value=h?1:0,p.smokeLightColor.value.set(f),p.smokeDarkColor.value.set(y),ee(()=>{l&&(p.time.value=25e-5*t*(Date.now()-s))}),v.jsxs("mesh",{position:o,children:[v.jsx("icosahedronGeometry",{args:[e,r]}),v.jsx("shaderMaterial",{vertexShader:Te,fragmentShader:Fe,uniforms:p,side:te,toneMapped:!1})]})}const Z=32;function De({points:o,pointRotations:e,pointScales:r,tension:t=.5,closed:a=!1,spread:i=120,color:u=4500223,opacity:d=.3}){const l=n.useMemo(()=>{if(!o||o.length<2)return null;const h=new xe([...o],a,"catmullrom",t),f=r?.length??0,y=f>=2,s=e?.length??0,m=s>=2,c=a?Z:Z+1,C=new Float32Array(c*4*3),p=[],A=new Q,q=new Q,H=new Q,U=new b,M=new b;for(let E=0;E<c;E+=1){const I=E/Z;h.getPoint(I,U);let W=1,L=1;if(y){const x=a?f:Math.max(1,f-1),w=Math.min(I*x,x-1e-6),g=Math.floor(w),O=w-g,P=r[g%f],G=r[(g+1)%f];W=P.x+(G.x-P.x)*O,L=P.z+(G.z-P.z)*O}if(m){const x=a?s:Math.max(1,s-1),w=Math.min(I*x,x-1e-6),g=Math.floor(w),O=w-g;q.setFromEuler(e[g%s]),H.setFromEuler(e[(g+1)%s]),A.copy(q).slerp(H,O)}else A.identity();const R=i*.5*W,V=i*.5*L,N=[[-R,0,-V],[R,0,-V],[R,0,V],[-R,0,V]],T=E*4;for(let x=0;x<4;x+=1){M.set(N[x][0],N[x][1],N[x][2]),M.applyQuaternion(A),M.add(U);const w=(T+x)*3;C[w]=M.x,C[w+1]=M.y,C[w+2]=M.z}for(let x=0;x<4;x+=1)p.push(T+x,T+(x+1)%4);const z=(E+1)%c;if(E<c-1||a){const x=z*4;for(let w=0;w<4;w+=1)p.push(T+w,x+w)}}const j=new he;return j.setAttribute("position",new ye(C,3)),j.setIndex(p),j},[o,e,r,t,a,i]);return n.useEffect(()=>()=>{l&&l.dispose()},[l]),l?v.jsx("lineSegments",{geometry:l,children:v.jsx("lineBasicMaterial",{color:u,transparent:!0,opacity:d,depthTest:!1})}):null}const ke=`
...
`,_e=5;function Ae(o){return Array.from({length:o},()=>({pos:new b,scale:new b(1,1,1),rot:new Q}))}function je(o,e,r,t,a,i){const u=e/2;for(let d=0;d<o.length;d++){const l=d/(o.length-1),h=l*l,f=r*(1-l*.25),y=t*(1-l*.25);o[d].pos.set(a*h,-u+l*e,i*h),o[d].scale.set(f,1,y)}}const X=new b,K=new b,B=new b,_=new b,ne=new b,J=new b,se=new Y;function Ie({position:o=[0,0,0],inverted:e=!1,width:r=.5,height:t=1.5,depth:a=.5,bendX:i=0,bendZ:u=0,animated:d=!0,animSpeed:l=.5,magnitude:h=1.3,lacunarity:f=2,gain:y=.5,speed:s=.8,density:m=1.2,brightness:c=1.8,saturation:C=1,tintColor:p="#ffffff",coreColor:A="#ffffcc",borderColor:q="#ff6600",smokeColor:H="#330000",emberDensity:U=.15,emberSize:M=.25,emberColor:j="#ff4400",steps:E=64,stepSize:I=1,controlPoints:W=null}){const L=n.useRef(),R=n.useRef(),V=n.useRef(0),N=n.useRef({x:i,z:u}),T=n.useRef(null);T.current||(T.current=Ae(_e));const z=n.useMemo(()=>new fe({vertexShader:ke,fragmentShader:Be,uniforms:{uTime:{value:0},uInvGroupWorld:{value:new Y},uBoundsMin:{value:new b(-.5,-.75,-.5)},uBoundsMax:{value:new b(.5,.75,.5)},uMagnitude:{value:h},uLacunarity:{value:f},uGain:{value:y},uSpeed:{value:s},uDensity:{value:m},uBrightness:{value:c},uSaturation:{value:C},uColorTint:{value:new D(p)},uCoreColor:{value:new D(A)},uBorderColor:{value:new D(q)},uSmokeColor:{value:new D(H)},uEmberDensity:{value:U},uEmberSize:{value:M},uEmberColor:{value:new D(j)},uSteps:{value:E},uStepSize:{value:I},uCPCount:{value:0},uCPPos:{value:Array.from({length:8},()=>new b)},uCPScale:{value:Array.from({length:8},()=>new b(1,1,1))}},side:te,transparent:!0,depthWrite:!1,blending:me}),[]),x=n.useMemo(()=>new ge(1,1,1),[]);n.useEffect(()=>{const g=z.uniforms;g.uMagnitude.value=h,g.uLacunarity.value=f,g.uGain.value=y,g.uSpeed.value=s,g.uDensity.value=m,g.uBrightness.value=c,g.uSaturation.value=C,g.uSteps.value=E,g.uStepSize.value=I,g.uEmberDensity.value=U,g.uEmberSize.value=M},[z,h,f,y,s,m,c,C,E,I,U,M]),n.useEffect(()=>{z.uniforms.uColorTint.value.set(p)},[z,p]),n.useEffect(()=>{z.uniforms.uCoreColor.value.set(A)},[z,A]),n.useEffect(()=>{z.uniforms.uBorderColor.value.set(q)},[z,q]),n.useEffect(()=>{z.uniforms.uSmokeColor.value.set(H)},[z,H]),n.useEffect(()=>{z.uniforms.uEmberColor.value.set(j)},[z,j]),n.useEffect(()=>{N.current={x:i,z:u}},[i,u]),n.useEffect(()=>()=>{z.dispose(),x.dispose()},[z,x]),ee(({clock:g},O)=>{const P=z.uniforms;P.uTime.value=g.getElapsedTime();let G;if(W&&W.length>=2)G=W;else{let k=N.current.x,S=N.current.z;if(d){V.current+=O*l;const $=V.current;k+=Math.sin($*.8)*.14+Math.sin($*2.1+.5)*.04,S+=Math.cos($*.65+1.2)*.07+Math.cos($*1.7)*.03}je(T.current,t,r,a,k,S),G=T.current}const oe=Math.min(G.length,8);P.uCPCount.value=oe,B.set(1/0,1/0,1/0),_.set(-1/0,-1/0,-1/0);for(let k=0;k<oe;k++){const S=G[k];S.pos instanceof b?X.copy(S.pos):Array.isArray(S.pos)?X.set(S.pos[0]||0,S.pos[1]||0,S.pos[2]||0):X.set(S.pos.x||0,S.pos.y||0,S.pos.z||0),S.scale instanceof b?K.copy(S.scale):Array.isArray(S.scale)?K.set(S.scale[0]||1,S.scale[1]||1,S.scale[2]||1):K.set(S.scale.x||1,S.scale.y||1,S.scale.z||1),P.uCPPos.value[k].copy(X),P.uCPScale.value[k].copy(K);const $=Math.max(K.x,K.z)*.75;B.min(X.clone().addScalar(-$)),_.max(X.clone().addScalar($))}B.y-=.15,_.y+=t*.35,B.x-=.35,B.z-=.35,_.x+=.35,_.z+=.35,P.uBoundsMin.value.copy(B),P.uBoundsMax.value.copy(_),L.current&&(ne.addVectors(B,_).multiplyScalar(.5),J.subVectors(_,B),L.current.position.copy(ne),L.current.scale.set(Math.max(J.x,.01),Math.max(J.y,.01),Math.max(J.z,.01))),R.current&&(R.current.updateWorldMatrix(!0,!1),se.copy(R.current.matrixWorld).invert(),P.uInvGroupWorld.value.copy(se))});const w=W?0:t/2;return v.jsx("group",{position:o,rotation:e?[Math.PI,0,0]:[0,0,0],children:v.jsx("group",{ref:R,position:[0,w,0],children:v.jsx("mesh",{ref:L,geometry:x,material:z,frustumCulled:!1})})})}let F=null;function We(){if(F)return F;const o=256,e=new Uint8Array(o*o*4);for(let r=0;r<o;r++)for(let t=0;t<o;t++){const a=(r*o+t)*4,i=Math.abs(Math.sin(t*127.1+r*311.7)*43758.5453)%1,u=Math.abs(Math.sin(t*269.5+r*183.3)*43758.5453)%1,d=Math.abs(Math.sin(t*419.2+r*371.9)*43758.5453)%1,l=Math.abs(Math.sin(t*113.5+r*271.9)*43758.5453)%1;e[a]=i*255|0,e[a+1]=u*255|0,e[a+2]=d*255|0,e[a+3]=l*255|0}return F=new be(e,o,o,ze),F.wrapS=re,F.wrapT=re,F.minFilter=ae,F.magFilter=ae,F.needsUpdate=!0,F}const Le=`
  varying vec3 vWorldPos;
...
`,ie=new Y;function Ne({position:o=[0,0,0],radius:e=1.5,rotSpeed:r=.1,noiseScale:t=.5,coreColor:a="#ccffff",coreIntensity:i=7,edgeColor:u="#7a877f",edgeIntensity:d=1.5,density:l=1,steps:h=64}){const f=n.useRef(),y=n.useMemo(()=>We(),[]),s=n.useMemo(()=>new fe({vertexShader:Le,fragmentShader:Ve,uniforms:{uTime:{value:0},uRotSpeed:{value:r},uNoiseScale:{value:t},uInvWorld:{value:new Y},uNoiseTex:{value:y},uSteps:{value:h},uDensity:{value:l},uCoreColor:{value:new D(a)},uCoreIntensity:{value:i},uEdgeColor:{value:new D(u)},uEdgeIntensity:{value:d}},side:te,transparent:!0,depthWrite:!1,blending:me}),[]),m=n.useMemo(()=>new Se(1,32,16),[]);return n.useEffect(()=>{const c=s.uniforms;c.uRotSpeed.value=r,c.uNoiseScale.value=t,c.uSteps.value=h,c.uDensity.value=l,c.uCoreIntensity.value=i,c.uEdgeIntensity.value=d},[s,r,t,h,l,i,d]),n.useEffect(()=>{s.uniforms.uCoreColor.value.set(a)},[s,a]),n.useEffect(()=>{s.uniforms.uEdgeColor.value.set(u)},[s,u]),n.useEffect(()=>()=>{s.dispose(),m.dispose()},[s,m]),ee(({clock:c})=>{s.uniforms.uTime.value=c.getElapsedTime(),f.current&&(f.current.updateWorldMatrix(!0,!1),ie.copy(f.current.matrixWorld).invert(),s.uniforms.uInvWorld.value.copy(ie))}),v.jsx("group",{position:o,children:v.jsx("mesh",{ref:f,geometry:m,material:s,scale:[e*1.02,e*1.02,e*1.02],frustumCulled:!1})})}function Ge({points:o,config:e,showVolume:r}){const t=n.useMemo(()=>o.map(a=>({pos:a.position.clone(),scale:new b(e.fireWidth*(a.scale?.x??1),a.scale?.y??1,e.fireDepth*(a.scale?.z??1)),rot:new Q().setFromEuler(a.rotation)})),[o,e.fireWidth,e.fireDepth]);return v.jsx(Ee,{controlPoints:t,sliceSpacing:e.fireSliceSpacing,magnitude:e.fireMagnitude,lacunarity:e.fireLacunarity,gain:e.fireGain,tintColor:e.fireTintColor,saturation:e.fireSaturation,brightness:e.fireBrightness,animated:e.fireAnimated,animSpeed:e.fireAnimSpeed,showVolume:r})}function $e({points:o,config:e}){const r=n.useMemo(()=>o.map(t=>({pos:t.position.clone(),scale:new b(e.fireWidth*(t.scale?.x??1),t.scale?.y??1,e.fireDepth*(t.scale?.z??1)),rot:new Q().setFromEuler(t.rotation)})),[o,e.fireWidth,e.fireDepth]);return v.jsx(Ie,{controlPoints:r,magnitude:e.cs184Magnitude,lacunarity:e.cs184Lacunarity,gain:e.cs184Gain,speed:e.cs184Speed,density:e.cs184Density,brightness:e.cs184Brightness,saturation:e.cs184Saturation,tintColor:e.cs184TintColor,coreColor:e.cs184CoreColor,borderColor:e.cs184BorderColor,smokeColor:e.cs184SmokeColor,emberDensity:e.cs184EmberDensity,emberSize:e.cs184EmberSize,emberColor:e.cs184EmberColor,steps:e.cs184Steps,stepSize:e.cs184StepSize,animated:e.cs184Animated,animSpeed:e.cs184AnimSpeed})}function qe({points:o,config:e}){return v.jsx(v.Fragment,{children:o.map((r,t)=>v.jsx(Ne,{position:r.position,radius:e.fireballRadius*(r.scale?.x??1),rotSpeed:e.fireballRotSpeed,noiseScale:e.fireballNoiseScale,coreColor:e.fireballCoreColor,coreIntensity:e.fireballCoreIntensity,edgeColor:e.fireballEdgeColor,edgeIntensity:e.fireballEdgeIntensity,density:e.fireballDensity,steps:e.fireballSteps},t))})}function Ye({index:o,points:e,config:r,splineConfig:t,attractorsRef:a,setSplinePoints:i,allowedTypes:u="both"}){const d=n.useCallback(p=>i(o,p),[o,i]),l=n.useMemo(()=>e.map(p=>p.position),[e]),h=n.useMemo(()=>e.map(p=>p.rotation),[e]),f=n.useMemo(()=>e.map(p=>p.scale),[e]),y=n.useMemo(()=>({...r,...t}),[r,t]);if(!t.visible||u==="smoke"&&t.type==="Fire"||u==="fire"&&t.type==="Smoke")return null;const s=t.type==="Fire",m=t.type==="Smoke",{smokeType:c="Particle",fireType:C="Classic"}=t;return v.jsxs(v.Fragment,{children:[v.jsx(Me,{points:e,setPoints:d,visible:t.showHelpers,mode:r.pointMode}),v.jsx(Pe,{points:l,tension:t.tension,closed:t.closed,curveType:"catmullrom",color:"#aaaaaa",visible:t.showSpline,arcSegments:t.arcSegments}),m&&c==="Particle"&&v.jsx(Ce,{points:l,pointRotations:h,pointScales:f,config:y,attractorsRef:a}),m&&c==="Volumetric"&&v.jsx(we,{points:l,pointRotations:h,pointScales:f,config:y,attractorsRef:a}),m&&t.showSmokeVolume&&v.jsx(De,{points:l,pointRotations:h,pointScales:f,tension:t.tension,closed:t.closed,spread:Math.max(y.spawnSpread??0,y.volSpread??0)||120}),s&&C==="Classic"&&v.jsx(Ge,{points:e,config:y,showVolume:t.showFireVolume}),s&&C==="RayMarch"&&v.jsx($e,{points:e,config:y}),s&&C==="Fireball"&&v.jsx(qe,{points:e,config:y})]})}const ve={name:"",visible:!0,type:"Smoke",smokeType:"Particle",fireType:"Classic",tension:1,closed:!0,showSpline:!0,showHelpers:!0,arcSegments:200,showSmokeVolume:!1,showFireVolume:!1,particleCount:15e3,particleSize:.4,particleColor:"#7c7989",opacity:.045,growth:2,fadeExponent:1.2,buoyancy:.2,rotSpeed:.3,blendMode:"Normal",springK:5,flowSpeed:.04,damping:.12,turbulence:1.2,turbulenceSpeed:.3,spawnSpread:1.2,maxDrift:6,fadeRate:8,volParticleCount:12e3,volSize:.6,volColor:"#9090a0",volOpacity:.06,volBlendMode:"Normal",volSpread:1.2,volSpringK:2.5,volDamping:.1,volTurbulence:1.8,volTurbulenceSpeed:.25,volMaxDrift:9,volGrowth:1.5,volFadeExp:1.2,volBuoyancy:0,fireWidth:.8,fireHeight:2,fireDepth:.8,fireSliceSpacing:.04,fireMagnitude:1.3,fireLacunarity:2,fireGain:.5,fireTintColor:"#ffffff",fireSaturation:1,fireBrightness:1.5,fireAnimated:!0,fireAnimSpeed:.5,cs184Magnitude:1.3,cs184Lacunarity:2,cs184Gain:.5,cs184Speed:.8,cs184Density:1.2,cs184Brightness:1.8,cs184Saturation:1,cs184TintColor:"#ffffff",cs184CoreColor:"#ffffcc",cs184BorderColor:"#ff6600",cs184SmokeColor:"#330000",cs184EmberDensity:.15,cs184EmberSize:.25,cs184EmberColor:"#ff4400",cs184Steps:64,cs184StepSize:1,cs184Animated:!0,cs184AnimSpeed:.5,fireballRadius:.8,fireballRotSpeed:.1,fireballNoiseScale:.5,fireballCoreColor:"#ccffff",fireballCoreIntensity:7,fireballEdgeColor:"#7a877f",fireballEdgeIntensity:1.5,fireballDensity:1,fireballSteps:64};function Ze(o,e,r,t){o(a=>{const i=[...a];return i[e]={...i[e],[r]:t},i})}function et(o){let e=[];Array.isArray(o?.splines)?e=o.splines:o?.points&&(e=[o]);const r=e.map(a=>a.points.map(i=>({position:i.position.clone(),rotation:i.rotation?i.rotation.clone():new pe(0,0,0),scale:i.scale?i.scale.clone():new b(1,1,1)}))),t=e.map(a=>{const{points:i,...u}=a;let d={...u};return(u.type==="Particle"||u.type==="Volumetric")&&(d={...u,smokeType:u.type,type:"Smoke"}),{...ve,...d}});return{splines:r,splineConfigs:t}}function tt(o,e){return o.map((r,t)=>{const a=e[t]??ve,{showSpline:i,showHelpers:u,showSmokeVolume:d,showFireVolume:l,...h}=a,f=r.map(s=>{const m=s.position,c=s.rotation??new pe,C=s.scale??new b(1,1,1);return`    { position: new THREE.Vector3(${m.x.toFixed(3)}, ${m.y.toFixed(3)}, ${m.z.toFixed(3)}), rotation: new THREE.Euler(${c.x.toFixed(3)}, ${c.y.toFixed(3)}, ${c.z.toFixed(3)}), scale: new THREE.Vector3(${C.x.toFixed(3)}, ${C.y.toFixed(3)}, ${C.z.toFixed(3)}) }`});return`  {
...
`)}export{Ie as C,ve as D,Ne as F,Je as P,Ye as S,Re as n,et as p,tt as s,Ze as u};
